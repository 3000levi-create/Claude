...
try {
  (function () {
    ...
    if (r) {
      ...
      t._sentryDebugIds[r] = "f461451b-53fa-465e-a61e-b03775717418";
      t._sentryDebugIdIdentifier = "sentry-dbid-f461451b-53fa-465e-a61e-b03775717418";
    }
  })();
} catch {}
(function () {
...
const ny = "" + new URL("AnthropicSans-Roman-Variable-DCEzLfgm.ttf", import.meta.url).href;
const ry = "" + new URL("AnthropicSerif-Italic-Variable-B9Ik5ODi.ttf", import.meta.url).href;
const iy = "" + new URL("AnthropicSerif-Roman-Variable-D05ngSTe.ttf", import.meta.url).href;
const oy = `
@font-face {
...
${l[p].replace(" at new ", " at ")}`;
  ...
  var dm = r.unstable_shouldYield;
  var pm = r.unstable_requestPaint;
  var Ne = r.unstable_now;
  var hm = r.unstable_getCurrentPriorityLevel;
  var Ss = r.unstable_ImmediatePriority;
  var Fl = r.unstable_UserBlockingPriority;
  var Oi = r.unstable_NormalPriority;
  var mm = r.unstable_LowPriority;
  ...
  var Br = new Map();
  var on = [];
  var Tm = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
  function Gl(e, n) {
    switch (e) {
      case "focusin":
      case "focusout":
  ...
  function ks(e, n, i, s) {
    if (Bi) {
      ...
      if (l === null) {
        Vs(e, n, s, Ui, i);
        Gl(e, s);
      } else if (xm(l, e, n, i, s)) {
        s.stopPropagation();
      } else {
        Gl(e, s);
        if (n & 4 && Tm.indexOf(e) > -1) {
          while (l !== null) {
            var c = ei(l);
            if (c !== null) {
              Ul(c);
  ...
  var jm = U({}, $r, {
    key: function (e) {
      ...
      if (e.type === "keypress") {
        ...
        return Hm[e.keyCode] || "Unidentified";
      } else {
        return "";
      }
    },
  ...
  var lg = h && "documentMode" in document && document.documentMode <= 11;
  var tr = null;
  var Bs = null;
  var Qr = null;
  var Us = false;
  ...
  for (var zs = 0; zs < Sc.length; zs++) {
    var $s = Sc[zs];
    var cg = $s.toLowerCase();
    var fg = $s[0].toUpperCase() + $s.slice(1);
    an(cg, "on" + fg);
  }
  ...
  var dg = new Set("cancel close invalid load scroll toggle".split(" ").concat(Kr));
  function wc(e, n, i) {
...
`).replace(hg, "");
  ...
  var mg = typeof clearTimeout == "function" ? clearTimeout : undefined;
  var kc = typeof Promise == "function" ? Promise : undefined;
  var gg = typeof queueMicrotask == "function" ? queueMicrotask : typeof kc !== "undefined" ? function (e) {
  ...
  var vg = "__reactListeners$" + ir;
  var _g = "__reactHandles$" + ir;
  function Cn(e) {
    var n = e[Rt];
    if (n) {
      return n;
...
${c.stack}`;
  ...
  var Eo = false;
  var je = false;
  var Mg = typeof WeakSet == "function" ? WeakSet : Set;
  var B = null;
  function gr(e, n) {
    var i = e.ref;
    if (i !== null) {
  ...
  function Xf(e, n) {
    ...
    if (n !== 0) {
      ...
      if (n === 6) {
        ...
        if ((s & 30) === 0 && !Bg(l) && (n = Po(e, s), n === 2 && (c = ws(e), c !== 0 && (s = c, n = $a(e, c))), n === 1)) {
          i = fi;
          bn(e, 0);
          vn(e, s);
          Je(e, Ne());
        ...
        switch (n) {
          ...
          case 4:
            ...
            s = l;
            s = Ne() - s;
            s = (s < 120 ? 120 : s < 480 ? 480 : s < 1080 ? 1080 : s < 1920 ? 1920 : s < 3000 ? 3000 : s < 4320 ? 4320 : Hg(s / 1960) * 1960) - s;
            if (s > 10) {
  ...
  function t(r, o = t.defaultLocale, a, u) {
    ...
    this.format = function (m) {
      ...
      var v = y.reduce(function (T, N) {
        if (!T.length || N.type !== We.literal || typeof T[T.length - 1] != "string") {
          T.push(N.value);
        } else {
...
function M0(t) {
  if (ze.isValidElement(t)) {
    return ze.createElement(ze.Fragment, D0, t);
  } else {
    return t;
  }
}
function F0(t) {
  return ze.Children.map(t, M0) ?? [];
}
function b0(t) {
  return function (r) {
...
j0();
var Qu = typeof window !== "undefined" && !window.__REACT_INTL_BYPASS_GLOBAL_CONTEXT__ ? window.__REACT_INTL_CONTEXT__ ||= ze.createContext(null) : ze.createContext(null);
Qu.Consumer;
var z0 = Qu.Provider;
var $0 = z0;
var G0 = Qu;
...
function yh(t, r = {}) {
  ...
  try {
    ...
    const T = !Array.isArray(r) && r.maxStringLength || pv;
    while (o && f++ < a && (y = hv(o, v), y !== "html" && (!(f > 1) || !(d + u.length * m + y.length >= T)))) {
      u.push(y);
      d += y.length;
      o = o.parentNode;
    }
...
function lt(t = yv()) {
  ...
  return mu.replace(/[018]/g, r => (r ^ (vv() & 15) >> r / 4).toString(16));
}
function Eh(t) {
  var r;
  var o;
...
const Dv = "sentry.sample_rate";
const Mv = "sentry.previous_trace_sample_rate";
const Fv = "sentry.op";
const bv = "sentry.origin";
const Th = "sentry.profile_id";
const xh = "sentry.exclusive_time";
const Hv = 0;
const Bv = 1;
const Uv = "_sentryScope";
const jv = "_sentryIsolationScope";
function zv(t) {
  if (t) {
...
function n_(t) {
  ...
  const f = Ih(t).scope;
  const d = a ? (f == null ? undefined : f.getPropagationContext().propagationSpanId) || wh() : r;
  return {
    parent_span_id: u,
    span_id: d,
    trace_id: o
...
function h_(t) {
  ...
  const d = (f == null ? undefined : f.get("sentry.sample_rate")) ?? u[Dv] ?? u[Mv];
  function h(M) {
  ...
  if (l_()) {
    T.sampled = String(s_(o));
    T.sample_rand = (f == null ? undefined : f.get("sentry.sample_rand")) ?? ((D = Ih(o).scope) == null ? undefined : D.getPropagationContext().sampleRand.toString());
  }
  h(T);
...
function Mu(t, r, o = Infinity, a = Infinity, u = __()) {
  const [f, d] = u;
...
function Fh(t, r) {
  ...
  const u = eE(o, a._metadata, a.tunnel, t.getDsn());
  bh().set(t, []);
  t.emit("flushLogs");
  t.sendEnvelope(u);
}
...
function Hh(t, r) {
  ...
  const a = t.getOptions();
  const u = rE(o, a._metadata, a.tunnel, t.getDsn());
  Bh().set(t, []);
  t.emit("flushMetrics");
  t.sendEnvelope(u);
}
...
function fE(t) {
  ...
  return {
    ...
    trace_id: r ?? "",
    origin: f,
    profile_id: d == null ? undefined : d[Th],
    exclusive_time: d == null ? undefined : d[xh],
...
const $h = Symbol.for("SentryInternalError");
const Gh = Symbol.for("SentryDoNotSendEventError");
const pE = 5000;
function Qo(t) {
  return {
    message: t,
...
class hE {
  constructor(r) {
    ...
    this._hooks = {};
    this._eventProcessors = [];
    this._promiseBuffer = ll(((a = r.transportOptions) == null ? undefined : a.bufferSize) ?? Uh);
    if (r.dsn) {
      this._dsn = e_(r.dsn);
    } else if (Z) {
  ...
  _prepareEvent(r, o, a, u) {
    ...
    return b_(f, r, o, a, this, u).then(h => {
      if (h === null) {
        return h;
      }
  ...
  _processEvent(r, o, a, u) {
    ...
    const T = typeof d === "undefined" ? undefined : t_(d);
  ...
  setupOnce() {
    ...
    try {
      Function.prototype.toString = function (...t) {
        const r = nl(this);
        const o = _p.has($e()) && r !== undefined ? r : this;
        return vp.apply(o, t);
      };
    } catch {}
  },
...
function LE(t, r) {
  if (t.type) {
    if (t.type === "transaction" && AE(t, r.ignoreTransactions)) {
      if (Z) {
...
function vS(t, {
  ...
  if (mh(t)) {
    ...
    return `Event \`${_S(t)}\` (type=${t.type}) captured as ${a}`;
  } else {
...
class SS extends hE {
  constructor(r) {
    var v;
    const o = wS(r);
    const a = Ce.SENTRY_SDK_SOURCE || tS();
    wE(o, "browser", ["browser"], a);
...
const TS = typeof __SENTRY_DEBUG__ === "undefined" || __SENTRY_DEBUG__;
const Xe = he;
const xS = 1000;
let kp;
let Gu;
...
function NS() {
  ...
  ["EventTarget", "Node"].forEach(o => {
    var f;
    var d;
    const u = (f = Xe[o]) == null ? undefined : f.prototype;
...
const zS = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i;
const $S = /\((\S*)(?::(\d+))(?::(\d+))\)/;
const GS = /at (.+?) ?\(data:(.+?),/;
const VS = t => {
  const r = t.match(GS);
...
const em = [BS, VS];
const WS = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i;
const XS = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i;
const YS = t => {
  const r = WS.exec(t);
  if (r) {
  ...
  return {
    ...
    setupOnce() {
      ...
      if (r.requestAnimationFrame) {
        ut(Ce, "requestAnimationFrame", d1);
      }
      if (r.XMLHttpRequest && "XMLHttpRequest" in Ce) {
        ut(XMLHttpRequest.prototype, "send", p1);
      }
      const o = r.eventTarget;
      if (o) {
        (Array.isArray(o) ? o : u1).forEach(u => h1(u, r));
      }
    }
  };
};
...
function S1(t) {
  iv(r => {
    ...
    const y = I1(dl(o, m || u, undefined, a, false), f, d, h);
    y.level = "error";
    Oh(y, {
      originalException: m,
      mechanism: {
...
function w1(t) {
  sv(r => {
    ...
    const u = T1(r);
    const f = rs(u) ? x1(u) : dl(o, u, undefined, a, true);
    f.level = "error";
    Oh(f, {
      originalException: u,
      mechanism: {
...
export { Q1 as R, es as _, Su as j, ze as r, H0 as s, sh as u };