...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            t = new e.Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "b3ca2d5b-6a13-445b-9604-bdae630d3f69", e._sentryDebugIdIdentifier = "sentry-dbid-b3ca2d5b-6a13-445b-9604-bdae630d3f69")
    })()
} catch {}
...
function V(e) {
    ...
    return typeof x == "function" ? x(Array.isArray(p) ? p : [p]) : u ? i.createElement(u, null, p) : i.createElement(i.Fragment, null, p)
}
...
function ne() {
    ...
    function m(h, c, x) {
        var f, u = {},
            g = null,
            b = null;
        x !== void 0 && (g = "" + x), c.key !== void 0 && (g = "" + c.key), c.ref !== void 0 && (b = c.ref);
        for (f in c) a.call(c, f) && !d.hasOwnProperty(f) && (u[f] = c[f]);
        if (h && h.defaultProps)
            for (f in c = h.defaultProps, c) u[f] === void 0 && (u[f] = c[f]);
        return {
            $$typeof: t,
            type: h,
            key: g,
...
const se = new Map([
        ...
        ["regular", n.jsx(n.Fragment, {
            children: n.jsx("path", {
                d: "M224,128a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,128ZM40,72H216a8,8,0,0,0,0-16H40a8,8,0,0,0,0,16ZM216,184H40a8,8,0,0,0,0,16H216a8,8,0,0,0,0-16Z"
            })
        })],
        ["thin", n.jsx(n.Fragment, {
            children: n.jsx("path", {
...
var ie = Object.defineProperty,
    ...
    C = (e, t) => {
        for (var r in t || (t = {})) q.call(t, r) && _(e, r, t[r]);
        if (w)
            for (var r of w(t)) Y.call(t, r) && _(e, r, t[r]);
        return e
    },
    fe = (e, t) => ce(e, de(t)),
    L = (e, t) => {
        var r = {};
        for (var a in e) q.call(e, a) && t.indexOf(a) < 0 && (r[a] = e[a]);
        if (e != null && w)
            for (var a of w(e)) t.indexOf(a) < 0 && Y.call(e, a) && (r[a] = e[a]);
        return r
    };
const U = i.forwardRef((e, t) => {
    const r = e,
        ...
        f = L(r, ["alt", "color", "size", "weight", "mirrored", "children", "weights"]),
        u = i.useContext(le),
        {
        ...
        H = L(u, ["color", "size", "weight", "mirrored"]);
...
var ue = Object.defineProperty,
    ...
    xe = (e, t) => {
        for (var r in t || (t = {})) pe.call(t, r) && N(e, r, t[r]);
        if (F)
            for (var r of F(t)) me.call(t, r) && N(e, r, t[r]);
        return e
    },
    be = (e, t) => he(e, ge(t));
...
var ve = Object.defineProperty,
    ...
    Ae = (e, t) => {
        for (var r in t || (t = {})) we.call(t, r) && P(e, r, t[r]);
        if (k)
            for (var r of k(t)) He.call(t, r) && P(e, r, t[r]);
        return e
    },
    Ze = (e, t) => ye(e, je(t));
...
var R;
(R = globalThis["claude.internal.ui"]) == null || R.AboutWindow;
var S;
(S = globalThis["claude.internal.ui"]) == null || S.QuickWindow;
var I;
const o = (I = globalThis["claude.internal.ui"]) == null ? void 0 : I.MainWindowTitleBar;
...
function X(e) {
    ...
    if (typeof e == "string" || typeof e == "number") a += e;
        ...
        if (Array.isArray(e)) {
            var s = e.length;
            for (t = 0; t < s; t++) e[t] && (r = X(e[t])) && (a && (a += " "), a += r)
        } else
...
function J() {
    for (var e, t, r = 0, a = "", s = arguments.length; r < s; r++)(e = arguments[r]) && (t = X(e)) && (a && (a += " "), a += t);
    return a
}
const Me = (e = "primary") => J("inline-flex items-center justify-center relative shrink-0 select-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none disabled:drop-shadow-none", {
    ...
    Oe = (e = "default", t, r) => {
        ...
        return t && (e === "default" ? s = s.replace("px-4", "pl-2 pr-3 gap-1") : e === "lg" ? s = s.replace("px-5", "pl-2.5 pr-3.5 gap-1") : e === "sm" && (s = s.replace("px-3", "pl-2 pr-2.5 gap-1"))), r && (e === "default" ? s = s.replace("px-4", "pl-3 pr-2 gap-1") : e === "lg" ? s = s.replace("px-5", "pl-3.5 pr-2.5 gap-1") : e === "sm" && (s = s.replace("px-3", "pl-2.5 pr-2 gap-1"))), s
    },
    Z = i.forwardRef(({
        className: e,
        variant: t = "primary",
...
function Ce(e) {
    const t = Math.min(1e3 * Math.pow(2, e - 1), Ee),
        r = Math.random() * .1 * t;
    return t + r
}
async function Le(e) {
...
async function T(e = 1) {
    ...
    if (t) {
        if (console.log($, "Requesting health check", `(attempt ${e})`), await ((a = o == null ? void 0 : o.isClaudeCurrentlyHealthy) == null ? void 0 : a.call(o))) return !0;
        e++
    }
    const r = Ce(e);
    return console.log($, `${t?"Fetch failed":"offline"}, waiting ${(r/1e3).toPrecision(3)}s`), await Le(r), T(e)
}
async function Fe() {
    return j.waiting || (j.waiting = T().finally(_e)), j.waiting
}
const B = ae,
    Ne = 36,
    ke = ({
        ...
        return l.jsx("div", {
            ...
            children: l.jsxs("div", {
                className: "nc-no-drag select-none flex flex-col items-center justify-center max-w-md p-6 space-y-2",
                children: [l.jsx("div", {
                    className: "flex items-center justify-center w-16 h-16 rounded-full bg-danger-200/10 text-danger-100",
                    children: l.jsx(Q, {
                        size: 32
                    })
                }), l.jsx("h1", {
                    ...
                    className: "text-xs text-center text-text-400 dark:text-text-100 select-text !mb-2",
...
const $e = () => {
        var e;
        (e = o == null ? void 0 : o.requestReloadMainView) == null || e.call(o)
    },
    Re = () => {
        var e;
        (e = o == null ? void 0 : o.requestMainMenuPopup) == null || e.call(o)
    };

function Ie() {
    const [e, t] = i.useState("Claude"), [r, a] = i.useState(null);
    return i.useEffect(() => {
        var s;
        return (s = o == null ? void 0 : o.onUpdateTitleBar) == null ? void 0 : s.call(o, d => {
            t(d)
        })
    }, []), i.useEffect(() => {
        var s;
        return (s = o == null ? void 0 : o.onShowLoadError) == null ? void 0 : s.call(o, d => {
            a(d)
        })
    }, []), i.useEffect(() => {
        var s;
        return (s = o == null ? void 0 : o.onHideLoadError) == null ? void 0 : s.call(o, () => {
            a(null)
        })
    }, []), i.useEffect(() => {
        var s;
        (s = o == null ? void 0 : o.titleBarReady) == null || s.call(o)
    }, []), l.jsxs(l.Fragment, {
        children: [l.jsx(Pe, {
            windowTitle: e,
            isMainWindow: !0
            ...
            children: [l.jsx("div", {
                className: "nc-no-drag absolute top-2 left-2 z-[60]",
                children: l.jsx(Z, {
                    variant: "ghost",
                    size: "icon_sm",
                    onClick: Re,
