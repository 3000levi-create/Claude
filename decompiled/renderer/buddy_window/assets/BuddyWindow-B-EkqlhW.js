...
try {
    (function() {
        var t = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            a = new t.Error().stack;
        a && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[a] = "7b9afad9-cf23-4064-99ea-50636169af6a", t._sentryDebugIdIdentifier = "sentry-dbid-7b9afad9-cf23-4064-99ea-50636169af6a")
    })()
} catch {}
...
function q(t) {
    ...
    return typeof m == "function" ? m(Array.isArray(x) ? x : [x]) : k ? c.createElement(k, null, x) : c.createElement(c.Fragment, null, x)
}
...
function G(t) {
    ...
    if (typeof t == "string" || typeof t == "number") o += t;
        ...
        if (Array.isArray(t)) {
            var d = t.length;
            for (a = 0; a < d; a++) t[a] && (i = G(t[a])) && (o && (o += " "), o += i)
        } else
...
function J() {
    for (var t, a, i = 0, o = "", d = arguments.length; i < d; i++)(t = arguments[i]) && (a = G(t)) && (o && (o += " "), o += a);
    return o
}
const ee = (t = "primary") => J("inline-flex items-center justify-center relative shrink-0 select-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none disabled:drop-shadow-none", {
    ...
    te = (t = "default", a, i) => {
        ...
        return a && (t === "default" ? d = d.replace("px-4", "pl-2 pr-3 gap-1") : t === "lg" ? d = d.replace("px-5", "pl-2.5 pr-3.5 gap-1") : t === "sm" && (d = d.replace("px-3", "pl-2 pr-2.5 gap-1"))), i && (t === "default" ? d = d.replace("px-4", "pl-3 pr-2 gap-1") : t === "lg" ? d = d.replace("px-5", "pl-3.5 pr-2.5 gap-1") : t === "sm" && (d = d.replace("px-3", "pl-2.5 pr-2 gap-1"))), d
    },
    g = c.forwardRef(({
        className: t,
        variant: a = "primary",
...
var V = (t => (t.Gif = "gif", t.Text = "text", t))(V || {}),
    _;
const s = (_ = globalThis["claude.buddy"]) == null ? void 0 : _.Buddy;
var Z;
(Z = globalThis["claude.buddy"]) == null || Z.BuddyBleTransport;
const u = {
        color: "var(--ink-dim)"
    },
    W = process.platform === "darwin" ? "pl-[83px]" : "pl-5",
    se = "https://github.com/anthropics/claude-desktop-buddy";
...
function ne({
    ...
    var i;
    let a;
    return (t == null ? void 0 : t.kind) === V.Gif && t.dataUrl ? a = e.jsx("img", {
        src: t.dataUrl,
        alt: ""
    }) : (i = t == null ? void 0 : t.frames) != null && i.length ? a = e.jsx("div", {
        ...
        children: [e.jsx("div", {
            className: "buddy-stick-screen",
            children: a
        }), e.jsx("div", {
            className: "flex-1 flex items-center justify-center",
            children: e.jsx("div", {
                className: "buddy-stick-btn"
            })
        })]
    })
}
...
function ie({
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsx("span", {
                className: `buddy-dot ${m?"on":""}`
            }), e.jsx("span", {
                children: m ? a != null && a.sec ? e.jsx(r, {
        ...
        }), (t == null ? void 0 : t.paired) && e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                k: a.bat.usb ? a.bat.mA > 1 ? e.jsx(r, {
...
function oe({
    ...
    return c.useEffect(() => {
        var p;
        (p = s == null ? void 0 : s.scanDevices) == null || p.call(s).then(v => d(v ?? []))
    }, []), e.jsxs("div", {
        ...
        children: [e.jsx(g, {
            ...
            className: "px-8 pt-14 pb-7 overflow-y-auto text-[13px] leading-relaxed",
            children: [e.jsx("h2", {
                ...
                children: [(o == null ? void 0 : o.length) === 0 && e.jsx("div", {
                ...
                }), o == null ? void 0 : o.map(p => e.jsx("button", {
...
function de({
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            className: "px-8 pt-5 pb-7 overflow-y-auto text-[13px] leading-relaxed select-text",
            children: [e.jsx("h2", {
                className: "text-lg mb-1",
                style: {
                    color: "var(--ink)"
                ...
                style: u,
                children: e.jsx(r, {
                    defaultMessage: "As an example, we built a desk pet that lives off permission approvals and interaction with Claude. Find the firmware, build instructions, and character pack guide in the <a>claude-desktop-buddy repository</a>.",
                    id: "mTUIZX4Qq2",
                ...
                style: u,
                children: e.jsx(r, {
                    defaultMessage: "The repository includes full details on building and connecting your own devices. Here's the short version.",
                    id: "RfhFFMTHtV",
                ...
                style: u,
                children: e.jsx(r, {
                    defaultMessage: "Advertise a name starting with <code>Claude</code> over the Nordic UART Service. Everything on the wire is UTF-8 JSON—one object per line, terminated with <code>\\n</code>.",
                    id: "tkAZD2CTH1",
                    description: "BLE transport requirements; <code> tags wrap literal protocol values",
                    values: {
                        code: i => e.jsx("code", {
                            children: i
                        })
                ...
                children: [`service  6e400001-b5a3-f393-e0a9-e50e24dcca9e
...
`, "tx notif 6e400003-b5a3-f393-e0a9-e50e24dcca9e"]
                ...
                style: u,
                children: e.jsx(r, {
                    defaultMessage: "The desktop apps send a heartbeat snapshot whenever something changes, plus a keepalive every 10 seconds:",
                    id: "mRGbzwGtHn",
                ...
                style: u,
                children: e.jsx(r, {
                    defaultMessage: "When <code>prompt</code> is present, your device can return a response:",
                    id: "hzmFz+zKgD",
...
`, '{"cmd":"permission","id":"req_abc","decision":"deny"}']
                ...
                style: u,
                children: e.jsx(r, {
                    defaultMessage: "Each completed turn also fires a one-shot event containing the raw SDK content array—text blocks, tool calls, and any other content from the message. Events that serialize larger than 4KB are dropped.",
                    id: "NlhLVO18ds",
                    description: "Explains the turn event sent alongside the heartbeat"
                })
            }), e.jsx("pre", {
...
function fe() {
    const t = E(),
        ...
        w = c.useCallback(async () => {
            ...
            i(n);
            const l = n.connected ? await ((f = s.deviceStatus) == null ? void 0 : f.call(s)) ?? null : null;
            d(l), v(R => R === "" && (l != null && l.name) ? l.name : R)
        }, []),
        H = pe();
    c.useEffect(() => {
        if (!H) return;
        w();
        const n = setInterval(() => void w(), 2e3);
        return () => clearInterval(n)
    }, [w, H]), c.useEffect(() => {
        var n;
        return (n = s == null ? void 0 : s.onPairingPrompt) == null ? void 0 : n.call(s, l => {
            N(!1), O(l)
        })
    }, []), c.useEffect(() => {
        var n;
        return (n = s == null ? void 0 : s.onProgress) == null ? void 0 : n.call(s, l => {
            const f = l.match(/(\d+)%/);
            x({
                msg: l,
    ...
    const I = async n => {
        var f;
        if (!n) return;
        const l = await ((f = s == null ? void 0 : s.preview) == null ? void 0 : f.call(s, n)) ?? null;
        j(l ? n : null), b(l), z(l ? "" : t.formatMessage({
        ...
        if (h) {
            ...
            try {
                await ((n = s == null ? void 0 : s.install) == null ? void 0 : n.call(s, h))
            } catch (l) {
                z(l.message, "err")
            } finally {
                M(!1)
        ...
        const n = p.trim();
        if (!n) return;
        const l = await ((f = s == null ? void 0 : s.setName) == null ? void 0 : f.call(s, n));
        z(l ? t.formatMessage({
        ...
        var n;
        a != null && a.paired ? (n = s == null ? void 0 : s.pairDevice) == null || n.call(s).then(w) : N(!0)
    }, Q = () => {
        var n;
        (n = s == null ? void 0 : s.cancelScan) == null || n.call(s), N(!1), w()
    };
    return e.jsxs("div", {
        className: "buddy-body h-screen flex flex-col font-sans text-sm select-none nc-drag",
        children: [e.jsxs("header", {
            ...
            className: "flex-1 px-6 pt-5 pb-5 flex flex-col gap-4 nc-no-drag min-h-0 overflow-hidden",
            children: [e.jsxs("div", {
                ...
                children: [e.jsx(ne, {
                    ...
                    onForget: () => {
                        var n;
                        return void((n = s == null ? void 0 : s.forgetDevice) == null ? void 0 : n.call(s).then(w))
                    }
                }), e.jsxs("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        onClick: () => {
                            var n;
                            return void((n = s == null ? void 0 : s.pickFolder) == null ? void 0 : n.call(s).then(I))
                        },
                        onDragOver: n => {
                        ...
                        onDrop: n => {
                            ...
                            l && I(window.buddy.getPathForFile(l))
                        },
                        children: [e.jsx("div", {
                            className: "text-[13px]",
                            style: u,
            ...
            onSubmit: n => {
                var l;
                (l = s == null ? void 0 : s.submitPin) == null || l.call(s, n), O(null), w()
            }
        }), L && e.jsx(oe, {
            onClose: Q,
            onPick: n => {
                var l;
                return void((l = s == null ? void 0 : s.pickDevice) == null ? void 0 : l.call(s, n).then(() => {
                    N(!1), w()
                }))
            }
        })]
