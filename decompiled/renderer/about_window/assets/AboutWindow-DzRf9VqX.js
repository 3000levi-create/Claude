...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            t = new e.Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e504c6cc-5398-4e18-9dea-7972cac16684", e._sentryDebugIdIdentifier = "sentry-dbid-e504c6cc-5398-4e18-9dea-7972cac16684")
    })()
} catch {}
...
function H(e) {
    ...
    return typeof m == "function" ? m(Array.isArray(p) ? p : [p]) : c ? l.createElement(c, null, p) : l.createElement(l.Fragment, null, p)
}
...
function M(e) {
    ...
    if (typeof e == "string" || typeof e == "number") s += e;
        ...
        if (Array.isArray(e)) {
            var a = e.length;
            for (t = 0; t < a; t++) e[t] && (n = M(e[t])) && (s && (s += " "), s += n)
        } else
...
function b() {
    for (var e, t, n = 0, s = "", a = arguments.length; n < a; n++)(e = arguments[n]) && (t = M(e)) && (s && (s += " "), s += t);
    return s
}
const S = (e = "primary") => b("inline-flex items-center justify-center relative shrink-0 select-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none disabled:drop-shadow-none", {
    ...
    I = (e = "default", t, n) => {
        ...
        return t && (e === "default" ? a = a.replace("px-4", "pl-2 pr-3 gap-1") : e === "lg" ? a = a.replace("px-5", "pl-2.5 pr-3.5 gap-1") : e === "sm" && (a = a.replace("px-3", "pl-2 pr-2.5 gap-1"))), n && (e === "default" ? a = a.replace("px-4", "pl-3 pr-2 gap-1") : e === "lg" ? a = a.replace("px-5", "pl-3.5 pr-2.5 gap-1") : e === "sm" && (a = a.replace("px-3", "pl-2.5 pr-2 gap-1"))), a
    },
    v = l.forwardRef(({
        className: e,
        variant: t = "primary",
...
var N;
const r = (N = globalThis["claude.internal.ui"]) == null ? void 0 : N.AboutWindow;
var j;
...
function $({
    ...
    l.useEffect(() => {
        (async () => {
            var L;
            const f = await ((L = r == null ? void 0 : r.getAppName) == null ? void 0 : L.call(r));
            f && n(f)
        })()
    }, []);
    const s = "Windows",
        a = t || "Claude";
    return i.jsxs("h2", {
        className: b(e, "font-serif font-medium text-text-100 text-2xl select-none"),
        style: {
            maxWidth: "95%"
        },
        children: [a, " ", i.jsx("em", {
...
function D() {
    const [e, t] = l.useState(null), [n, s] = l.useState(!1), d = (e == null ? void 0 : e.commitHash) && e.commitHash !== "unknown" ? e.commitHash.slice(0, 6) : "Unknown", f = `${process.version} (${d})`, L = l.useCallback(() => {
        var o;
        ...
        var o;
        try {
            const g = `${await((o=r==null?void 0:r.getAppName)==null?void 0:o.call(r))} ${process.version} (${d}) ${(e==null?void 0:e.commitTimestamp)||""}`.trim();
    ...
    return l.useEffect(() => {
        var o;
        (o = r == null ? void 0 : r.getBuildProps) == null || o.call(r).then(c => {
            t(c)
        }).catch(c => {
        ...
        children: [i.jsx(B, {
            ...
            className: "w-full px-16 mt-6 flex flex-col font-sans text-xl font-medium text-text-100 nc-no-drag",
            children: [i.jsx(v, {
                variant: "secondary",
                onClick: L,
                children: i.jsx(h, {
