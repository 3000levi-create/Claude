...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            t = new e.Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "12b5bfde-030e-4af9-8bbd-e226cbed6c6b", e._sentryDebugIdIdentifier = "sentry-dbid-12b5bfde-030e-4af9-8bbd-e226cbed6c6b")
    })()
} catch {}
...
const h = require("./index.chunk-c42vKsva.js"),
    ...
    r = "\x1B",
    p = "\x07",
    S = new RegExp(r + "\\[[0-9;?]*[A-Za-z]", "g"),
    E = new RegExp(r + "\\][^" + p + r + "]*(?:" + p + "|" + r + "\\\\)", "g"),
    I = "Terminal is not open. Ask the user to open the terminal panel first.";
    ...
    return {
        ...
        handleToolCall: async (e, t, a) => {
            ...
            const [{
                ...
                shellPtyKeyFor: b
            }] = await Promise.all([Promise.resolve().then(() => require("./index.chunk-B3Z2xpgG.js")), Promise.resolve().then(() => require("./index.chunk-Dtoqdu4o.js"))]), l = typeof t.tab_id == "string" ? t.tab_id : void 0, i = b(a.sessionId, l), d = i === a.sessionId ? I : N(l ?? ""), o = typeof t.wait_for_output_ms == "number" ? t.wait_for_output_ms : void 0;
            let u = "";
            if (o !== void 0) {
                const n = await s.shellPty.waitForTerminalOutput(i, o);
                if ("noShell" in n) return {
                    content: [{
                        type: "text",
                        text: d
                    }]
                };
                "timedOut" in n && (u = "[waited " + o + `ms — no new output; the watcher may not have reacted yet, or nothing is watching]
...
`).map(n => {
                ...
                y = typeof t.lines == "number" && Number.isFinite(t.lines) ? t.lines : 200,
                w = Math.max(1, Math.min(y, 1e3)),
                _ = m.slice(-w).join(`
`);
            return {
                content: [{
