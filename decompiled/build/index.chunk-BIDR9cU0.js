...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            a = new e.Error().stack;
        a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "a7fa7dca-1524-4565-9595-23b8e1afe0f0", e._sentryDebugIdIdentifier = "sentry-dbid-a7fa7dca-1524-4565-9595-23b8e1afe0f0")
    })()
} catch {}
...
async function r(e, a, o, n) {
    const s = n ? t.getIntl().formatMessage({
        ...
        i = d === 0;
    return t.logger.info(`User ${i?"accepted":"declined"} update for org-scoped extension '${e}' (${a} → ${o})`), i
}
