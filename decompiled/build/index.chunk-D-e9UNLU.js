...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            t = new e.Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "79e65fba-2d50-4859-b608-50c76ca3aa4f", e._sentryDebugIdIdentifier = "sentry-dbid-79e65fba-2d50-4859-b608-50c76ca3aa4f")
    })()
} catch {}
...
function y(e) {
    return e.command ? `command: ${e.command}` : e.file_path ? `file: ${e.file_path}` : e.path ? `path: ${e.path}` : e.pattern ? `pattern: ${e.pattern}` : ""
}
...
function p(e) {
    ...
    s.length !== t.length && (e.tool_use_result = s)
}

function c(e) {
    var s;
    if (e.type !== "user") return !1;
    const t = (s = e.message) == null ? void 0 : s.content;
    return Array.isArray(t) ? t.some(n => n !== null && typeof n == "object" && "type" in n && n.type === "tool_result") : !1
}
...
function _(e) {
    ...
    const n = {
        ...
        r = t.message;
    if (r != null && r.model && (n.last_message_model = r.model), t.type === "assistant") {
        const o = f(t);
        o && (n.last_tool_name = o)
    } else if (t.type === "tool_progress") {
        const o = t.tool_name;
        typeof o == "string" && (n.last_tool_name = o)
