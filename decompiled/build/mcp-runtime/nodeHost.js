...
process.parentPort.once("message", e => {
  ...
  if (process.stdin) {
    const methods = ["read", "push", "unshift", "pause", "resume", "pipe", "unpipe", "on", "once", "removeListener", "removeAllListeners", "setEncoding", "destroy", "isPaused", "readableLength", "readable"];
