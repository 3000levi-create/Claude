...
try {
    (function() {
        var r = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            e = new r.Error().stack;
        e && (r._sentryDebugIds = r._sentryDebugIds || {}, r._sentryDebugIds[e] = "66654af2-65af-4da0-a47b-f0d079b6a9dc", r._sentryDebugIdIdentifier = "sentry-dbid-66654af2-65af-4da0-a47b-f0d079b6a9dc")
    })()
} catch {}
const b = require("electron"),
    x = require("electron/renderer");

function Re() {
    var r;
    return "frameToken" in x.webFrame && x.webFrame.top && "frameToken" in x.webFrame.top ? x.webFrame.top.frameToken === x.webFrame.frameToken : ((r = x.webFrame.top) == null ? void 0 : r.routingId) === x.webFrame.routingId
}
const Ne = {
        status() {
        ...
        onProgress(r) {
            const e = (t, s) => r(s);
            return b.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.buddy_$_Buddy_$_progress", e), () => {
                b.ipcRenderer.removeListener("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.buddy_$_Buddy_$_progress", e)
            }
        },
        onPairingPrompt(r) {
            const e = (t, s) => r(s);
            return b.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.buddy_$_Buddy_$_pairingPrompt", e), () => {
                b.ipcRenderer.removeListener("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.buddy_$_Buddy_$_pairingPrompt", e)
            }
        }
    },
    Se = r => {
        Re() && (r["claude.buddy"] = r["claude.buddy"] || {}, r["claude.buddy"].Buddy = Ne)
    },
    xe = {};
Se(xe);
for (const [r, e] of Object.entries(xe)) b.contextBridge.exposeInMainWorld(r, e);
...
const Ae = {
        ...
        onLocaleChanged(r) {
            const e = (t, s, n) => r(s, n);
            return b.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.hybrid_$_DesktopIntl_$_localeChanged", e), () => {
    ...
    Ze = r => {
        Ie() && (r["claude.hybrid"] = r["claude.hybrid"] || {}, r["claude.hybrid"].DesktopIntl = Ae)
    },
    we = {};
Ze(we);
for (const [r, e] of Object.entries(we)) b.contextBridge.exposeInMainWorld(r, e);
...
const u = y.arrayToEnum(["string", "nan", "number", "integer", "float", "boolean", "date", "bigint", "symbol", "function", "undefined", "null", "array", "object", "unknown", "promise", "void", "never", "map", "set"]),
    ...
    o = y.arrayToEnum(["invalid_type", "invalid_literal", "custom", "invalid_union", "invalid_union_discriminator", "invalid_enum_value", "unrecognized_keys", "invalid_arguments", "invalid_return_type", "invalid_date", "invalid_string", "too_small", "too_big", "invalid_intersection_types", "not_multiple_of", "not_finite"]);
        ...
        const t = e || function(a) {
            ...
            n = a => {
                for (const i of a.issues)
                    ...
                    for (; f < i.path.length;) {
                        const h = i.path[f];
                        f === i.path.length - 1 ? (d[h] = d[h] || {
                            _errors: []
                        }, d[h]._errors.push(t(i))) : d[h] = d[h] || {
                            _errors: []
                        }, d = d[h], f++
                    }
                }
...
function c(r, e) {
    const t = De(),
        s = Pe({
            ...
            data: r.data,
            path: r.path,
            errorMaps: [r.common.contextualErrorMap, r.schemaErrorMap, t, t === G ? void 0 : G].filter(n => !!n)
        });
...
const Le = /^c[^\s-]{8,}$/i,
    Ve = /^[0-9a-z]+$/,
    Me = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
    Be = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
    ze = /^[a-z0-9_-]{21}$/i,
...
const Je = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
    ...
    Ye = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/,
...
class R extends g {
    _parse(e) {
        ...
        for (const a of this._def.checks)
            if (a.kind === "min") e.data.length < a.value && (n = this._getOrReturnCtx(e, n), c(n, {
                code: o.too_small,
                minimum: a.value,
                type: "string",
                inclusive: !0,
            ...
            else if (a.kind === "max") e.data.length > a.value && (n = this._getOrReturnCtx(e, n), c(n, {
            code: o.too_big,
            maximum: a.value,
            type: "string",
            inclusive: !0,
        ...
        } else if (a.kind === "email") We.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "email",
            code: o.invalid_string,
            message: a.message
        }), s.dirty());
        else if (a.kind === "emoji") H || (H = new RegExp(qe, "u")), H.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "emoji",
            code: o.invalid_string,
            message: a.message
        }), s.dirty());
        else if (a.kind === "uuid") Be.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "uuid",
            code: o.invalid_string,
            message: a.message
        }), s.dirty());
        else if (a.kind === "nanoid") ze.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "nanoid",
            code: o.invalid_string,
            message: a.message
        }), s.dirty());
        else if (a.kind === "cuid") Le.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "cuid",
            code: o.invalid_string,
            message: a.message
        }), s.dirty());
        else if (a.kind === "cuid2") Ve.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "cuid2",
            code: o.invalid_string,
            message: a.message
        }), s.dirty());
        else if (a.kind === "ulid") Me.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "ulid",
            code: o.invalid_string,
            message: a.message
        }), s.dirty());
            ...
            message: a.message
        }), s.dirty()) : a.kind === "datetime" ? tt(a).test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            code: o.invalid_string,
            validation: "datetime",
            message: a.message
        }), s.dirty()) : a.kind === "date" ? Ke.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            code: o.invalid_string,
            validation: "date",
            message: a.message
        }), s.dirty()) : a.kind === "time" ? et(a).test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            code: o.invalid_string,
            validation: "time",
            message: a.message
        }), s.dirty()) : a.kind === "duration" ? Ue.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "duration",
            code: o.invalid_string,
            message: a.message
        }), s.dirty()) : a.kind === "ip" ? rt(e.data, a.version) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "ip",
            code: o.invalid_string,
            message: a.message
        }), s.dirty()) : a.kind === "jwt" ? st(e.data, a.alg) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "jwt",
            code: o.invalid_string,
            message: a.message
        }), s.dirty()) : a.kind === "cidr" ? nt(e.data, a.version) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "cidr",
            code: o.invalid_string,
            message: a.message
        }), s.dirty()) : a.kind === "base64" ? Xe.test(e.data) || (n = this._getOrReturnCtx(e, n), c(n, {
            validation: "base64",
            code: o.invalid_string,
            message: a.message
...
class M extends g {
    ...
    _parse(e) {
        ...
        let s;
        const n = new w;
        for (const a of this._def.checks) a.kind === "int" ? y.isInteger(e.data) || (s = this._getOrReturnCtx(e, s), c(s, {
            code: o.invalid_type,
            expected: "integer",
            received: "float",
            message: a.message
            ...
            exact: !1,
            message: a.message
        }), n.dirty()) : a.kind === "multipleOf" ? at(e.data, a.value) !== 0 && (s = this._getOrReturnCtx(e, s), c(s, {
...
class B extends g {
    ...
    _parse(e) {
        ...
        let s;
        const n = new w;
        for (const a of this._def.checks) a.kind === "min" ? (a.inclusive ? e.data < a.value : e.data <= a.value) && (s = this._getOrReturnCtx(e, s), c(s, {
            code: o.too_small,
            type: "bigint",
            minimum: a.value,
            inclusive: a.inclusive,
...
class U extends g {
    _parse(e) {
        ...
        const s = new w;
        let n;
        for (const a of this._def.checks) a.kind === "min" ? e.data.getTime() < a.value && (n = this._getOrReturnCtx(e, n), c(n, {
            code: o.too_small,
            message: a.message,
            inclusive: !0,
            exact: !1,
...
class T extends g {
    _parse(e) {
        ...
        if (t.parsedType !== u.array) return c(t, {
            code: o.invalid_type,
            expected: u.array,
            received: t.parsedType
        }), m;
        ...
        if (n.minLength !== null && t.data.length < n.minLength.value && (c(t, {
            ...
            }), s.dirty()), t.common.async) return Promise.all([...t.data].map((i, d) => n.type._parseAsync(new S(t, i, t.path, d)))).then(i => w.mergeArray(s, i));
...
function Z(r) {
    if (r instanceof k) {
        ...
        ...r._def,
        type: Z(r.element)
    }) : r instanceof N ? N.create(Z(r.unwrap())) : r instanceof P ? P.create(Z(r.unwrap())) : r instanceof A ? A.create(r.items.map(e => Z(e))) : r
}
class k extends g {
    constructor() {
    ...
    _parse(e) {
        ...
        if (this._def.catchall instanceof I) {
            ...
            else if (h === "strict") d.length > 0 && (c(n, {
    ...
    pick(e) {
        const t = {};
        for (const s of y.objectKeys(e)) e[s] && this.shape[s] && (t[s] = this.shape[s]);
        return new k({
            ...this._def,
            shape: () => t
        })
...
function Q(r, e) {
    ...
    } else return t === u.date && s === u.date && +r == +e ? {
        valid: !0,
        data: r
    } : {
        valid: !1
...
class q extends g {
    _parse(e) {
        const {
            ...
            return d.valid ? ((oe(a) || oe(i)) && t.dirty(), {
                status: t.value,
                value: d.data
            }) : (c(s, {
...
class A extends g {
    _parse(e) {
        ...
        if (s.parsedType !== u.array) return c(s, {
            code: o.invalid_type,
            expected: u.array,
            received: s.parsedType
        }), m;
        if (s.data.length < this._def.items.length) return c(s, {
            code: o.too_small,
...
class _e extends g {
    ...
    _parse(e) {
        ...
        if (s.parsedType !== u.map) return c(s, {
            code: o.invalid_type,
            expected: u.map,
            received: s.parsedType
        }), m;
...
class z extends g {
    _parse(e) {
        ...
        if (s.parsedType !== u.set) return c(s, {
            code: o.invalid_type,
            expected: u.set,
            received: s.parsedType
        }), m;
...
class J extends g {
    ...
    _parse(e) {
        ...
        if (t.parsedType !== u.promise && t.common.async === !1) return c(t, {
            code: o.invalid_type,
            expected: u.promise,
            received: t.parsedType
        }), m;
...
class D extends g {
    ...
    _parse(e) {
        ...
        if (a.addIssue = a.addIssue.bind(a), n.type === "preprocess") {
            ...
            if (s.common.async) return Promise.resolve(i).then(async d => {
                ...
                return f.status === "aborted" ? m : f.status === "dirty" || t.value === "dirty" ? V(f.value) : f
            });
            {
                if (t.value === "aborted") return m;
                ...
                return d.status === "aborted" ? m : d.status === "dirty" || t.value === "dirty" ? V(d.value) : d
            }
        }
        if (n.type === "refinement") {
            ...
            if (s.common.async === !1) {
                ...
                return d.status === "aborted" ? m : (d.status === "dirty" && t.dirty(), i(d.value), {
                    status: t.value,
                    value: d.value
                })
...
class N extends g {
    _parse(e) {
        return this._getType(e) === u.undefined ? $(void 0) : this._def.innerType._parse(e)
    }
    unwrap() {
...
class P extends g {
    _parse(e) {
        return this._getType(e) === u.null ? $(null) : this._def.innerType._parse(e)
    }
    unwrap() {
        return this._def.innerType
    }
...
class se extends g {
    _parse(e) {
        ...
        if (s.common.async) return (async () => {
            ...
            return a.status === "aborted" ? m : a.status === "dirty" ? (t.dirty(), V(a.value)) : this._def.out._parseAsync({
                data: a.value,
                path: s.path,
                parent: s
            })
...
function lt() {
    const r = JSON.parse('{"commitHash":"df1d8a339dfabcf359af7144fe142b59ff7d9a0f","isNestBuild":false,"commitTimestamp":"2026-07-10T21:55:12.000Z","buildType":"prod","appVersion":"1.20186.1"}'),
        e = ut.safeParse(r);
...
var ke = {};
const ft = Object.fromEntries(["arch", "platform", "type", "versions"].map(r => [r, !0])),
