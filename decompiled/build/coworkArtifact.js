...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            n = new e.Error().stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "34e3cd4b-edaf-4dec-b331-177e1f2a4c27", e._sentryDebugIdIdentifier = "sentry-dbid-34e3cd4b-edaf-4dec-b331-177e1f2a4c27")
    })()
} catch {}
...
r.contextBridge.exposeInMainWorld("cowork", {
    callMcpTool: (e, n) => {
        var a;
        return (a = t.callMcpTool) == null ? void 0 : a.call(t, e, n, {
    ...
    runScheduledTask: e => {
        var n;
        return (n = t.runScheduledTask) == null ? void 0 : n.call(t, e, {
            hasUserActivation: navigator.userActivation.isActive
        })
    }
});
...
function c(e) {
    ...
    const n = (d = (a = e.target) == null ? void 0 : a.closest) == null ? void 0 : d.call(a, "a[href]");
    n instanceof HTMLAnchorElement && (!n.protocol || n.protocol === "cowork-artifact:" || (e.preventDefault(), (i = t.openExternalUrl) == null || i.call(t, n.href)))
}
...
process.platform === "darwin" && window.addEventListener("mouseup", e => {
    var n, a;
    e.isTrusted && (e.button === 3 ? (e.preventDefault(), (n = t.navigateHost) == null || n.call(t, o.Back)) : e.button === 4 && (e.preventDefault(), (a = t.navigateHost) == null || a.call(t, o.Forward)))
}, !0);
