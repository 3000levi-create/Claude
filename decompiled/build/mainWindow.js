...
try {
    (function() {
        var t = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            e = new t.Error().stack;
        e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "8ebc2e11-cea3-4aa7-9ae3-11df592f3caa", t._sentryDebugIdIdentifier = "sentry-dbid-8ebc2e11-cea3-4aa7-9ae3-11df592f3caa")
    })()
} catch {}
...
function wr() {
    ...
    return ("frameToken" in w.webFrame && w.webFrame.top && "frameToken" in w.webFrame.top ? w.webFrame.top.frameToken === w.webFrame.frameToken : ((e = w.webFrame.top) == null ? void 0 : e.routingId) === w.webFrame.routingId) && (t.origin === "null" || t.origin === null ? `${t.protocol}//${t.host}` : t.origin) === "app://localhost"
}
const Rs = {
        getAppConfig() {
    ...
    Cs = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].AppConfig = Rs)
    },
    Is = {
    ...
    Ts = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].Startup = Is)
    },
    As = {
        setGlobalShortcut(t) {
        ...
        onGlobalShortcutChange(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_GlobalShortcut_$_globalShortcutChange", e), () => {
    ...
    Ns = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].GlobalShortcut = As)
    },
    Os = {
        ...
        onMcpConfigChange(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_MCP_$_mcpConfigChange", e), () => {
        ...
        onMcpStatusChanged(t) {
            ...
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_MCP_$_mcpStatusChanged", e), () => {
        ...
        onRevealMcpServerSettingsRequested(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_MCP_$_revealMcpServerSettingsRequested", e), () => {
    ...
    Ds = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].MCP = Os)
    },
    Ms = {
        isExtensionsEnabled() {
        ...
        onExtensionsChanged(t) {
            const e = n => t();
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_Extensions_$_extensionsChanged", e), () => {
        ...
        onExtensionSettingsChanged(t) {
            const e = (n, r, s) => t(r, s);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_Extensions_$_extensionSettingsChanged", e), () => {
        ...
        onPreviewExtensionInstallation(t) {
            ...
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_Extensions_$_previewExtensionInstallation", e), () => {
        ...
        onExtensionDownloadProgress(t) {
            ...
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_Extensions_$_extensionDownloadProgress", e), () => {
    ...
    Ps = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].Extensions = Ms)
    },
    Ls = {
        getDirectoryPath(t) {
    ...
    Fs = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].FilePickers = Ls)
    },
    js = {
        getPreferences() {
        ...
        onPreferencesChanged(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_AppPreferences_$_preferencesChanged", e), () => {
    ...
    Us = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].AppPreferences = js)
    },
    Bs = {
    ...
    Ws = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].AppFeatures = Bs)
    },
    Zs = {
        getSystemInfo() {
    ...
    Hs = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].DesktopInfo = Zs)
    },
    Vs = {
        exportConfig(t, e) {
        ...
        bootstrapStateStore: {
            ...
            onStateChange(t) {
                const e = (n, r) => t(r);
                return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_Custom3pSetup_$_bootstrapState_$store$_update", e), () => {
    ...
    zs = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].Custom3pSetup = Vs)
    },
    qs = {
        ...
        onProbeDeviceCode(t) {
            const e = (n, r, s) => t(r, s);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_Custom3pHelperRun_$_probeDeviceCode", e), () => {
    ...
    Gs = t => {
        wr() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].Custom3pHelperRun = qs)
    },
    Ys = {
        isAvailable() {
        ...
        onOnAuthUserCode(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_ClaudeAiImport_$_onAuthUserCode", e), () => {
        ...
        onOnAuthStateChange(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_ClaudeAiImport_$_onAuthStateChange", e), () => {
    ...
    Js = t => {
        wr() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].ClaudeAiImport = Ys)
    },
    Ks = {
        submitAction(t) {
        ...
        supportBundleStateStore: {
            ...
            onStateChange(t) {
                const e = (n, r) => t(r);
                return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.settings_$_SupportBundle_$_supportBundleState_$store$_update", e), () => {
    ...
    Xs = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].SupportBundle = Ks)
    },
    Qs = {
        getStatus() {
    ...
    ei = t => {
        j() && (t["claude.settings"] = t["claude.settings"] || {}, t["claude.settings"].WakeScheduler = Qs)
    },
    D = {};
Cs(D);
Ts(D);
...
function Ht() {
    var t;
    return "frameToken" in w.webFrame && w.webFrame.top && "frameToken" in w.webFrame.top ? w.webFrame.top.frameToken === w.webFrame.frameToken : ((t = w.webFrame.top) == null ? void 0 : t.routingId) === w.webFrame.routingId
}
const ti = {
        openHelp() {
    ...
    ni = t => {
        Ht() && (t["claude.internal.ui"] = t["claude.internal.ui"] || {}, t["claude.internal.ui"].AboutWindow = ti)
    },
    ri = {
        requestDismiss(t) {
    ...
    si = t => {
        Ht() && (t["claude.internal.ui"] = t["claude.internal.ui"] || {}, t["claude.internal.ui"].QuickWindow = ri)
    },
    ii = {
        titleBarReady() {
        ...
        onUpdateTitleBar(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.ui_$_MainWindowTitleBar_$_updateTitleBar", e), () => {
        ...
        onShowLoadError(t) {
            const e = (n, r) => t(r);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.ui_$_MainWindowTitleBar_$_showLoadError", e), () => {
        ...
        onHideLoadError(t) {
            const e = n => t();
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.ui_$_MainWindowTitleBar_$_hideLoadError", e), () => {
    ...
    ai = t => {
        Ht() && (t["claude.internal.ui"] = t["claude.internal.ui"] || {}, t["claude.internal.ui"].MainWindowTitleBar = ii)
    },
    nt = {};
ni(nt);
si(nt);
ai(nt);
for (const [t, e] of Object.entries(nt)) d.contextBridge.exposeInMainWorld(t, e);
...
const ci = {
        ...
        onLocaleChanged(t) {
            const e = (n, r, s) => t(r, s);
            return d.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.hybrid_$_DesktopIntl_$_localeChanged", e), () => {
    ...
    ui = t => {
        oi() && (t["claude.hybrid"] = t["claude.hybrid"] || {}, t["claude.hybrid"].DesktopIntl = ci)
    },
    Rr = {};
ui(Rr);
for (const [t, e] of Object.entries(Rr)) d.contextBridge.exposeInMainWorld(t, e);
...
function Ar(t) {
    ...
    return /sentryWrapped/.test(je(e).function || "") && e.pop(), e.reverse(), pn.test(je(e).function || "") && (e.pop(), pn.test(je(e).function || "") && e.pop()), e.slice(0, Ir).map(n => ({
        ...n,
...
function B(t, e) {
    ...
    if (n)
        for (const r of n) try {
            ...
            E && y.error(`Error while triggering instrumentation handler.
Type: ${t}
Name: ${te(r)}
Error:`, s)
        }
...
function yi() {
    ft = R.onerror, R.onerror = function(t, e, n, r, s) {
        return B("error", {
            column: r,
            error: s,
            line: n,
...
function vi() {
    pt = R.onunhandledrejection, R.onunhandledrejection = function(t) {
...
function Pr(t, e = {}) {
    ...
    try {
        ...
        const l = Array.isArray(e) ? e : e.keyAttrs,
            f = !Array.isArray(e) && e.maxStringLength || Ri;
        for (; n && i++ < r && (u = Ci(n, l), !(u === "html" || i > 1 && a + s.length * c + u.length >= f));) s.push(u), a += u.length, n = n.parentNode;
...
function Ci(t, e) {
    ...
    if (s != null && s.length) s.forEach(a => {
        r.push(`[${a[0]}="${a[1]}"]`)
    });
    else {
        n.id && r.push(`#${n.id}`);
...
function gn(t) {
    try {
        return Si(t) ? Pr(t) : Object.prototype.toString.call(t)
    } catch {
        return "<unknown>"
    }
}
...
function yn(t, e) {
    ...
    for (let r = 0; r < t.length; r++) {
        const s = t[r];
        try {
            Mr(s) ? n.push(Nr(s)) : n.push(String(s))
        } catch {
...
function Ve(t, e, n = !1) {
    return z(t) ? ki(e) ? e.test(t) : z(e) ? n ? t === e : t.includes(e) : !1 : !1
}
...
function L(t = Ai()) {
    ...
    return _t || (_t = "10000000100040008000" + 1e11), _t.replace(/[018]/g, e => (e ^ (Ni() & 15) >> e / 4).toString(16))
}
...
function Pe(t, e, n = 2) {
    ...
    for (const s in e) Object.prototype.hasOwnProperty.call(e, s) && (r[s] = Pe(r[s], e[s], n - 1));
    return r
}
...
class G {
    ...
    clone() {
        ...
        }, e._client = this._client, e._lastEventId = this._lastEventId, Sn(e, kn(this)), e
    }
    setClient(e) {
        this._client = e
    }
    ...
    setUser(e) {
        return this._user = e || {
            ...
            ip_address: void 0,
            username: void 0
        }, this._session && he(this._session, {
            user: e
    ...
    update(e) {
        ...
        return this._tags = {
            ...
            ...this._contexts,
            ...c
        }, o && Object.keys(o).length && (this._user = o), u && (this._level = u), l.length && (this._fingerprint = l), f && (this._propagationContext = f), this
    }
    clear() {
        return this._breadcrumbs = [], this._tags = {}, this._attributes = {}, this._extra = {}, this._user = {}, this._contexts = {}, this._level = void 0, this._transactionName = void 0, this._fingerprint = void 0, this._session = void 0, Sn(this, void 0), this._attachments = [], this.setPropagationContext({
            traceId: En(),
            sampleRand: Math.random()
        }), this._notifyScopeListeners(), this
    }
    ...
    captureException(e, n) {
        ...
        if (!this._client) return E && y.warn("No client configured on scope - will not capture exception!"), r;
    ...
    captureMessage(e, n, r) {
        ...
        if (!this._client) return E && y.warn("No client configured on scope - will not capture message!"), s;
    ...
    captureEvent(e, n) {
        ...
        return this._client ? (this._client.captureEvent(e, {
            ...n,
            event_id: r
        }, this), r) : (E && y.warn("No client configured on scope - will not capture event!"), r)
    }
...
class Bi {
    ...
    withScope(e) {
        ...
        return De(r) ? r.then(s => (this._popScope(), s), s => {
            throw this._popScope(), s
        }) : (this._popScope(), r)
    }
    getClient() {
...
const qi = "sentry.source",
    Gi = "sentry.sample_rate",
    Yi = "sentry.previous_trace_sample_rate",
    Ji = "sentry.op",
    Ki = "sentry.origin",
    Wr = "sentry.profile_id",
    Zr = "sentry.exclusive_time",
    Xi = 0,
    Qi = 1,
    ea = "_sentryScope",
    ta = "_sentryIsolationScope";
...
function aa(t) {
    if (!(!t || !z(t) && !Array.isArray(t))) return Array.isArray(t) ? t.reduce((e, n) => {
        const r = wn(n);
...
function la(t) {
    ...
    return ["protocol", "publicKey", "host", "projectId"].find(a => t[a] ? !1 : (y.error(`Invalid Sentry Dsn: ${a} missing`), !0)) ? !1 : n.match(/^\d+$/) ? ua(r) ? e && isNaN(parseInt(e, 10)) ? (y.error(`Invalid Sentry Dsn: Invalid port ${e}`), !1) : !0 : (y.error(`Invalid Sentry Dsn: Invalid protocol ${r}`), !1) : (y.error(`Invalid Sentry Dsn: Invalid projectId ${n}`), !1)
}
...
function pa(t) {
    ...
    let r;
    return e.orgId ? r = String(e.orgId) : n && (r = fa(n)), r
}
...
function ma(t) {
    const {
        ...
        traceId: n,
        isRemote: r
    } = t.spanContext(), s = r ? e : en(t).parent_span_id, i = Hr(t).scope, a = r ? (i == null ? void 0 : i.getPropagationContext().propagationSpanId) || Br() : e;
    return {
        parent_span_id: s,
        span_id: a,
        trace_id: n
...
function Cn(t) {
    return typeof t == "number" ? In(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? In(t.getTime()) : q()
}
...
function en(t) {
    ...
    if (ba(t)) {
        const {
            ...
            status: c,
            links: u
        } = t, l = "parentSpanId" in t ? t.parentSpanId : "parentSpanContext" in t ? (r = t.parentSpanContext) == null ? void 0 : r.spanId : void 0;
        return {
            span_id: e,
            trace_id: n,
            data: s,
...
function va(t) {
    if (!(!t || t.code === Xi)) return t.code === Qi ? "ok" : t.message || "internal_error"
}
...
function Ca(t) {
    ...
    const n = qr(t),
        ...
        a = (i == null ? void 0 : i.get("sentry.sample_rate")) ?? s[Gi] ?? s[Yi];

    function o(M) {
        return (typeof a == "number" || typeof a == "string") && (M.sample_rate = `${a}`), M
    }
    const c = n[wa];
    if (c) return o(c);
    ...
    const f = Gr(t.spanContext().traceId, e),
        b = s[qi],
        _ = r.description;
    return b !== "url" && _ && (f.transaction = _), Sa() && (f.sampled = String($a(n)), f.sample_rand = (i == null ? void 0 : i.get("sentry.sample_rand")) ?? ((C = Hr(n).scope) == null ? void 0 : C.getPropagationContext().sampleRand.toString())), o(f), e.emit("createDsc", f, n), f
}
...
function Yr(t, e = 3, n = 100 * 1024) {
    const r = W(t, e);
    return Na(r) > n ? Yr(t, e - 1, n) : r
}

function xt(t, e, n = 1 / 0, r = 1 / 0, s = Oa()) {
    const [i, a] = s;
    ...
    const b = Fr(e);
    for (const _ in b) {
        if (!Object.prototype.hasOwnProperty.call(b, _)) continue;
        if (f >= r) {
            l[_] = "[MaxProperties ~]";
            break
        }
...
function Ma(t) {
    ...
    function s(i) {
        typeof r == "string" ? r = typeof i == "string" ? r + i : [wt(r), i] : r.push(typeof i == "string" ? wt(i) : i)
    }
    for (const i of n) {
        const [a, o] = i;
        if (s(`
...
function Ua(t, e) {
    ...
    return t.sdk = {
        ...
        settings: (i = t.sdk) != null && i.settings || e.settings ? {
            ...(a = t.sdk) == null ? void 0 : a.settings,
            ...e.settings
        } : void 0
    }, t
}
...
function Wa(t, e, n, r) {
    ...
    const a = ja(t, s, r, e);
    return delete t.sdkProcessingMetadata, xe(a, [
        [{
            type: i
        }, t]
    ])
...
class Ie {
    ...
    _executeHandlers() {
        ...
        this._handlers = [], e.forEach(n => {
            n[0] || (this._state === Mn && n[1](this._value), this._state === Pn && n[2](this._value), n[0] = !0)
        })
    }
    _runExecutor(e) {
        const n = (i, a) => {
...
function Rt(t, e, n, r) {
    ...
    return E && i === null && y.log(`Event processor "${s.id||"?"}" dropped event`), De(i) ? i.then(a => Rt(a, e, n, r + 1)) : Rt(i, e, n, r + 1)
}
...
function Ha(t, e) {
    ...
    Va(t, e), r && Ga(t, r), Ya(t, n), za(t, s), qa(t, i)
}
...
function Ye(t, e) {
    ...
    Ue(t, "extra", n), Ue(t, "tags", r), Ue(t, "user", s), Ue(t, "contexts", i), t.sdkProcessingMetadata = Pe(t.sdkProcessingMetadata, o, 2), a && (t.level = a), _ && (t.transactionName = _), C && (t.span = C), c.length && (t.breadcrumbs = [...t.breadcrumbs, ...c]), u.length && (t.fingerprint = [...t.fingerprint, ...u]), l.length && (t.eventProcessors = [...t.eventProcessors, ...l]), f.length && (t.attachments = [...t.attachments, ...f]), t.propagationContext = {
...
function Va(t, e) {
    ...
    Object.keys(n).length && (t.extra = {
        ...
        ...i,
        ...t.contexts
    }), a && (t.level = a), o && t.type !== "transaction" && (t.transaction = o)
}
...
function Ka(t, e, n, r, s, i) {
    ...
    Xa(c, t), to(c, u), s && s.emit("applyFrameMetadata", e), e.type === void 0 && Qa(c, t.stackParser);
    ...
    _.length && (n.attachments = _), Ha(c, b);
    const C = [...f, ...b.eventProcessors];
    return Za(C, c, n).then(A => (A && eo(A), typeof a == "number" && a > 0 ? no(A, a, o) : A))
}
...
function Xa(t, e) {
    ...
    const a = t.request;
    a != null && a.url && i && (a.url = Et(a.url, i)), i && ((c = (o = t.exception) == null ? void 0 : o.values) == null || c.forEach(u => {
...
function Qa(t, e) {
    ...
    (s = (r = t.exception) == null ? void 0 : r.values) == null || s.forEach(i => {
        var a, o;
        (o = (a = i.stacktrace) == null ? void 0 : a.frames) == null || o.forEach(c => {
...
function no(t, e, n) {
    ...
    return (s = t.contexts) != null && s.trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = W(t.contexts.trace.data, e, n))), t.spans && (r.spans = t.spans.map(a => ({
        ...a,
        ...a.data && {
            data: W(a.data, e, n)
        }
    }))), (i = t.contexts) != null && i.flags && r.contexts && (r.contexts.flags = W(t.contexts.flags, 3, n)), r
}
...
function jn(t) {
    const e = fe(),
        ...
        i = e.getSession();
    return (i == null ? void 0 : i.status) === "ok" && he(i, {
        status: "exited"
    }), Xr(), e.setSession(s), s
}
...
function es(t, e, n) {
    if (n[e.name]) {
        E && y.log(`Integration skipped because it was already installed: ${e.name}`);
        return
    }
    if (n[e.name] = e, !Bn.includes(e.name) && typeof e.setupOnce == "function" && (e.setupOnce(), Bn.push(e.name)), e.setup && typeof e.setup == "function" && e.setup(t), typeof e.preprocessEvent == "function") {
        const r = e.preprocessEvent.bind(e);
        t.on("preprocessEvent", (s, i) => r(s, i, t))
    }
    if (typeof e.processEvent == "function") {
        const r = e.processEvent.bind(e),
            s = Object.assign((i, a) => r(i, a, t), {
                id: e.name
            });
...
function ts(t, e) {
    ...
    const r = t.getOptions(),
        s = ho(n, r._metadata, r.tunnel, t.getDsn());
    ns().set(t, []), t.emit("flushLogs"), t.sendEnvelope(s)
}
...
function rs(t, e) {
    ...
    if (n.length === 0) return;
    const r = t.getOptions(),
        s = bo(n, r._metadata, r.tunnel, t.getDsn());
    ss().set(t, []), t.emit("flushMetrics"), t.sendEnvelope(s)
}
...
function sn(t = 100) {
    ...
    function s(a) {
        if (!n()) return nn(rn);
        const o = a();
        return e.add(o), o.then(() => r(o), () => r(o)), o
    }
...
function ko(t, {
    ...
    if (i)
        for (const o of i.trim().split(",")) {
            const [c, u, , , l] = o.split(":", 5), f = parseInt(c, 10), b = (isNaN(f) ? 60 : f) * 1e3;
            if (!u) s.all = r + b;
            else
                for (const _ of u.split(";")) _ === "metric_bucket" ? (!l || l.split(";").includes("custom")) && (s[_] = r + b) : s[_] = r + b
        } else a ? s.all = r + vo(a, r) : e === 429 && (s.all = r + 60 * 1e3);
    return s
}
const is = 64;
...
function as(t, e, n = sn(t.bufferSize || is)) {
    ...
    function i(a) {
        ...
        if (On(a, (f, b) => {
                const _ = Dn(b);
                So(r, _) ? t.recordDroppedEvent("ratelimit_backoff", _) : o.push(f)
        ...
        const c = xe(a[0], o),
            ...
            l = () => e({
                body: Ma(c)
            }).then(f => (f.statusCode !== void 0 && (f.statusCode < 200 || f.statusCode >= 300) && E && y.warn(`Sentry responded with status code ${f.statusCode} to sent event.`), r = ko(r, f), f), f => {
                throw u("network_error"), E && y.error("Encountered error running transport request:", f), f
            });
        return n.add(l).then(f => f, f => {
            if (f === rn) return E && y.error("Skipped sending event because buffer is full."), u("queue_overflow"), Promise.resolve({});
            throw f
        })
    }
    return {
...
function wo(t) {
    ...
    return {
        ...
        trace_id: e ?? "",
        origin: i,
        profile_id: a == null ? void 0 : a[Wr],
        exclusive_time: a == null ? void 0 : a[Zr],
...
const Zn = "Not capturing exception because it's already been captured.",
    ...
    cs = Symbol.for("SentryInternalError"),
...
function qn(t, e, n, r, s) {
    ...
    t.on(n, () => {
        ...
        i += r(c), i >= 8e5 ? s(t) : o || (o = !0, a = setTimeout(() => {
            s(t)
        }, Co))
    }), t.on("flush", () => {
        s(t)
...
class Io {
    constructor(e) {
        var r, s, i;
        if (this._options = e, this._integrations = {}, this._numProcessing = 0, this._outcomes = {}, this._hooks = {}, this._eventProcessors = [], this._promiseBuffer = sn(((r = e.transportOptions) == null ? void 0 : r.bufferSize) ?? is), e.dsn ? this._dsn = _a(e.dsn) : E && y.warn("No DSN provided, client will not send events."), this._dsn) {
            const a = uo(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
        ...
        this._options.enableLogs = this._options.enableLogs ?? ((s = this._options._experiments) == null ? void 0 : s.enableLogs), this._options.enableLogs && qn(this, "afterCaptureLog", "flushLogs", Oo, ts), (this._options.enableMetrics ?? ((i = this._options._experiments) == null ? void 0 : i.enableMetrics) ?? !0) && qn(this, "afterCaptureMetric", "flushMetrics", No, rs)
    }
    captureException(e, n, r) {
        const s = L();
        if ($n(e)) return E && y.log(Zn), s;
        const i = {
            event_id: s,
            ...n
        };
        return this._process(() => this.eventFromException(e, i).then(a => this._captureEvent(a, i, r)).then(a => a), "error"), i.event_id
    }
    captureMessage(e, n, r, s) {
        ...
        return this._process(() => c.then(u => this._captureEvent(u, i, s)), o ? "unknown" : "error"), i.event_id
    }
    captureEvent(e, n, r) {
        const s = L();
        if (n != null && n.originalException && $n(n.originalException)) return E && y.log(Zn), s;
        const i = {
                event_id: s,
                ...n
            },
            ...
            u = Gn(e.type);
        return this._process(() => this._captureEvent(e, i, o || r, c), u), i.event_id
    }
    captureSession(e) {
        this.sendSession(e), he(e, {
            init: !1
        })
    }
    getDsn() {
    ...
    addIntegration(e) {
        ...
        es(this, e, this._integrations), n || Wn(this, [e])
    }
    sendEvent(e, n = {}) {
        this.emit("beforeSendEvent", e, n);
        let r = Wa(e, this._dsn, this._options._metadata, this._options.tunnel);
        for (const s of n.attachments || []) r = Da(r, La(s));
    ...
    recordDroppedEvent(e, n, r = 1) {
        if (this._options.sendClientReports) {
            const s = `${e}:${n}`;
            E && y.log(`Recording outcome: "${s}"${r>1?` (${r} times)`:""}`), this._outcomes[s] = (this._outcomes[s] || 0) + r
        }
    }
    on(e, n) {
    ...
    _setupIntegrations() {
        ...
        this._integrations = po(this, e), Wn(this, e)
    }
    ...
    _prepareEvent(e, n, r, s) {
        ...
        return !n.integrations && (a != null && a.length) && (n.integrations = a), this.emit("preprocessEvent", e, n), e.type || s.setLastEventId(e.event_id || n.event_id), Ka(i, e, n, r, this, s).then(o => {
            if (o === null) return o;
    ...
    _captureEvent(e, n = {}, r = H(), s = fe()) {
        return E && Ct(e) && y.log(`Captured error event \`${os(e)[0]||"<unknown>"}\``), this._processEvent(e, n, r, s).then(i => i.event_id, i => {
            E && (zn(i) ? y.log(i.message) : Vn(i) ? y.warn(i.message) : y.warn(i))
        })
    }
    _processEvent(e, n, r, s) {
        const i = this.getOptions(),
            ...
            f = typeof a > "u" ? void 0 : ha(a);
        if (c && typeof f == "number" && Math.random() > f) return this.recordDroppedEvent("sample_rate", "error"), nn(mt(`Discarding event because it's not included in the random sample (sampling rate = ${a})`));
        const b = Gn(e.type);
        return this._prepareEvent(e, n, r, s).then(_ => {
            if (_ === null) throw this.recordDroppedEvent("event_processor", b), mt("An event processor returned `null`, will not send event.");
            ...
            var A;
            if (_ === null) {
                if (this.recordDroppedEvent("before_send", b), o) {
            ...
            if (c && C && this._updateSessionFromEvent(C, _), o) {
                const Fe = ((A = _.sdkProcessingMetadata) == null ? void 0 : A.spanCountBeforeProcessing) || 0,
...
Reason: ${_}`))
    ...
    _process(e, n) {
        this._numProcessing++, this._promiseBuffer.add(e).then(r => (this._numProcessing--, r), r => (this._numProcessing--, r === rn && this.recordDroppedEvent("queue_overflow", n), r))
    }
    _clearOutcomes() {
    ...
    if (ds(c)) {
        if (a || o) {
            ...
            if (c.spans) {
                ...
                b && t.recordDroppedEvent("before_send", "span", b), c.spans = l
            }
        }
        if (i) {
            if (c.spans) {
...
function ls(t) {
    ...
    return Object.values(t).forEach(n => {
        Array.isArray(n) ? e += n.length * Yn(n[0]) : it(n) ? e += Yn(n) : e += 100
    }), e
}
...
function zo(t, e) {
    if (t.type) {
        if (t.type === "transaction" && Go(t, e.ignoreTransactions)) return E && y.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${ie(t)}`), !0
    } else {
        if (qo(t, e.ignoreErrors)) return E && y.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${ie(t)}`), !0;
        if (Xo(t)) return E && y.warn(`Event dropped due to not having an error message, error type or stacktrace.
Event: ${ie(t)}`), !0;
        if (Yo(t, e.denyUrls)) return E && y.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${ie(t)}.
Url: ${Je(t)}`), !0;
        if (!Jo(t, e.allowUrls)) return E && y.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${ie(t)}.
Url: ${Je(t)}`), !0
    }
    return !1
...
function qo(t, e) {
    return e != null && e.length ? os(t).some(n => ot(n, e)) : !1
}
...
function Je(t) {
    ...
    try {
        const r = [...((e = t.exception) == null ? void 0 : e.values) ?? []].reverse().find(i => {
                var a, o, c;
                return ((a = i.mechanism) == null ? void 0 : a.parent_id) === void 0 && ((c = (o = i.stacktrace) == null ? void 0 : o.frames) == null ? void 0 : c.length)
            }),
            s = (n = r == null ? void 0 : r.stacktrace) == null ? void 0 : n.frames;
        return s ? Ko(s) : null
    } catch {
        return E && y.error(`Cannot extract url for event ${ie(t)}`), null
    }
}
...
function Qo(t, e, n, r, s, i) {
    var o;
    if (!((o = s.exception) != null && o.values) || !i || !ne(i.originalException, Error)) return;
    const a = s.exception.values.length > 0 ? s.exception.values[s.exception.values.length - 1] : void 0;
    a && (s.exception.values = It(t, e, r, i.originalException, n, s.exception.values, a, 0))
}
...
function It(t, e, n, r, s, i, a, o) {
    ...
    return Array.isArray(r.errors) && r.errors.forEach((u, l) => {
        if (ne(u, Error)) {
            ...
            const f = t(e, u),
                b = c.length;
            er(f, `errors[${l}]`, b, o), c = It(t, e, n, u, s, [f, ...c], f, b)
        }
    }), c
}
...
function tc() {
    "console" in R && di.forEach(function(t) {
        t in R.console && P(R.console, t, function(e) {
            return Ge[t] = e,
                function(...n) {
                    B("console", {
                        args: n,
    ...
    sc = () => {
        ...
        return {
            ...
            processEvent(e) {
                if (e.type) return e;
                try {
                    if (ac(e, t)) return E && y.warn("Event dropped due to being a duplicate of previously captured event."), null
                } catch {}
                return t = e
            }
        }
...
function lc() {
    ...
    if (e && typeof e.createElement == "function") try {
        ...
        r.hidden = !0, e.head.appendChild(r), (n = r.contentWindow) != null && n.fetch && (t = Tt(r.contentWindow.fetch)), e.head.removeChild(r)
    } catch (r) {
        E && y.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ", r)
    }
    return t
}
...
function fc(t, e) {
    const n = "fetch";
    de(n, t), le(n, () => pc(void 0, e))
}

function pc(t, e = !1) {
    e && !lc() || P(R, "fetch", function(n) {
        return function(...r) {
            const s = new Error,
                {
                    method: i,
            ...
            return B("fetch", {
                ...o
            }), n.apply(R, r).then(async c => (B("fetch", {
                ...o,
                endTimestamp: q() * 1e3,
                response: c
            }), c), c => {
                if (B("fetch", {
                        ...
                        endTimestamp: q() * 1e3,
                        error: c
                    }), qt(c) && c.stack === void 0 && (c.stack = s.stack, oe(c, "framesToPop", 1)), c instanceof TypeError && (c.message === "Failed to fetch" || c.message === "Load failed" || c.message === "NetworkError when attempting to fetch resource.")) try {
...
function bc(t) {
    ...
    return s => {
        ...
        if (a) {
            ...
            u && (f = c, b = u), u === "<anonymous>" && (b = void 0, l = void 0), l === void 0 && (b = b || ee, l = f ? `${f}.${b}` : b);
            let _ = (o = a[2]) != null && o.startsWith("file://") ? a[2].slice(7) : a[2];
            const C = a[5] === "native";
            return _ != null && _.match(/\/[A-Z]:/) && (_ = _.slice(1)), !_ && a[5] && !C && (_ = a[5]), {
...
function Ec(t) {
    var n;
    const e = $c(t);
    if ((n = window.__SENTRY_IPC__) != null && n[e.namespace]) return window.__SENTRY_IPC__[e.namespace];
    {
...
function ge(t, e = {}) {
    ...
    const r = function(...s) {
        try {
            ...
            throw Sc(), Vi(a => {
                a.addEventProcessor(o => (e.mechanism && (St(o, void 0), _e(o, e.mechanism)), o.extra = {
                    ...o.extra,
                    arguments: s
                }, o)), so(i)
            }), i
    ...
    Lr(r, t), oe(t, "__sentry_wrapped__", r);
    try {
...
function Rc(t) {
    return t && wc.test(t.message) ? 1 : 0
}
...
function Tc(t) {
    ...
    return gs(t) ? Array.isArray(t.message) && t.message.length == 2 ? t.message[1] : "wasm exception" : e ? e.error && typeof e.error.message == "string" ? e.error.message : e : "No error message"
}

function Ac(t, e, n, r) {
    const s = (n == null ? void 0 : n.syntheticException) || void 0,
        i = cn(t, e, s, r);
    return _e(i), i.level = "error", n != null && n.event_id && (i.event_id = n.event_id), ct(i)
}

function Nc(t, e, n = "info", r, s) {
    const i = (r == null ? void 0 : r.syntheticException) || void 0,
        a = Ot(t, e, i, s);
    return a.level = n, r != null && r.event_id && (a.event_id = r.event_id), ct(a)
}

function cn(t, e, n, r, s) {
    let i;
    if (Dr(e) && e.error) return bt(t, e.error);
    if (mn(e) || Ei(e)) {
        const a = e;
        if ("stack" in e) i = bt(t, e);
        else {
    ...
    return qt(e) ? bt(t, e) : Ce(e) || at(e) ? (i = xc(t, e, n, s), _e(i, {
        synthetic: !0
    }), i) : (i = Ot(t, e, n, r), St(i, `${e}`), _e(i, {
        synthetic: !0
    }), i)
}
...
function Oc(t, {
    ...
    return Dr(t) ? `Event \`ErrorEvent\` captured as ${r} with message \`${t.message}\`` : at(t) ? `Event \`${Dc(t)}\` (type=${t.type}) captured as ${r}` : `Object captured as ${r} with keys: ${n}`
}
...
class Pc extends Io {
    constructor(e) {
        var l;
        const n = Lc(e),
            r = I.SENTRY_SDK_SOURCE || mc();
        Lo(n, "browser", ["browser"], r), (l = n._metadata) != null && l.sdk && (n._metadata.sdk.settings = {
        ...
        const {
            ...
            _experiments: o,
            enableMetrics: c
        } = this._options, u = c ?? (o == null ? void 0 : o.enableMetrics) ?? !0;
        I.document && (i || a || u) && I.document.addEventListener("visibilitychange", () => {
            I.document.visibilityState === "hidden" && (i && this._flushOutcomes(), a && ts(this), u && rs(this))
        }), s && this.on("beforeSendSession", Po)
    }
...
function Lc(t) {
    var e;
    return {
        release: typeof __SENTRY_RELEASE__ == "string" ? __SENTRY_RELEASE__ : (e = I.SENTRY_RELEASE) == null ? void 0 : e.id,
        sendClientReports: !0,
        parentSpanIsAlwaysRootSpan: !0,
        ...t
    }
}
const Fc = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__,
    O = R,
    jc = 1e3;
let ir, Dt, Mt;
...
function Bc() {
    ...
    const t = B.bind(null, "dom"),
        e = ar(t, !0);
    O.document.addEventListener("click", e, !1), O.document.addEventListener("keypress", e, !1), ["EventTarget", "Node"].forEach(n => {
        var i, a;
        const s = (i = O[n]) == null ? void 0 : i.prototype;
        (a = s == null ? void 0 : s.hasOwnProperty) != null && a.call(s, "addEventListener") && (P(s, "addEventListener", function(o) {
            ...
            return function(c, u, l) {
                if (c === "click" || c == "keypress") try {
                    const f = this.__sentry_instrumentation_handlers__ || {},
                        b = f[c];
                    b && (b.refCount--, b.refCount <= 0 && (o.call(this, c, b.handler, l), b.handler = void 0, delete f[c]), Object.keys(f).length === 0 && delete this.__sentry_instrumentation_handlers__)
                } catch {}
                return o.call(this, c, u, l)
            }
        }))
...
function ar(t, e = !1) {
    return n => {
        ...
        const r = Hc(n);
        if (Zc(n.type, r)) return;
        oe(n, "_sentryCaptured", !0), r && !r._sentryId && oe(r, "_sentryId", L());
        const s = n.type === "keypress" ? "input" : n.type;
        Wc(n) || (t({
            event: n,
            name: s,
            global: e
        }), Dt = n.type, Mt = r ? r._sentryId : void 0), clearTimeout(ir), ir = O.setTimeout(() => {
            Mt = void 0, Dt = void 0
        }, jc)
    }
}
...
function qc(t) {
    ...
    if (r && typeof r.createElement == "function") try {
        ...
        Fc && y.warn(`Could not create sandbox iframe for ${t} check, bailing to window.${t}: `, s)
    }
    ...
    t.open = new Proxy(t.open, {
        apply(e, n, r) {
            ...
            return "onreadystatechange" in n && typeof n.onreadystatechange == "function" ? n.onreadystatechange = new Proxy(n.onreadystatechange, {
                ...
                apply(u, l, f) {
                    const [b, _] = f, C = l[we];
                    return C && z(b) && z(_) && (C.request_headers[b.toLowerCase()] = _), u.apply(l, f)
                }
            }), e.apply(n, r)
        }
...
const nu = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
    ru = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
    su = /\((\S*)(?::(\d+))(?::(\d+))\)/,
    iu = /at (.+?) ?\(data:(.+?),/,
    au = t => {
        const e = t.match(iu);
    ...
    ys = [eu, au],
    ou = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
    ...
    uu = t => {
        ...
        if (e) {
            ...
            let r = e[3],
                s = e[1] || ee;
            return [s, r] = $s(s, r), Pt(r, s, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0)
        }
    },
    du = [tu, uu],
    lu = [ys, du],
    ...
    $s = (t, e) => {
        ...
        return n || r ? [t.indexOf("@") !== -1 ? t.split("@")[0] : ee, n ? `safari-extension:${e}` : `safari-web-extension:${e}`] : [t, e]
    },
    Ze = 1024,
    pu = "Breadcrumbs",
    _u = (t = {}) => {
        ...
        return {
            name: pu,
            setup(n) {
                e.console && ec(bu(n)), e.dom && Uc(gu(n, e.dom)), e.xhr && Yc(yu(n)), e.fetch && fc($u(n)), e.history && bs(vu(n)), e.sentry && n.on("beforeSendEvent", mu(n))
            }
        }
    },
    hu = _u;
...
function gu(t, e) {
    return function(r) {
        if (N() !== t) return;
        let s, i, a = typeof e == "object" ? e.serializeAttribute : void 0,
            o = typeof e == "object" && typeof e.maxStringLength == "number" ? e.maxStringLength : void 0;
        o && o > Ze && (ut && y.warn(`\`dom.maxStringLength\` cannot exceed ${Ze}, but a value of ${o} was configured. Sentry will use ${Ze} instead.`), o = Ze), typeof a == "string" && (a = [a]);
        try {
            const u = r.event,
                l = Eu(u) ? u.target : u;
            s = Pr(l, {
...
function bu(t) {
    return function(n) {
        ...
        if (n.level === "assert")
            if (n.args[0] === !1) r.message = `Assertion failed: ${yn(n.args.slice(1)," ")||"console.assert"}`, r.data.arguments = n.args.slice(1);
            else return;
        ce(r, {
            input: n.args,
            level: n.level
...
function yu(t) {
    return function(n) {
        ...
        t.emit("beforeOutgoingRequestBreadcrumb", b, f), ce(b, f)
    }
}
...
function vu(t) {
    return function(n) {
        ...
        let a = r ? gt(r) : void 0;
        const o = gt(s);
        a != null && a.path || (a = i), i.protocol === o.protocol && i.host === o.host && (s = o.relative), i.protocol === a.protocol && i.host === a.host && (r = a.relative), ce({
            category: "navigation",
            data: {
                from: r,
                to: s
...
const Su = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "BroadcastChannel", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "SharedWorker", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
    ...
    xu = (t = {}) => {
        ...
        return {
            name: ku,
            setupOnce() {
                e.setTimeout && P(I, "setTimeout", or), e.setInterval && P(I, "setInterval", or), e.requestAnimationFrame && P(I, "requestAnimationFrame", Ru), e.XMLHttpRequest && "XMLHttpRequest" in I && P(XMLHttpRequest.prototype, "send", Cu);
                const n = e.eventTarget;
                n && (Array.isArray(n) ? n : Su).forEach(s => Iu(s, e))
            }
        }
    },
    wu = xu;
...
function Cu(t) {
    return function(...e) {
        ...
        return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(s => {
            s in n && typeof n[s] == "function" && P(n, s, function(i) {
                const a = {
                        mechanism: {
                            data: {
                                handler: te(i)
...
function Iu(t, e) {
    ...
    (i = r == null ? void 0 : r.hasOwnProperty) != null && i.call(r, "addEventListener") && (P(r, "addEventListener", function(a) {
        return function(o, c, u) {
            try {
                Tu(c) && (c.handleEvent = ge(c.handleEvent, {
                    mechanism: {
                        data: {
                            handler: te(c),
                            target: t
            ...
            return e.unregisterOriginalCallbacks && Au(this, o, c), a.apply(this, [o, ge(c, {
                mechanism: {
                    data: {
                        handler: te(c),
                        target: t
...
const Nu = () => ({
        ...
        setupOnce() {
            if (typeof I.document > "u") {
                ut && y.warn("Using the `browserSessionIntegration` in non-browser environments is not supported.");
                return
            }
            jn({
                ignoreDuration: !0
    ...
    Du = (t = {}) => {
        ...
        return {
            ...
            setup(n) {
                e.onerror && (Pu(n), cr("onerror")), e.onunhandledrejection && (Lu(n), cr("onunhandledrejection"))
            }
        }
    },
    Mu = Du;
...
function Pu(t) {
    bi(e => {
        ...
        const {
            ...
            column: o,
            error: c
        } = e, u = Uu(cn(n, c || s, void 0, r, !1), i, a, o);
        u.level = "error", Kr(u, {
            originalException: c,
            mechanism: {
                handled: !1,
...
function cr(t) {
    ut && y.log(`Global Handler attached: ${t}`)
}
...
const Xu = () => ({
    ...
    setup(t) {
        const e = hs(t);
        Ku((n, r) => {
            e.sendScope(JSON.stringify(W(n, 20, 2e3))), r.clearBreadcrumbs(), r.clearAttachments()
        })
    }
});
...
function Qu(t) {
    let e;
    return as(t, async n => (e || (e = hs()), e.sendEnvelope(n.body), {
        statusCode: 200
    }))
}
const ed = 50,
...
`).slice(e)) {
            const s = td(r),
                i = nd(r);
            if (s && (i == null ? void 0 : i.in_app) !== !1 ? n.push(s) : i && (i.module === void 0 && delete i.module, n.push(i)), n.length >= ed) break
        }
        return Ar(n)
    };
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
    ...
    window.__SENTRY__RENDERER_INIT__ = !0, t.sendClientReports = !1, t.defaultIntegrations === void 0 && (t.defaultIntegrations = sd()), t.stackParser === void 0 && (t.stackParser = rd), t.ipcNamespace === void 0 && (t.ipcNamespace = "sentry-ipc"), t.dsn === void 0 && (t.dsn = "https://12345@dummy.dsn/12345"), t.transport === void 0 && (t.transport = Qu), delete t.initialScope, e(t)
}
...
const m = x.arrayToEnum(["string", "nan", "number", "integer", "float", "boolean", "date", "bigint", "symbol", "function", "undefined", "null", "array", "object", "unknown", "promise", "void", "never", "map", "set"]),
    ...
    p = x.arrayToEnum(["invalid_type", "invalid_literal", "custom", "invalid_union", "invalid_union_discriminator", "invalid_enum_value", "unrecognized_keys", "invalid_arguments", "invalid_return_type", "invalid_date", "invalid_string", "too_small", "too_big", "invalid_intersection_types", "not_multiple_of", "not_finite"]);
        ...
        const n = e || function(i) {
            ...
            s = i => {
                for (const a of i.issues)
                    ...
                    for (; c < a.path.length;) {
                        const u = a.path[c];
                        c === a.path.length - 1 ? (o[u] = o[u] || {
                            _errors: []
                        }, o[u]._errors.push(n(a))) : o[u] = o[u] || {
                            _errors: []
                        }, o = o[u], c++
                    }
                }
...
function h(t, e) {
    const n = cd(),
        r = ud({
            ...
            data: t.data,
            path: t.path,
            errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, n, n === Lt ? void 0 : Lt].filter(s => !!s)
        });
...
class F {
    ...
    static mergeObjectSync(e, n) {
        ...
        for (const s of n) {
            ...
            if (i.status === "aborted" || a.status === "aborted") return $;
...
const dd = /^c[^\s-]{8,}$/i,
    ...
    pd = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
    _d = /^[a-z0-9_-]{21}$/i,
    hd = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
    md = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
    gd = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
...
const yd = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
    $d = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/,
    vd = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/,
    Ed = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/,
    Sd = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
    kd = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/,
    Ss = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))",
    xd = new RegExp(`^${Ss}$`);
...
class X extends k {
    _parse(e) {
        ...
        for (const i of this._def.checks)
            if (i.kind === "min") e.data.length < i.value && (s = this._getOrReturnCtx(e, s), h(s, {
                code: p.too_small,
                minimum: i.value,
                type: "string",
                inclusive: !0,
            ...
            else if (i.kind === "max") e.data.length > i.value && (s = this._getOrReturnCtx(e, s), h(s, {
            code: p.too_big,
            maximum: i.value,
            type: "string",
            inclusive: !0,
        ...
        } else if (i.kind === "email") gd.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "email",
            code: p.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "emoji") $t || ($t = new RegExp(bd, "u")), $t.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "emoji",
            code: p.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "uuid") pd.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "uuid",
            code: p.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "nanoid") _d.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "nanoid",
            code: p.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "cuid") dd.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cuid",
            code: p.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "cuid2") ld.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cuid2",
            code: p.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "ulid") fd.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "ulid",
            code: p.invalid_string,
            message: i.message
        }), r.dirty());
            ...
            code: p.invalid_string,
            message: i.message
        }), r.dirty())) : i.kind === "trim" ? e.data = e.data.trim() : i.kind === "includes" ? e.data.includes(i.value, i.position) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: p.invalid_string,
            validation: {
                includes: i.value,
                position: i.position
            ...
            message: i.message
        }), r.dirty()) : i.kind === "toLowerCase" ? e.data = e.data.toLowerCase() : i.kind === "toUpperCase" ? e.data = e.data.toUpperCase() : i.kind === "startsWith" ? e.data.startsWith(i.value) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: p.invalid_string,
            validation: {
                startsWith: i.value
            },
            ...
            message: i.message
        }), r.dirty()) : i.kind === "datetime" ? Rd(i).test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: p.invalid_string,
            validation: "datetime",
            message: i.message
        }), r.dirty()) : i.kind === "date" ? xd.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: p.invalid_string,
            validation: "date",
            message: i.message
        }), r.dirty()) : i.kind === "time" ? wd(i).test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: p.invalid_string,
            validation: "time",
            message: i.message
        }), r.dirty()) : i.kind === "duration" ? md.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "duration",
            code: p.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "ip" ? Cd(e.data, i.version) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "ip",
            code: p.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "jwt" ? Id(e.data, i.alg) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "jwt",
            code: p.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "cidr" ? Td(e.data, i.version) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cidr",
            code: p.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "base64" ? Sd.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "base64",
            code: p.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "base64url" ? kd.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
...
class Ae extends k {
    ...
    _parse(e) {
        ...
        let r;
        const s = new F;
        for (const i of this._def.checks) i.kind === "int" ? x.isInteger(e.data) || (r = this._getOrReturnCtx(e, r), h(r, {
            code: p.invalid_type,
            expected: "integer",
            received: "float",
            message: i.message
            ...
            exact: !1,
            message: i.message
        }), s.dirty()) : i.kind === "multipleOf" ? Ad(e.data, i.value) !== 0 && (r = this._getOrReturnCtx(e, r), h(r, {
            code: p.not_multiple_of,
            multipleOf: i.value,
            message: i.message
        }), s.dirty()) : i.kind === "finite" ? Number.isFinite(e.data) || (r = this._getOrReturnCtx(e, r), h(r, {
            code: p.not_finite,
            message: i.message
...
class Ne extends k {
    ...
    _parse(e) {
        ...
        let r;
        const s = new F;
        for (const i of this._def.checks) i.kind === "min" ? (i.inclusive ? e.data < i.value : e.data <= i.value) && (r = this._getOrReturnCtx(e, r), h(r, {
            code: p.too_small,
            type: "bigint",
            minimum: i.value,
            inclusive: i.inclusive,
            ...
            inclusive: i.inclusive,
            message: i.message
        }), s.dirty()) : i.kind === "multipleOf" ? e.data % i.value !== BigInt(0) && (r = this._getOrReturnCtx(e, r), h(r, {
            code: p.not_multiple_of,
            multipleOf: i.value,
            message: i.message
        }), s.dirty()) : x.assertNever(i);
...
class Xe extends k {
    _parse(e) {
        ...
        const r = new F;
        let s;
        for (const i of this._def.checks) i.kind === "min" ? e.data.getTime() < i.value && (s = this._getOrReturnCtx(e, s), h(s, {
            code: p.too_small,
            message: i.message,
            inclusive: !0,
            exact: !1,
...
class Z extends k {
    _parse(e) {
        ...
        if (n.parsedType !== m.array) return h(n, {
            code: p.invalid_type,
            expected: m.array,
            received: n.parsedType
        }), $;
        ...
        if (s.minLength !== null && n.data.length < s.minLength.value && (h(n, {
            ...
            }), r.dirty()), n.common.async) return Promise.all([...n.data].map((a, o) => s.type._parseAsync(new re(n, a, n.path, o)))).then(a => F.mergeArray(r, a));
...
function pe(t) {
    if (t instanceof T) {
        ...
        ...t._def,
        type: pe(t.element)
    }) : t instanceof Q ? Q.create(pe(t.unwrap())) : t instanceof ve ? ve.create(pe(t.unwrap())) : t instanceof ue ? ue.create(t.items.map(e => pe(e))) : t
}
class T extends k {
    constructor() {
    ...
    _parse(e) {
        ...
        if (this._def.catchall instanceof se) {
            ...
            else if (u === "strict") o.length > 0 && (h(s, {
        ...
        return s.common.async ? Promise.resolve().then(async () => {
            ...
            return u
        }).then(u => F.mergeObjectSync(r, u)) : F.mergeObjectSync(r, c)
    }
    get shape() {
    ...
    pick(e) {
        const n = {};
        for (const r of x.objectKeys(e)) e[r] && this.shape[r] && (n[r] = this.shape[r]);
        return new T({
            ...this._def,
            shape: () => n
        })
...
function jt(t, e) {
    ...
    } else return n === m.date && r === m.date && +t == +e ? {
        valid: !0,
        data: t
    } : {
        valid: !1
...
class et extends k {
    _parse(e) {
        const {
            status: n,
            ctx: r
        } = this._processInputParams(e), s = (i, a) => {
            if (lr(i) || lr(a)) return $;
            const o = jt(i.value, a.value);
            return o.valid ? ((fr(i) || fr(a)) && n.dirty(), {
                status: n.value,
                value: o.data
            }) : (h(r, {
...
class ue extends k {
    _parse(e) {
        ...
        if (r.parsedType !== m.array) return h(r, {
            code: p.invalid_type,
            expected: m.array,
            received: r.parsedType
        }), $;
        ...
        return r.common.async ? Promise.all(i).then(a => F.mergeArray(n, a)) : F.mergeArray(n, i)
    }
    get items() {
...
class $r extends k {
    ...
    _parse(e) {
        ...
        if (r.parsedType !== m.map) return h(r, {
            code: p.invalid_type,
            expected: m.map,
            received: r.parsedType
        }), $;
        ...
        if (r.common.async) {
            ...
            return Promise.resolve().then(async () => {
                for (const c of a) {
                    const u = await c.key,
                        l = await c.value;
                    if (u.status === "aborted" || l.status === "aborted") return $;
                    (u.status === "dirty" || l.status === "dirty") && n.dirty(), o.set(u.value, l.value)
                }
                return {
                    status: n.value,
                    value: o
...
class Oe extends k {
    _parse(e) {
        ...
        if (r.parsedType !== m.set) return h(r, {
            code: p.invalid_type,
            expected: m.set,
            received: r.parsedType
        }), $;
...
class tt extends k {
    ...
    _parse(e) {
        ...
        if (n.parsedType !== m.promise && n.common.async === !1) return h(n, {
            code: p.invalid_type,
            expected: m.promise,
            received: n.parsedType
        }), $;
    ...
    _parse(e) {
        ...
        if (i.addIssue = i.addIssue.bind(i), s.type === "preprocess") {
            ...
            if (r.common.async) return Promise.resolve(a).then(async o => {
                if (n.value === "aborted") return $;
                const c = await this._def.schema._parseAsync({
                    data: o,
                    path: r.path,
                    parent: r
                });
                return c.status === "aborted" ? $ : c.status === "dirty" || n.value === "dirty" ? Re(c.value) : c
            });
            {
                if (n.value === "aborted") return $;
                ...
                return o.status === "aborted" ? $ : o.status === "dirty" || n.value === "dirty" ? Re(o.value) : o
            }
        }
        if (s.type === "refinement") {
            ...
            if (r.common.async === !1) {
                ...
                return o.status === "aborted" ? $ : (o.status === "dirty" && n.dirty(), a(o.value), {
                    status: n.value,
                    value: o.value
                })
...
class un extends k {
    _parse(e) {
        ...
        if (r.common.async) return (async () => {
            ...
            return i.status === "aborted" ? $ : i.status === "dirty" ? (n.dirty(), Re(i.value)) : this._def.out._parseAsync({
                data: i.value,
                path: r.path,
                parent: r
            })
...
class Zt extends k {
    _parse(e) {
        const n = this._def.innerType._parse(e),
            r = s => (be(s) && (s.value = Object.freeze(s.value)), s);
...
function Ld() {
    const t = JSON.parse('{"commitHash":"df1d8a339dfabcf359af7144fe142b59ff7d9a0f","isNestBuild":false,"commitTimestamp":"2026-07-10T21:55:12.000Z","buildType":"prod","appVersion":"1.20186.1"}'),
        e = Pd.safeParse(t);
...
var xr = {};
const Fd = Object.fromEntries(["arch", "platform", "type", "versions"].map(t => [t, !0])),
