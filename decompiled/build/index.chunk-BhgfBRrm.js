...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            t = new e.Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "42c2cb8b-ac3a-4698-a17d-40e7901c2a49", e._sentryDebugIdIdentifier = "sentry-dbid-42c2cb8b-ac3a-4698-a17d-40e7901c2a49")
    })()
} catch {}
...
const H = require("node:os"),
    ...
    Y = require("./index.chunk-CvbeGVMj.js"),
    S = 3e4,
    w = 300 * 1e3,
    g = 3e4,
    B = 5e3;
...
function A(e) {
    if (e instanceof U || e instanceof T) return !0;
...
async function M() {
    ...
    const L = new Promise((a, p) => {
            c = setTimeout(() => {
                P = !0, p(new Error(`usage probe timed out after ${S}ms`))
            }, S), c.unref()
        }),
        m = (async () => {
            ...
            const p = n.applyDeploymentModeOverrides(n.CLAUDE_CODE_OAUTH_CONFIGS[n.getOAuthEnvironment()]),
                b = await n.getApiTokenResult(p);
            if (!b.ok) {
                const {
                    reason: i
                } = b;
                throw n.logger.warn("[UsageProbe] oauth failed", {
                    type: i.type,
                    detail: E(i.detail ?? "")
                }), new Error(`oauth failed (${i.type})`)
            }
            const k = n.loadUserEnvVars().CLAUDE_CONFIG_DIR || n.getClaudeConfigDir(),
                R = n.buildHostCliEnv(p.apiHost, k, {
                ...
                N = n.mergeNetworkEnv(await n.resolveSystemProxyEnv(p.apiHost), R),
                {
                    cmd: x,
                    args: F
...
function I() {
    o++, r = null, l = 0, d = g, f = null, y = 0, u == null || u(), u = null
}
async function $() {
    if (r && Date.now() - r.at < w) return r.payload;
    if (l && Date.now() - l < d) return (r == null ? void 0 : r.payload) ?? null;
    if (f) return f;
    const e = o;
    return f = (async () => {
        try {
            const t = await M();
            return o !== e ? null : t === null && (r == null ? void 0 : r.payload) != null && (y = y || Date.now(), Date.now() - y < w) ? (l = Date.now(), d = g, r.payload) : (y = 0, r = {
                at: Date.now(),
                payload: t
            }, l = 0, d = g, t)
        } catch (t) {
            return t instanceof D ? (n.logger.debug("[UsageProbe] attempt inside rate floor"), o === e ? (r == null ? void 0 : r.payload) ?? null : null) : t instanceof v ? (n.logger.debug("[UsageProbe] probe superseded before spawn"), o === e && (l = Date.now(), d = g), o === e ? (r == null ? void 0 : r.payload) ?? null : null) : (n.logger.error("[UsageProbe] get_usage failed", {
                message: E(t instanceof Error ? t.message : String(t))
            }), o === e && (l = Date.now(), d = A(t) ? w : g), o === e ? (r == null ? void 0 : r.payload) ?? null : null)
        } finally {
            o === e && (f = null)
        }
    })(), f
