...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            t = new e.Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "20f8940e-5dcc-4d83-ab54-ed2501ba0337", e._sentryDebugIdIdentifier = "sentry-dbid-20f8940e-5dcc-4d83-ab54-ed2501ba0337")
    })()
} catch {}
...
const A = new RegExp(`\\.(${O.join("|")})$`, "i"),
    W = new RegExp(`\\.(${[...O,"pdf"].join("|")})$`, "i"),
    w = 160,
    F = /^(?!\.)[^\\/:<>"|?*\u0000-\u001F\u007F\u200E\u200F\u202A-\u202E\u2066-\u2069]+\.(clark|cd)$/i,
    m = /^(con|prn|aux|nul|com[0-9]|lpt[0-9])$/i,
    R = /^(con|prn|aux|nul|com[0-9]|lpt[0-9]) *(\.|$)/i;

function y(e) {
    if (e.length > w || !F.test(e)) return !1;
...
function M(e) {
    let t = e.replace(K, "");
    if (t = t.replace(/^[\s.]+|[\s.]+$/g, ""), u.encode(t).length > d) {
        let n = "",
            s = 0;
        for (const o of t) {
    ...
    let r;
    do r = t, t = t.replace(W, ""), t = t.replace(/^[\s.]+|[\s.]+$/g, ""); while (t !== r);
    return t === "" || m.test(t) ? "Document" : t
}
...
function D(e) {
    try {
        const n = new URL(e);
        if (n.host) return n.username = "", n.password = "", n.search = "", n.hash = "", n.toString()
    } catch {}
    const t = e.lastIndexOf("@");
    return t === -1 ? e : (e.startsWith("//") ? "//" : "") + e.slice(t + 1)
}
...
async function X(e) {
    ...
    const t = [i.getCCDSettingsFile(), l.join(e, ".claude", "settings.json"), l.join(e, ".claude", "settings.local.json"), await i.getManagedSettingsPath()],
        r = await Promise.all(t.map(i.readSettingsFile$1));
    for (let s = 0; s < r.length; s++) {
        const o = (n = r[s]) == null ? void 0 : n.env;
        if (o && b(o)) return t[s]
    }
    return null
}
async function L(e) {
    ...
    const t = [{
        ...
        r = await Promise.all(t.map(o => i.readSettingsFile$1(o.path))),
        n = new Map;
    for (let o = 0; o < t.length; o++) {
        const c = (s = r[o]) == null ? void 0 : s.env;
        if (c)
            for (const E of f) {
                const a = c[E];
                typeof a == "string" && a.trim() !== "" && n.set(E, {
                    value: a.trim(),
                    tier: t[o].tier,
                    path: t[o].path
                })
