...
var Bt = (e, r, t) => {
  ...
  var i = a => r = t ? new o(a, r, "An error was suppressed during disposal") : (t = true, a);
  var s = a => {
    while (a = e.pop()) {
      try {
        var l = a[1] && a[1].call(a[2]);
        if (a[0]) {
          return Promise.resolve(l).then(s, c => {
            i(c);
            return s();
          });
        }
...
try {
  (function () {
    ...
    if (r) {
      ...
      e._sentryDebugIds[r] = "e8856b4c-8b50-4b3e-98e5-f47755a82d8b";
      e._sentryDebugIdIdentifier = "sentry-dbid-e8856b4c-8b50-4b3e-98e5-f47755a82d8b";
    }
  })();
} catch {}
const n = require("./index.chunk-c42vKsva.js");
const H = require("node:fs/promises");
const j = require("node:fs");
const N = require("node:path");
require("node:timers/promises");
const yr = require("node:os");
const K = require("electron");
const gn = require("./index.chunk-ZXPKeP3a.js");
const ce = require("./index.chunk-CvbeGVMj.js");
const yt = require("node:crypto");
const yn = require("./index.chunk-ChePQt0A.js");
const de = require("./index.chunk-BLNdD7Yt.js");
const wn = require("node:events");
const Y = require("./index.chunk-BJQfDnQY.js");
const G = require("./index.chunk-bem6RoHM.js");
const Le = require("./index.chunk-Cp81FYE3.js");
const _n = require("./index.chunk-BimimalO.js");
const vn = require("node:util");
function wt(e) {
...
function wr() {
  ...
  if (e) {
    return n.getCoworkAccountSettingsFile(n.maybeGetStaticInstallID(), e);
  } else {
    return null;
  }
}
...
function _r(e, r) {
  if (typeof e != "object" || e === null || typeof e.windowStartMs != "number" || typeof e.inputTokens != "number" || typeof e.outputTokens != "number") {
    return Ht();
  }
  const t = e;
  if (t.windowStartMs > Date.now()) {
    return {
      ...t,
      windowStartMs: Date.now()
    };
...
async function Cn(e, r) {
  ...
  if ((t == null ? undefined : t.windowHours) === undefined || t.maxPerWindow === undefined) {
    return;
  }
  const {
    maxPerWindow: o,
  ...
  const s = wr();
  if (s) {
    await n.accountSettingsMutex.runExclusive(async () => {
      let a;
      try {
...
async function An() {
  ...
  if ((e == null ? undefined : e.windowHours) === undefined || e.maxPerWindow === undefined) {
    return {
      over: false
    };
  }
  ...
  const i = (await En(o)) ?? {};
  const s = _r(i[Ze], t);
  const a = s.inputTokens + s.outputTokens;
  if (a < r) {
    return {
      over: false
    };
...
const vr = "Framebuffer";
const Rn = ["framebuffer_list", "framebuffer_attach", "framebuffer_screenshot", "framebuffer_zoom", "framebuffer_cursor_position"];
const ne = "Coordinates are read directly from the most recent framebuffer_screenshot image. The server handles all scaling. Do NOT scale coordinates yourself.";
const z = {
  name: {
    type: "string",
...
function xn() {
  const e = n.isFeatureEnabled("4141490266") || false;
...
function Sr(e) {
  ...
  let r = 0;
  for (const t of e.toLowerCase().split("+")) {
    if (t === "alt") {
      r |= 1;
    } else if (t === "ctrl" || t === "control") {
      r |= 2;
    } else if (t === "meta" || t === "cmd" || t === "win" || t === "windows") {
      r |= 4;
    } else if (t === "shift") {
      r |= 8;
    }
...
function $n(e) {
  ...
  const o = Sr(r.join("+"));
  const i = t.length === 1 && o === 0 ? t : undefined;
  return {
    key: t,
    modifiers: o,
    text: i
...
function Dn(e) {
  return e === true || e === 1 || e === "true" || e === "1" || e === "on" || e === "yes";
}
const Wt = 10;
const J = {
  tabId: {
...
const Nn = new Set(["left_click", "right_click", "double_click", "triple_click", "type", "key", "left_click_drag"]);
const Ln = {
  type: "object",
  properties: {
    ...J,
...
function ge(e, r, t) {
  if (e.isError || !n.isContextExternalPreviewEnabled(r)) {
    return e;
  }
...
async function oe(e, r) {
  if (!n.isContextExternalPreviewEnabled(e)) {
    return null;
  }
  ...
  if (o === null || n.isLocalhostHostname(new URL(t).hostname)) {
    return null;
  }
  const i = await n.consultBlocklistEpochGuarded(t);
  if (i.kind === "epoch-changed") {
    return {
  ...
  if (i.kind === "ok" && n.shouldBlockNavigation(i.category)) {
    return {
      denied: M("This site is blocked by policy.")
    };
  }
  if (i.kind === "ok" && n.shouldForceApproval(i.category)) {
    return {
...
async function Kn(e, r, t) {
  ...
  const s = Number.isFinite(t.depth) ? Number(t.depth) : 15;
  const a = Number.isFinite(t.max_chars) ? Number(t.max_chars) : 50000;
  const l = t.ref_id ?? null;
  const c = `${On};window.__generateAccessibilityTree(${JSON.stringify(i)}, ${JSON.stringify(s)}, ${JSON.stringify(a)}, ${JSON.stringify(l)})`;
  let d;
  try {
  ...
  const u = d;
  if (!u || u.error) {
    return M(`read_page failed: ${(u == null ? undefined : u.error) ?? "no result from page"}`);
  }
  const p = u.pageContent ?? "";
  const h = o && "url" in o ? n.normalizePreviewOrigin(o.url) ?? "(non-http)" : "(non-http)";
  const f = n.normalizePreviewOrigin(n.getPreviewUrlForTab(e, r) ?? "") ?? "(non-http)";
  const _ = pe(e, r);
  if (f === h) {
    ie.set(_, {
      tree: p,
...
function Pe(e, r, t, o) {
  ...
  if (!i || i.screenshotWidth === 0 || i.screenshotHeight === 0) {
    return null;
  } else {
    return [Math.round(t * (i.viewportWidth / i.screenshotWidth)), Math.round(o * (i.viewportHeight / i.screenshotHeight))];
  }
}
    ...
    switch (i) {
      case "screenshot":
        {
          ...
          const c = await n.evaluateInPreview(e, r, "({w: window.innerWidth, h: window.innerHeight})");
          const d = (c == null ? undefined : c.w) || 1280;
          const u = (c == null ? undefined : c.h) || 800;
          ue.set(pe(e, r), {
            viewportWidth: d,
            viewportHeight: u,
      ...
      case "triple_click":
        {
          ...
          const d = i === "double_click" ? 2 : i === "triple_click" ? 3 : 1;
          await n.dispatchMouseInPreview(e, r, l.dispatch[0], l.dispatch[1], {
            button: c,
            clickCount: d,
      ...
      case "hover":
        {
          ...
          if ("error" in l) {
            ...
            await n.hoverInPreview(e, r, l.dispatch[0], l.dispatch[1]);
            return {
              content: [{
                type: "text",
      ...
      case "type":
        if (typeof t.text != "string") {
          return M("`type` requires `text`");
        } else {
          await n.typeTextInPreview(e, r, t.text);
          return {
            content: [{
              type: "text",
      ...
      case "key":
        {
          if (typeof t.text != "string") {
            return M("`key` requires `text`");
          }
          const l = Number.isFinite(t.repeat) ? Math.min(Math.max(Number(t.repeat), 1), 100) : 1;
          const c = t.text.split(/\s+/).filter(Boolean);
          const d = 100;
          if (c.length > d) {
            return M(`\`key\` accepts at most ${d} tokens (got ${c.length})`);
          }
          ...
          for (let h = 0; h < l; h++) {
            for (const f of c) {
              const _ = $n(f);
              if (_) {
                if (n.getNavCommitEpoch(e, r) !== u) {
                  return M("Page navigated during key sequence; remaining keys not dispatched.");
                }
                await n.pressKeyInPreview(e, r, _);
                p++;
              }
            }
          }
          if (p === 0) {
            return M(`\`key\` parsed no valid tokens from "${t.text}"`);
          } else {
            return {
              content: [{
                type: "text",
      ...
      case "scroll":
        {
          if (!t.coordinate) {
            return M("`scroll` requires `coordinate`");
          }
          const l = Pe(e, r, t.coordinate[0], t.coordinate[1]);
          if (l === null) {
            return M("`scroll` with `coordinate` requires a prior computer{action:\"screenshot\"}");
          }
          const c = t.scroll_direction ?? "down";
          if (c !== "up" && c !== "down" && c !== "left" && c !== "right") {
            return M("`scroll` requires `scroll_direction` of up/down/left/right");
          }
          const u = (Number.isFinite(t.scroll_amount) ? Number(t.scroll_amount) : 3) * Yn;
          const p = c === "left" ? -u : c === "right" ? u : 0;
          const h = c === "up" ? -u : c === "down" ? u : 0;
          await n.scrollInPreview(e, r, l[0], l[1], p, h);
          return {
            content: [{
              type: "text",
      ...
      case "scroll_to":
        {
          if (!t.ref) {
            return M("`scroll_to` requires `ref`");
          }
          const l = await Kt(e, r, t.ref);
          if ("error" in l) {
            return M(l.error);
      ...
      case "left_click_drag":
        {
          if (!t.start_coordinate || !t.coordinate) {
            return M("`left_click_drag` requires `start_coordinate` and `coordinate`");
          }
          const l = Pe(e, r, t.start_coordinate[0], t.start_coordinate[1]);
          const c = Pe(e, r, t.coordinate[0], t.coordinate[1]);
          if (l === null || c === null) {
            return M("`left_click_drag` requires a prior computer{action:\"screenshot\"}");
          }
          const d = n.getNavCommitEpoch(e, r);
          await n.dragInPreview(e, r, l[0], l[1], c[0], c[1]);
          if (n.getNavCommitEpoch(e, r) !== d) {
            return M("Page navigated during drag; result may be unreliable.");
          } else {
            return {
              content: [{
                type: "text",
...
async function zt(e, r, t) {
  ...
  if (o === "denied") {
    return M(n.userDeclinedMessage("this domain transition"));
  } else if (o === "suppressed") {
    return M("The user has repeatedly declined this domain transition, so the prompt is suppressed and the navigation was not performed. Do not retry; the user can navigate there manually if they want.");
  } else if (o === "retry") {
    return M("Could not confirm the domain transition (another permission prompt was open, or the session changed during the prompt) — retry the navigation.");
  } else {
    return null;
  }
}
async function Qn(e, r, t) {
  if (typeof t.url != "string") {
    return M("`navigate` requires a string `url`");
  }
  const o = t.url.trim();
  ...
  if (i === "back" || i === "forward") {
    ...
    if (!c) {
      return M(`no ${i} history`);
    }
    if (n.hasEmbeddedCredentials(c)) {
      if (n.isConsentedCredentialedNav(e, r, c)) {
        return M(`this history entry was opened with credentials the user approved for a single navigation — going ${i} would re-submit them without approval. Navigate to the URL directly to show the consent card again.`);
      } else {
        n.logEvent("desktop_launch_preview_credentialed_nav", {
          action: "refused",
          source: "history-tool"
        });
        return M(`the ${i} history entry embeds credentials (user:password@); ${Gt}.`);
      }
    }
    {
      const p = n.normalizePreviewOrigin(c);
      if (p !== null && !n.isLocalhostHostname(new URL(p).hostname) && n.isExternalPreviewDisabledByManagedPolicy()) {
        return M(n.EXTERNAL_PREVIEW_AGENT_POLICY_MESSAGE);
      }
    }
    if (n.isContextExternalPreviewEnabled(e) && n.normalizePreviewOrigin(c) !== null) {
      const p = await n.consultBlocklistEpochGuarded(c);
      if (p.kind === "ok" && n.shouldBlockNavigation(p.category)) {
        return M(`${n.normalizePreviewOrigin(c)} is blocked by policy and cannot be opened in the Browser pane.`);
      }
      if (p.kind === "epoch-changed") {
        return M("the Browser pane is no longer open");
      }
      if (p.kind === "error") {
        return M("site policy check is unavailable — try again shortly");
      }
    }
    ...
    if (u === "gone") {
      ...
      return M(`history changed — retry ${i}`);
    } else if (u === "blocked") {
      return M(`navigation ${i} was denied or failed`);
    } else {
      await n.awaitNavigationCommit(e, r);
      return {
        content: [{
          type: "text",
          text: `navigated ${i}`
  ...
  const s = /^https?:\/\//i.test(o) ? o : `https://${o}`;
  {
    ...
    if (c !== null && !n.isLocalhostHostname(new URL(c).hostname) && n.isExternalPreviewDisabledByManagedPolicy()) {
      return M(n.EXTERNAL_PREVIEW_AGENT_POLICY_MESSAGE);
    }
  }
  let a = false;
  if (n.normalizePreviewOrigin(s) !== null && n.hasEmbeddedCredentials(s)) {
    ...
    if (c.kind === "epoch-changed") {
      return M("the Browser pane is no longer open");
    }
    if (c.kind === "error") {
      return M("site policy check is unavailable — try again shortly");
    }
    if (n.shouldBlockNavigation(c.category)) {
      return M(`${n.normalizePreviewOrigin(s)} is blocked by policy and cannot be opened in the Browser pane.`);
    }
    ...
    if (d === "denied") {
      ...
      return M(n.userDeclinedMessage("submitting the sign-in credentials in this link"));
    }
    if (d !== "allowed") {
      n.logEvent("desktop_launch_preview_credentialed_nav", {
        action: "refused",
      ...
      return M(`the URL embeds credentials (user:password@); ${Gt} — navigate without them and let the user sign in on the page.`);
    }
    n.logEvent("desktop_launch_preview_credentialed_nav", {
      action: "consented",
      source: "navigate-tool"
  ...
  try {
    ...
    if (c === "denied-by-user") {
      return M(n.userDeclinedMessage(`opening ${n.normalizePreviewOrigin(s) ?? "(target)"} in the Browser pane`));
    } else if (c === "blocked") {
      return M(n.isExternalPreviewDisabledByManagedPolicy() ? n.EXTERNAL_PREVIEW_AGENT_POLICY_MESSAGE : `${n.normalizePreviewOrigin(s) ?? "(target)"} is blocked by policy and cannot be opened in the Browser pane.`);
    } else if (c) {
      return {
        content: [{
          type: "text",
    ...
    } else if (n.consumeRecentDownloadStart(e, r)) {
      return {
        content: [{
          type: "text",
      ...
      return M(`navigation to ${n.normalizePreviewOrigin(s) ?? "(target)"} was denied or failed`);
    }
  } catch (c) {
...
async function eo(e, r, t) {
  if (typeof t.query != "string") {
    return M("`find` requires a string `query`");
  }
  const o = await oe(e, r);
  if (o && "denied" in o) {
    return o.denied;
  ...
  const s = ie.get(i);
  if (!s) {
    return M("no read_page tree cached; call read_page first");
  }
  const a = n.normalizePreviewOrigin(n.getPreviewUrlForTab(e, r) ?? "") ?? "(non-http)";
  if (s.origin !== a) {
    ie.delete(i);
    return M(`cached read_page tree was for ${s.origin}, page is now ${a}; call read_page first`);
  }
  const l = t.query.toLowerCase();
  const c = s.tree.split(`
`);
  const d = [];
  for (const u of c) {
    if (u.toLowerCase().includes(l) && /\[ref_\d+\]/.test(u) && (d.push(u.trim()), d.length >= Zn)) {
      break;
    }
  }
  if (d.length === 0) {
...
async function to(e, r, t) {
  ...
  const i = Number.isFinite(t.max_chars) ? Number(t.max_chars) : 50000;
  ...
  try {
    ...
    if (!l) {
      return M("get_page_text: no result from page");
    }
    const c = n.normalizePreviewOrigin(l.url) ?? "(non-http)";
    const d = br(l.title);
    const u = typeof l.tag == "string" && /^[a-z][a-z0-9]{0,15}$/.test(l.tag) ? l.tag : "body";
    const p = l.truncated ? `
...
async function ro(e, r, t, o) {
  ...
  try {
    const l = await n.evaluateInPreview(e, r, a);
    if (l == null || !l.ok) {
      return M(`form_input failed: ${(l == null ? undefined : l.error) ?? "no result from page"}`);
    }
    const c = o ? `
...
async function Kt(e, r, t) {
  ...
  const i = await n.evaluateInPreview(e, r, o);
  return i || {
    error: "ref resolution returned null"
  };
}
const _t = new Set(["preview_start", "preview_stop", "preview_list", "preview_logs"]);
const no = new Set(["read_page", "computer", "form_input", "navigate", "find", "get_page_text", "javascript_tool", "read_console_messages", "read_network_requests", "resize_window"]);
function oo(e) {
...
const io = "Open the Browser pane: pass `url` to open a browser tab at a URL (no dev server needed — use this for external sites, staging, docs, or your deployed app), OR pass `name` to start a dev server from .claude/launch.json.\n\n";
function so(e) {
  if (e.name !== "preview_start") {
    return e;
  }
...
function ao(e) {
  if (n.isExternalPreviewEnabled()) {
    return [...e.filter(t => _t.has(t.name)).map(so), ...Tr];
  } else {
    return e;
  }
}
...
const lo = new Set([...kr.map(e => e.name), ...Tr.map(e => e.name)]);
function co() {
  return ao(kr);
}
function I(e) {
...
function Ye(e) {
  if (typeof e == "string") {
    if (e.length > Yt) {
      return `${e.slice(0, Yt)}… (${e.length} chars)`;
    } else {
      return e;
    }
  }
...
function uo(e, r) {
  const t = r;
  return {
    action: e === "computer" && typeof t.action == "string" ? t.action : undefined,
    text: Ye(t.text),
    value: Ye(t.value),
    expression: Ye(t.expression),
    selector: typeof t.selector == "string" ? t.selector : undefined,
    ref: typeof t.ref == "string" ? t.ref : undefined,
    coordinate: Array.isArray(t.coordinate) && t.coordinate.length === 2 && t.coordinate.every(o => typeof o == "number") ? t.coordinate : undefined
  };
}
const Er = new Set(["preview_click", "preview_fill", "preview_eval", "computer", "form_input", "javascript_tool"]);
const po = new Set(["tabs_context", "tabs_create", "tabs_select", "tabs_close"]);
async function ho(e, r) {
  const t = n.checkToolAccessGate(e, r);
  if (t === null || t.state !== "needs-grant") {
    return t;
  }
  const o = n.getPreviewUrlForTab(e, r);
  const i = o !== null ? n.normalizePreviewOrigin(o) : null;
  if (o === null || i === null) {
    return {
  ...
  if (s === "denied-by-user") {
    ...
    await n.applyToolAccessForTab(e, r);
    return n.checkToolAccessGate(e, r) ?? t;
  } else if (s !== "allowed") {
    return t;
  } else {
    await n.applyToolAccessForTab(e, r, i);
    return n.checkToolAccessGate(e, r);
  }
}
async function mo(e, r, t, o, i) {
  if (!n.isContextExternalPreviewEnabled(r) || !Er.has(e) || e === "computer" && !Nn.has(String(o.action))) {
    return null;
  }
  ...
  if (a === null || n.isLocalhostHostname(new URL(s).hostname)) {
    return null;
  }
  if (n.checkToolAccessGate(r, t) !== null) {
    return {
      denied: I("This site is not approved for tool access.")
    };
  }
  if (!n.isLoopbackHostLiteral(new URL(s).hostname) && !n.isToolAccessFromOneShot(r, t) && !n.isPreviewOriginAllowed(s)) {
    return {
      denied: I(`${a} was removed from Allowed sites. Re-approve to continue.`)
    };
  }
  const l = await n.consultBlocklistEpochGuarded(s);
  if (l.kind === "epoch-changed") {
    return {
  ...
  if (l.kind === "ok" && n.shouldBlockNavigation(l.category)) {
    return {
  ...
  if (l.kind === "ok" && n.shouldForceApproval(l.category)) {
    ...
    const d = uo(e, o);
    n.logger.info("[Preview] cat3 per-action approval requested %o", {
      origin: a,
      toolName: e,
      action: d.action
    });
...
async function go(e, r) {
  ...
  try {
    return await Promise.race([r(), new Promise(o => {
      t = setTimeout(() => {
        n.logger.warn(`[Preview MCP] ${e} timed out after ${Ve}ms`);
        o(I(`${e} timed out after ${Ve / 1000}s. The Browser pane may be stuck (modal dialog, navigation hang, or unresponsive renderer). Check preview_console_logs for errors.`));
      }, Ve);
    })]);
  } finally {
    if (t) {
...
function yo(e, r, t) {
  if (!t.startsWith(n.HTML_PREVIEW_ID_PREFIX) || e === "preview_screenshot" || e === "preview_snapshot" || e === "read_page" || e === "computer" && String(r.action) === "screenshot") {
    return null;
  } else {
    return I(`${e} is not available on this serverId: it is a read-only artifact view. Only screenshot and accessibility-snapshot tools work on artifact views; interaction tools (click, fill, eval, navigate, resize, stop) are not permitted.`);
  }
}
function wo(e, r) {
  try {
...
function Vt(e) {
  ...
  if (r == null || !r.externalUrl) {
    return I("Artifact view no longer available. Call preview_list for current artifact views.");
  }
  if (n.CLAUDE_DESIGN_PATH_RE.test(((s = n.maybeURL(r.externalUrl)) == null ? undefined : s.pathname) ?? "")) {
    return I("Claude Design embeds are not capturable from Browser tools.");
  }
  const t = n.localFrameShellPreviewUrl(r.externalUrl) ?? r.externalUrl;
  const o = n.getPreviewUrl(e);
  if (!o || !wo(o, t)) {
    return I(Oe);
  }
  ...
  for (const a of i) {
    if (a === "" || a === "about:blank" || a === "about:srcdoc") {
      continue;
    }
    const l = n.maybeURL(a);
    if (!l || l.protocol !== "https:" || !n.isFrameUserContentHostForBuild(l.hostname)) {
      return I(Oe);
    }
  }
  return null;
...
function _o(e, r, t) {
  ...
  if (e != null && e.startsWith(n.HTML_PREVIEW_ID_PREFIX)) {
    ...
    if ((a == null ? undefined : a.sessionId) !== undefined && t !== undefined && a.sessionId === t) {
      return e;
    } else {
      return null;
    }
  }
  if (n.isExternalPreviewEnabled() && t !== undefined) {
    if (e != null && e.startsWith(n.SESSION_PREVIEW_ID_PREFIX)) {
      if (n.sessionIdFromPreviewId(e) === t) {
        return e;
      } else {
        return null;
      }
    ...
    if (e != null && e.startsWith(n.BROWSER_PREVIEW_ID_PREFIX)) {
      ...
      if ((l == null ? undefined : l.sessionId) === t) {
        return n.getSessionPreviewId(t);
      } else {
        return null;
      }
    }
    if (e) {
      ...
      if (l) {
        if (l.sessionId !== undefined && l.sessionId !== t) {
          return null;
        } else if (l.sessionId === undefined) {
          return e;
        } else {
          return n.getSessionPreviewId(t);
        }
    ...
    if (n.isContextExternalPreviewEnabled(a)) {
      return a;
    }
  }
  if (e != null && e.startsWith(n.BROWSER_PREVIEW_ID_PREFIX)) {
  ...
  const i = n.launchStateTracker.getServersForWorktree(r).find(a => a.status === "running" && (a.sessionId === undefined || a.sessionId === t));
  if (i) {
    return i.serverId;
  } else {
    return ((s = n.launchStateTracker.getBrowserPreviewForSession(t)) == null ? undefined : s.serverId) ?? null;
  }
}
function Jt(e, r) {
  const t = n.launchStateTracker.getBrowserPreview(e);
  if (t) {
    return r !== undefined && t.sessionId === r;
  }
  const o = n.launchStateTracker.get(e);
  if (o) {
    return o.sessionId === undefined || o.sessionId === r;
  } else {
    return false;
  }
}
function Cr(e, r, t) {
  ...
  const i = e.tabId;
  const s = typeof i == "string" && i.length > 0 ? i : o !== null ? n.getActivePreviewTabId(o) : n.SEED_TAB_ID;
  return {
    serverId: o,
    tabId: s
  };
...
async function vo(e, r, t, o, i) {
  ...
  if (e !== "navigate" && !_t.has(e) && !po.has(e)) {
    ...
    if (c !== null) {
      if (oo(e) && n.isContextExternalPreviewEnabled(c)) {
        return I(`${e} is not available — use the ext-shaped equivalent (read_page, computer, read_console_messages, …).`);
      }
      const u = await ho(c, d);
      if (u !== null) {
        return I(u.denied);
      }
      if (Er.has(e) && (s = await mo(e, c, d, r, i), s && "denied" in s)) {
        return s.denied;
      }
      a = c;
      l = d;
  ...
  if (fo.has(e)) {
    return go(e, () => Xt(e, r, t, o, s, a, l));
  } else {
    return Xt(e, r, t, o, s, a, l);
  }
}
async function Xt(e, r, t, o, i = null, s = null, a = null) {
  ...
  n.logEvent("desktop_launch_tool_used", {
    session_id: o ?? "",
    tool_name: `internal__${Ue}__${l}`
  });
  if (e === "preview_start") {
    const m = r.url;
    const g = typeof m == "string" && m.trim().length > 0;
    if (n.isExternalPreviewEnabled() && g) {
      if (o === undefined) {
        return I("preview_start{url} requires a session.");
      }
      const w = /^https?:\/\//i.test(m.trim()) ? m.trim() : `https://${m.trim()}`;
      let C = false;
      if (n.normalizePreviewOrigin(w) !== null && n.hasEmbeddedCredentials(w)) {
        if (!n.isLocalhostHostname(new URL(w).hostname) && n.isExternalPreviewDisabledByManagedPolicy()) {
          return I(n.EXTERNAL_PREVIEW_AGENT_POLICY_MESSAGE);
        }
        const O = await n.consultBlocklistEpochGuarded(n.stripEmbeddedCredentials(w));
        if (O.kind === "epoch-changed") {
          return I("Browser pane state was reset mid-call; retry.");
        }
        if (O.kind === "error") {
          return I("site policy check is unavailable — try again shortly");
        }
        if (n.shouldBlockNavigation(O.category)) {
          return I(`${n.normalizePreviewOrigin(w)} is blocked by policy and cannot be opened in the Browser pane.`);
        }
        ...
        if (D === "denied") {
          ...
          return I(n.userDeclinedMessage("submitting the sign-in credentials in this link"));
        }
        if (D !== "allowed") {
          n.logEvent("desktop_launch_preview_credentialed_nav", {
            action: "refused",
          ...
          return I("the URL embeds credentials (user:password@); the Browser pane never submits embedded credentials on the user's behalf — retry without them and let the user sign in on the page.");
        }
        n.logEvent("desktop_launch_preview_credentialed_nav", {
          action: "consented",
          source: "mcp-tool"
      ...
      const b = (v = n.launchStateTracker.getBrowserPreviewForSession(o)) == null ? undefined : v.tabId;
      const E = n.launchStateTracker.loadBrowserPreview(t, o);
      const T = ((P = n.launchStateTracker.getBrowserPreviewForSession(o)) == null ? undefined : P.tabId) ?? null;
      const k = T !== null && T === b;
      if (T === null) {
        return I("Tab cap reached. Close a tab (tabs_close) before opening another, or call tabs_context to find an existing tab to reuse.");
      }
      const S = n.normalizePreviewOrigin(w) === null ? false : await n.navigatePreview(E, T, w, "mcp-tool", {
        credentialConsentGranted: C
      });
      const R = n.normalizePreviewOrigin(w) ?? "(target)";
      return {
        content: [{
          type: "text",
          text: JSON.stringify({
...
Browser pane opened at about:blank; navigation to ${R} was denied or failed. Use \`navigate\` to try a different URL.`)
    ...
    try {
      ...
      const C = w.action !== "deny" ? w.config.port : 3000;
      const b = await n.startServer(w, t, o);
      let E = "";
      if (b.reused) {
        E = `
Server was already running and has been reused. No new process was started.`;
        ...
        E = `
Server started successfully. Configured port ${C} was in use, so port ${b.port} was assigned instead (autoPort is enabled). The preview is available at http://localhost:${b.port}.`;
      } else {
        E = `
Server started successfully on port ${b.port}.`;
      }
      if (n.isExternalPreviewEnabled() && !b.reused) {
        E += b.tabId !== undefined ? ` Opened tab "${b.tabId}" at http://localhost:${b.port}. Use tabId "${b.tabId}" with read_page / computer / navigate; serverId is for preview_stop and preview_logs only.` : " Tab cap reached — close a tab (tabs_close) before previewing this server. serverId is for preview_stop and preview_logs only.";
      }
      return {
        content: [{
          type: "text",
      ...
      if (w instanceof n.PortInUseError) {
        return I(w.message);
      }
      const C = w instanceof Error ? w.message : String(w);
      if (n.isPortInUseError(C)) {
        return I(n.formatEaddrinuseError(C));
      } else {
        return I(`Failed to start server: ${C}
...
Check the command in .claude/launch.json and try again.`);
  ...
  if (e === "preview_stop") {
    ...
    if (o !== undefined && n.sessionIdFromPreviewId(m) === o) {
      return I("preview_stop takes a process id from preview_list, not the session previewId.");
    }
    if (n.launchStateTracker.getArtifactView(m)) {
      return I("This serverId is a read-only artifact view; it cannot be stopped from Browser tools.");
    }
    if (!Jt(m, o)) {
      return {
        content: [{
  ...
  if (e === "preview_list") {
    const m = n.launchStateTracker.servers.filter(E => !E.serverId.startsWith(n.HTML_PREVIEW_ID_PREFIX)).filter(E => !E.serverId.startsWith(n.BROWSER_PREVIEW_ID_PREFIX) || o !== undefined && E.sessionId === o).filter(E => E.sessionId === undefined || E.sessionId === o).map(E => E.serverId.startsWith(n.BROWSER_PREVIEW_ID_PREFIX) ? {
      ...E,
      type: "browser"
    } : E);
    const g = o !== undefined ? n.launchStateTracker.servers.filter(E => {
      var T;
      return E.sessionId === o && n.launchStateTracker.getArtifactView(E.serverId) !== undefined && !n.CLAUDE_DESIGN_PATH_RE.test(((T = n.maybeURL(E.externalUrl ?? "")) == null ? undefined : T.pathname) ?? "");
    }).map(E => ({
      serverId: E.serverId,
      name: E.name,
      type: "artifact_view",
    ...
    const w = n.isExternalPreviewEnabled() && o !== undefined ? `

Session preview: ${JSON.stringify({
      previewId: n.getSessionPreviewId(o),
      tabs: n.allPreviewTabSummaries(n.getSessionPreviewId(o))
    }, null, 2)}
...
Entries with type "artifact_view" are the in-app Artifacts pane and are READ-ONLY: only ${n.isExternalPreviewEnabled() ? "read_page and computer {action: \"screenshot\"}" : "preview_screenshot and preview_snapshot"} work on them. Their serverIds change when a new artifact loads — re-list if one goes stale.`;
  ...
  if (!d) {
    ...
    const g = m !== undefined;
    if (n.isExternalPreviewEnabled()) {
      return I(g ? `serverId "${m}" not found — it may be stale or belong to another session. Call preview_list to get current ids.` : "No preview is open. Use preview_start with {\"url\": \"https://…\"} to open a browser tab at a URL, or with {\"name\": \"…\"} to start a dev server from .claude/launch.json.");
    } else {
      return I("Server not found. No running servers for this workspace.");
    }
  }
  const p = yo(e, r, d);
  if (p) {
  ...
  if (d.startsWith(n.HTML_PREVIEW_ID_PREFIX)) {
    ...
    const g = n.getNavCommitEpoch(d, n.SEED_TAB_ID);
    const w = n.getFrameTreeEpoch(d, n.SEED_TAB_ID);
    const C = Vt(d);
    if (C) {
      return C;
    }
  ...
  const h = (i == null ? undefined : i.capturedOrigin) ?? null;
  const f = h ? `

(captured at origin ${h})` : "";
  const _ = m => m.then(g => g.isError ? g : ge(g, d, u));
  if (e === "read_page") {
    return _(Kn(d, u, r));
  }
  if (e === "computer") {
  ...
  if (e === "tabs_create") {
    ...
    if (m === null) {
      return I("Could not open a new tab (Browser pane gone, gate off, or tab cap reached).");
    } else {
      return {
        content: [{
          type: "text",
...
Opened tab ${m}. Use \`navigate\` with tabId "${m}" to load a URL.`
  ...
  if (e === "tabs_select") {
    const m = r.tabId;
    if (typeof m != "string") {
      return I("`tabs_select` requires a string `tabId`.");
    } else if (n.setActivePreviewTab(d, m)) {
      return {
        content: [{
          type: "text",
          text: `Fronted tab ${m}.`
      ...
      return I(`Tab ${m} not found.`);
    }
  }
  if (e === "tabs_close") {
    const m = r.tabId;
    if (typeof m != "string") {
      return I("`tabs_close` requires a string `tabId`.");
    } else if (n.getPreviewTabCount(d) <= 1) {
      return I("The last tab cannot be closed from a tool — use `tabs_create` first or ask the user.");
    } else if (n.closePreviewTab(d, m)) {
      return {
        content: [{
          type: "text",
          text: `Closed tab ${m}.`
  ...
  if (e === "javascript_tool") {
    ...
    try {
      ...
      const w = g === undefined ? "undefined" : JSON.stringify(g, null, 2);
      return ge({
        content: [{
          type: "text",
          text: w + f
  ...
  if (e === "read_console_messages") {
    ...
    if (g) {
      b = b.filter(S => S.text.includes(g));
    }
    const T = Math.min(Math.max(1, w ?? 50), 200);
    const k = b.length === 0 ? "No console logs." : b.slice(-T).map(S => `[${S.level}] ${S.text}`).join(`
`);
    return ge({
      content: [{
        type: "text",
  ...
  if (e === "read_network_requests") {
    ...
    const E = O => {
      var L;
      const D = n.normalizePreviewOrigin(O);
      if (D === null || n.isLocalhostHostname(((L = n.maybeURL(O)) == null ? undefined : L.hostname) ?? "")) {
        return true;
      } else {
        return b !== null && D === b;
      }
    };
    const T = n.getNetworkEntries(d, u, "all");
    if (g) {
      const O = T.find(U => U.requestId === g);
      if (!O || !E(O.url)) {
        return I(`Response body not available for request ${g}.`);
      }
      const D = await n.getNetworkResponseBody(d, u, g);
      if (!D) {
        return I(`Response body not available for request ${g}.`);
      }
      const L = D.base64Encoded ? `(binary, ${D.body.length} chars base64)` : D.body.slice(0, 10000);
      return ge({
        content: [{
          type: "text",
          text: L
    ...
    if (m) {
      k = k.filter(O => O.url.includes(m));
    }
    const S = Math.max(1, w ?? 50);
    const R = k.slice(-S).map(O => {
      let D = `[${O.requestId}] ${O.method} ${O.url}`;
      if (O.status !== undefined) {
        D += ` → ${O.status} ${O.statusText}`;
      }
      if (O.failed) {
        D += ` [FAILED: ${O.errorText}]`;
      }
      return D;
    }).join(`
`);
  ...
  async function A(m, g, w) {
    ...
    try {
      ...
      if (C || b || E) {
        ...
        if (C === "desktop") {
          await n.clearViewport(m, g);
          S.push("Viewport reset to native size (desktop)");
        } else {
          await n.setViewport(m, g, R.w, R.h);
          S.push(`Viewport set to ${R.w}x${R.h}${C ? ` (${C})` : ""}`);
        }
      }
      if (T) {
        await n.setColorScheme(m, g, T);
        S.push(`Color scheme set to ${T}`);
      }
      if (S.length === 0) {
        return I("Provide a preset (mobile/tablet/desktop), width/height, or colorScheme.");
      } else {
        return {
          content: [{
            type: "text",
  ...
  if (e === "preview_logs") {
    ...
    const E = (m !== undefined && n.sessionIdFromPreviewId(m) === o ? undefined : m) ?? (n.isExternalPreviewEnabled() && o !== undefined ? (y = n.launchStateTracker.getServersForWorktree(t).find(R => (R.sessionId === undefined || R.sessionId === o) && (R.status === "running" || R.status === "starting"))) == null ? undefined : y.serverId : d);
    if (E === undefined) {
      return I("No dev server is running. preview_logs takes a process serverId from preview_list.");
    }
    if (!Jt(E, o)) {
      return {
        content: [{
    ...
    if (C) {
      T = T.filter(R => R.line.includes(C));
    }
  ...
  if (e === "preview_console_logs") {
    ...
    const w = n.getConsoleLogs(d, u, m);
    if (w.length === 0) {
      return {
        content: [{
          type: "text",
    ...
    const E = w.slice(-C).map(k => `[${k.level}] ${k.text}`).join(`
`);
    const T = w.length > C ? `
  ...
  if (e === "preview_click") {
    ...
    try {
      if (await n.click(d, u, m, {
        ...
        return I(`Failed to click element: ${m}`);
      }
    } catch (w) {
  ...
  if (e === "preview_fill") {
    ...
    try {
      if (await n.fill(d, u, m, g)) {
        ...
        return I(`Failed to fill element: ${m}`);
      }
    } catch (w) {
  ...
  if (e === "preview_eval") {
    ...
    try {
      ...
      return {
        content: [{
          type: "text",
          text: (g === undefined ? "undefined" : JSON.stringify(g, null, 2)) + f
        }]
      };
    } catch (g) {
  ...
  if (e === "preview_network") {
    ...
    try {
      if (g) {
        ...
        if (!b) {
          return I(`Response body not available for request ${g}. It may have been evicted from the browser cache.`);
        }
        if (b.base64Encoded) {
          return {
            content: [{
          ...
          content: [{
            ...
            text: w.map(b => {
              ...
              if (b.status !== undefined) {
                E += ` → ${b.status} ${b.statusText}`;
              }
              if (b.failed) {
                E += ` [FAILED: ${b.errorText}]`;
              }
              return E;
            }).join(`
`)
...
function So(e, r, t) {
  ...
  var l;
  var c;
  const o = n.getDeploymentMode().type === "3p" ? n.webSearchBuiltinToolName(r) : undefined;
  const i = n.resolveDisabledBuiltinTools(r);
  if (o && (l = (a = r.workspace) == null ? undefined : a.disabledBuiltinTools) != null && l.includes("WebSearch")) {
    i.push(o);
  }
  if (i.length > 0) {
    t("%d tool(s) disabled via admin policy", i.length);
    e.disallowedTools = [...(e.disallowedTools ?? []), ...i];
  }
  if (o) {
    const d = n.findWebSearchBuiltin((c = r.mcp) == null ? undefined : c.managedServers);
    t("WebSearch built-in configured (provider=%s) — aliasing SDK WebSearch", d == null ? undefined : d.provider);
    e.disallowedTools = [...(e.disallowedTools ?? []), "WebSearch"];
    e.toolAliases = {
      ...e.toolAliases,
      WebSearch: o
    };
  ...
  if (o && n.isWebSearchExplicitlyAsk(r)) {
    s.push(o);
  }
  if (s.length > 0) {
    t("Built-in tools require approval via admin policy: %s", s.join(", "));
    bo(e, s);
  }
}
function bo(e, r) {
  ...
  e.hooks = {
    ...e.hooks,
    PreToolUse: [...(((i = e.hooks) == null ? undefined : i.PreToolUse) ?? []), {
      matcher: o,
...
function To(e) {
  if (n.isFeatureEnabled("2800354941")) {
    return Object.fromEntries(Object.entries(e).sort(([r], [t]) => r.localeCompare(t)));
  } else {
    return e;
  }
}
function ko(e) {
  if (n.isFeatureEnabled("2800354941")) {
    return [...e].sort((r, t) => r.path.localeCompare(t.path));
  } else {
    return e;
  }
}
function Eo(e) {
  ...
  const r = e;
  if (typeof r.requestId != "number") {
    return null;
  }
  switch (r.type) {
    case "result":
      if (Array.isArray(r.hits) && r.hits.every(t => typeof t == "object" && t !== null && typeof t.sessionId == "string" && typeof t.snippet == "string" && typeof t.lastActivityAt == "number")) {
        return {
          type: "result",
...
class Co {
  ...
  async searchCandidates(r, t, o) {
    const i = o.limit ?? 50;
    const s = o.maxSessions ?? 200;
    const a = t.sort((d, u) => u.lastActivityAt - d.lastActivityAt).slice(0, s);
    const l = new n.PQueue({
      concurrency: 8
    });
    const c = (await Promise.all(a.map(d => l.add(async () => {
  ...
  async spawn() {
    ...
    o.on("message", a => {
      ...
      if (c) {
        this.pending.delete(l.requestId);
        switch (l.type) {
          case "result":
            c.resolve(l.hits);
            break;
          case "error":
            n.logger.warn(`[cowork-search] worker error: ${l.message}`);
            c.reject(new Error(l.message));
            break;
        }
      }
    });
    ...
    if (await new Promise(a => {
      ...
      n.logger.info("[cowork-search] worker forked");
      this.child = t;
      this.port = o;
    }
  }
...
const Ao = new Co();
const vt = `**Tiered apps:** some apps are granted at a restricted tier based on their category — the tier is displayed in the approval dialog and returned in the \`request_access\` response:
...
const Po = `**App access:** all approved applications are granted at tier **"full"** — you can screenshot, click, type, scroll, and drag in any app the user approves via \`request_access\`, including browsers, terminals, and IDEs.
...
**Financial actions - do not execute trades or move money.** Budgeting and accounting apps (Quicken, YNAB, QuickBooks, etc.) are granted at full tier so you can categorize transactions, generate reports, and help the user organize their finances. But never execute a trade, place an order, send money, or initiate a transfer on the user's behalf - always ask the user to perform those actions themselves.`;
const Ro = "[ANT ONLY] synced_resources.txt";
function Je(e) {
...
async function ye(e, r) {
  ...
  try {
    ...
    if (!s.ok) {
      ...
      n.logger.error(`[ProjectSync] API error ${r}: ${s.status} ${a}`);
...
function Mo(e) {
  ...
  switch (e.type) {
    case "github":
      {
        ...
        const o = String(r.repo ?? "");
        const i = String(r.branch ?? "");
        if (!t || !o) {
          return null;
        } else {
          return {
    ...
    case "mcpres":
      {
        const t = r.resource;
        const o = t == null ? undefined : t.uri;
        if (o) {
          return {
            url: o,
            title: t.name,
...
async function xo(e, r) {
  ...
  const o = N.join(r, e);
  const i = N.join(o, "docs");
  const s = N.join(o, "files");
  await n.mkdirPrivate(i);
  await n.mkdirPrivate(s);
  const [a, l, c] = await Promise.all([ye(t, `/projects/${e}`), ye(t, `/projects/${e}/docs`), ye(t, `/projects/${e}/files`)]);
  const [d, u] = await Promise.all([ye(t, `/memory?project_uuid=${e}`).then(y => y.memory ?? null).catch(y => {
  ...
  const A = c.map(y => h.add(async () => {
    try {
      ...
      const g = `${y.file_uuid}.${m}`;
      const w = await n.validateWritePath(s, g);
      if (!w) {
  ...
  if (d !== undefined) {
    if (d) {
      await n.writeFilePrivate(v, d);
    } else {
      await H.unlink(v).catch(() => {});
    }
  }
  const P = N.join(o, "syncs.json");
  if (u !== undefined) {
    if (u.length > 0) {
      await n.writeJsonAtomic(P, {
        sources: u
      });
    } else {
      await H.unlink(P).catch(() => {});
    }
  }
  await n.writeJsonAtomic(N.join(o, "metadata.json"), {
    uuid: a.uuid,
    name: a.name,
...
async function $o(e) {
  ...
  const s = e.projectUuids.filter(p => Ar.test(p) ? true : (n.logger.warn(`[ProjectSync] Rejecting invalid projectUuid: ${JSON.stringify(p)}`), false));
  const a = [];
  let l = 0;
  let c = 0;
  if (s.length === 0) {
  ...
  const u = await Promise.allSettled(s.map(async p => {
    if (t) {
      const h = N.join(t, ".projects", p);
      if (await et(N.join(h, "metadata.json"))) {
        const f = await d(h);
        n.logger.info(`[ProjectSync] Legacy per-session dir for "${f.metadata.name}"`);
        return {
          ...f,
          projectUuid: p
        };
    ...
    try {
      ...
      if (await et(N.join(f, "metadata.json"))) {
        const _ = await d(f);
        n.logger.warn(`[ProjectSync] API sync failed for "${_.metadata.name}", using cached copy: ${h instanceof Error ? h.message : h}`);
        return {
          ..._,
          projectUuid: p
        };
  ...
  for (let p = 0; p < u.length; p++) {
    ...
    if (h.status === "fulfilled") {
      ...
      n.logger.warn(`[ProjectSync] Failed to sync project ${f}: ${_}`);
      n.logCoworkEvent("lam_project_sync_failed", {
        session_id: i,
        project_uuid: f,
        error_message: _
      });
...
${e.map(o => {
      const i = o.metadata.prompt_template ? `
<custom_instructions>${Je(o.metadata.prompt_template)}</custom_instructions>` : "";
      const s = r ? o.hostPath ?? o.mountPath : o.mountPath;
...
function Ho() {
  return `Web search: the current date is ${new Intl.DateTimeFormat("en-US", {
    month: "long",
    year: "numeric"
  }).format(new Date())}. Use this year when searching for recent information, documentation, or current events.`;
}
function Pr() {
...
function Wo(e, r) {
  if (!e.includes("{{skillsDir}}/skills/")) {
    return e;
  }
  ...
  const i = e.split(`
`);
  const s = new Array(i.length).fill(false);
  for (let a = 0; a < i.length; a++) {
    if (o(i[a])) {
      s[a] = true;
      if (/^\s*Claude:/.test(i[a]) && /^\s*User:/.test(i[a - 1] ?? "")) {
        s[a - 1] = true;
        if (a >= 2 && i[a - 2].trim() === "") {
          s[a - 2] = true;
        }
...
async function Go({
  ...
  documentsPluginActive: _ = false,
  documentFunnelEnabled: A = false,
  mountSkeletonHome: v,
  isBridgeSession: P,
  isDispatchChild: y,
  ...
  skillsEnabled: se = true,
  pluginsEnabled: he = true,
  suggestSkillsEnabled: be = false,
  canSaveSkill: Te = false,
  hostOutputsDir: Ct,
  hostUploadsDir: ke,
  cuOnlyMode: At = false,
  hasWebSearchTool: Qr = false,
  onPluginSkills: qe,
  remoteMcpServers: Qa,
  spSectionPrompts: W,
  onSections: ae
  ...
  const F = (x, q) => {
    je.push(q);
    te[x] = (te[x] ?? 0) + q.length;
  };
  if (Qr && !At) {
    F("web_search_builtin", Pr());
  }
  if (A && _ && S) {
...
The app shows working documents in the Documents panel with a rich editor, and the user exports DOCX/PDF/Markdown from there. Do not write .docx or .pdf files directly unless the user explicitly asks for a raw file, and do not ask the user to choose a file format for a new document - the working document is the format; ask about content, not formats.`);
  ...
  let $ = (s == null ? undefined : s.mode) === "replace" ? [s.text, ...(i ?? [])].filter(Boolean).join(`

`) : o ?? "";
  if ((s == null ? undefined : s.mode) === "replace") {
    te.sp_variant_replace = s.text.length;
  } else if ((s == null ? undefined : s.mode) === "append") {
    F("sp_variant_append", s.text);
  }
  $ = $.replaceAll("{{promptCacheBoundary}}", () => ce.SYSTEM_PROMPT_DYNAMIC_BOUNDARY);
  const Zr = Bo();
  ...
  const me = S && R ? R : B;
  if (S && ke) {
    $ = $.replaceAll("{{cwd}}/mnt/uploads", () => ke);
  }
  $ = $.replaceAll("{{cwd}}", () => me);
  const Ee = r && r.length > 0 ? S ? de.deriveMountNamesIncremental(r, de.HOST_LOOP_RESERVED_MOUNT_NAMES) : de.deriveMountNames(r) : new Map();
  const Pt = new Map((t ?? []).map(x => [x.path, x]));
  const tn = x => x !== undefined && (x.kind !== "cloud-sync" || !x.mountable);
  const Be = (r ?? []).filter(x => !tn(Pt.get(x)));
  const fe = S ? r ?? [] : Be;
  const Ce = fe.length > 0;
  const rn = r == null ? undefined : r[0];
  const He = Be[0];
  const nn = S ? rn ?? R ?? me : He ? `${B}/mnt/${Ee.get(He) ?? N.basename(He)}` : `${B}/mnt/outputs`;
  $ = $.replaceAll("{{workspaceFolder}}", () => nn);
  const Rt = x => {
    const q = Pt.get(x);
    if (q) {
      return `  (${n.folderKindHints(q).tag})`;
    } else {
      return "";
    }
  };
  const It = x => S ? `   - Folder: ${x}${Rt(x)}` : `   - Folder: ${B}/mnt/${Ee.get(x) ?? N.basename(x)}`;
  const on = Ce ? fe.map(It).join(`
`) : "";
  const Mt = (t ?? []).map(n.folderKindHints);
  const We = [...new Set(Mt.map(x => x.copyHint).filter(x => x !== ""))];
  const xt = S && We.length > 0 ? `
   ${We.join(" ")}` : "";
  const Ot = (Lt = Mt.find(x => x.bulkHint !== undefined)) == null ? undefined : Lt.bulkHint;
  const $t = S && Ot !== undefined ? `
   ${Ot}.` : "";
  const Dt = on + xt + $t;
  ...
  } = await yn.skillsPluginManager.generateSkillsSystemPrompt(e, u, p, f, S, U, true, se, he, be, Te, _);
  const ln = S ? U ?? "(no skills directory — skip skill reads)" : `${B}/mnt/.claude`;
  $ = Wo($, an);
  $ = $.replaceAll("{{skillsDir}}", () => ln);
  $ = $.replaceAll("{{modelName}}", () => a || "Claude");
  if (l) {
    $ = $.replaceAll("{{modelIdentity}}", () => l);
  } else {
    $ = $.replace(/\n?\{\{modelIdentity\}\}/g, "");
  }
  $ = $.replaceAll("{{accountName}}", () => c || "");
  $ = $.replaceAll("{{emailAddress}}", () => d || "");
  let Ae;
  if (!Ce) {
    Ae = "Claude does not have access to the user's files. Claude has a temporary working folder where it can create new files for the user to download.";
  } else if (fe.length === 1) {
...
${It(fe[0])}${xt}${$t}` : x;
    ...
    Ae = `Claude has access to multiple folders the user selected and can read and modify files in them. The user-selected folders are:
${Dt}
When the user's request pertains to a specific folder, Claude should work in and save outputs to that folder rather than always defaulting to the first one.`;
  ...
  const cn = Ce ? "yes" : "no";
  $ = $.replaceAll("{{folderSelected}}", () => cn);
  if (qe != null) {
    qe(sn);
  }
  if (Nt) {
    n.logger.info("[LocalAgentModeSessionManager] Appending skills to system prompt");
    F("skills", Nt);
  }
  if (v && !S) {
    const x = process.platform === "win32";
    const q = x ? "C:/Users/alice/Documents/project" : "/Users/alice/Documents/project";
    const Q = x ? "c/Users/alice/Documents/foo" : "Users/alice/Documents/foo";
    const re = x ? "C:/Users/alice/Documents/foo" : "/Users/alice/Documents/foo";
    const Z = `
...
`)}`);
  ...
  if (P) {
    ...
    const q = n.resolveSection(W, n.SP_SECTION_KEYS.dispatchOrchestratorBase, jo);
    const Q = x.length > 0 ? `${q}

${x}` : q;
    const re = n.substituteSection(Q, {
      ...
      dispatchSeedMessages: n.getDispatchSeedMessages(w ?? false, n.resolveSection(W, n.SP_SECTION_KEYS.dispatchSeedGreeting, n.DISPATCH_SEED_GREETING_FALLBACK)).map(ze => `> ${ze.replaceAll(`
`, `
> `)}`).join(`
...
If you need access to files on the user's computer, load the \`mcp__cowork__${n.REQUEST_COWORK_DIRECTORY}\` tool (via ToolSearch if deferred) and call it with the specific \`path\` (e.g. \`path: "~/Downloads"\`).${x}`;
    const Q = S ? n.SP_SECTION_KEYS.dispatchChildFsHostLoop : n.SP_SECTION_KEYS.dispatchChildFsVm;
...
${x}`;
    ...
    F("cu_opted_out", n.resolveSection(W, n.SP_SECTION_KEYS.cuOptedOutStub, No));
  } else if (T === "settings") {
    F("cu_opted_out", n.resolveSection(W, n.SP_SECTION_KEYS.cuOptedOutSettings, Lo));
  }
  if (O && D) {
    F("imagine", `
...
${D}`);
  ...
  if (g && !P && !y && !m) {
    F("scheduled_tasks", n.substituteSection(n.resolveSection(W, n.SP_SECTION_KEYS.scheduledTasks, Fo()), {
      createTask: n.MCP_CREATE_SCHEDULED_TASK,
      updateTask: n.MCP_UPDATE_SCHEDULED_TASK,
      listTasks: n.MCP_LIST_SCHEDULED_TASKS
    }, n.SP_SECTION_KEYS.scheduledTasks));
  }
  if (L && !P && !y) {
  ...
  if (S) {
    ...
    const q = Ct ?? me;
    const re = `- ${q} → ${x}/  (your outputs directory${q === me ? " — cwd" : ""})`;
    const Z = Be;
    const ze = Z.length > 0 ? `${Z.map(Ut => {
      const fn = Ee.get(Ut);
      return `- ${Ut} → ${B}/mnt/${fn}/`;
    }).join(`
`)}
...
You are running as a subagent inside a Cowork session. Shell commands execute in an isolated Linux sandbox rooted at \`${i}\` — files created there (or under \`/tmp\`) exist only in the sandbox, not on the user's real computer. User-attached folders are mounted under \`${i}/mnt/\`.`;
  const a = r ? n.SP_SECTION_KEYS.subagentEnvHostLoop : n.SP_SECTION_KEYS.subagentEnvVm;
  const l = n.resolveSection(o, a, s);
  return `

${n.substituteSection(l, {
    vmCwd: i,
    hostCwd: t ?? i,
    workspaceBash: `mcp__${n.WORKSPACE_MCP_SERVER}__${n.WORKSPACE_BASH}`
  }, a)}`;
}
function Qt(e, r) {
  ...
  if (t === -1) {
    ...
    return [e.slice(0, t), ce.SYSTEM_PROMPT_DYNAMIC_BOUNDARY, e.slice(t + ce.SYSTEM_PROMPT_DYNAMIC_BOUNDARY.length) + r];
  }
}
function Ko(e, r, t) {
  const o = new Set();
  const i = Math.max(0, r.length - t);
  for (let a = i; a < r.length; a++) {
    o.add(r[a].uuid);
  }
  const s = [];
  for (const a of e) {
    if (a.uuid === undefined || !o.has(a.uuid)) {
      if (a.uuid !== undefined) {
        o.add(a.uuid);
      }
      s.push(a);
...
function Yo(e, r) {
  ...
  for (const a of e) {
    const l = a.timestamp;
    while (s < t.length && (!l || t[s].timestamp < l)) {
      i.push(t[s++]);
    }
    i.push(a);
  }
...
function Jo({
  ...
  const d = e instanceof Error ? e : new Error(typeof e == "string" ? e : `Non-Error thrown: ${String(e)}`);
  const u = o ? d.message.replace(/Output:[\s\S]*$/, () => `Output: ${n.redactCliOutput(o)}`) : n.redactCliOutputInErrorMessage(d.message);
  const p = u === d.message ? d : Object.assign(new Error(u), {
    name: d.name,
    stack: d.stack,
    cause: d.cause
  });
  n.sentryMainShimExports.captureException(p, {
    tags: {
      feature: "ccd",
      ccd_source: r,
      ccd_error_category: c,
      ccd_is_ssh: String(l.isSsh),
      ccd_is_resume: String(l.isResume ?? false),
      ccd_is_startup_error: String(l.isStartupError ?? false),
      ...(l.permissionMode && {
    ...
    extra: {
      ...
      cli_stderr_tail: a ? a.slice(-500) : undefined,
      model: l.model,
    ...
    fingerprint: ["ccd", r, c, ...(i !== undefined ? [String(i)] : []), "{{ default }}"]
  });
  return true;
}
const Xo = "self";
function we(e) {
  var r;
  if (((r = e.getPermissionMode) == null ? undefined : r.call(e)) === undefined) {
    return {
      content: [{
        type: "text",
...
const tt = "list_sessions";
const rt = "get_session";
const nt = "search_session_transcripts";
const ot = "list_events";
const it = "archive_session";
const st = "set_session_title";
const at = "send_message";
const Qo = `mcp__${X}__${tt}`;
const Zo = `mcp__${X}__${rt}`;
const ei = `mcp__${X}__${nt}`;
const ti = `mcp__${X}__${ot}`;
const ri = `mcp__${X}__${it}`;
const ni = `mcp__${X}__${st}`;
const oi = `mcp__${X}__${at}`;
const ii = `List the user's other CCD sessions (active and optionally archived).
...
const ai = `Get detailed metadata for a single CCD session by ID.
...
const ci = `Full-text search across the user/assistant messages of other CCD session transcripts.
...
const ui = `Read the recent transcript of another CCD session.
...
const hi = `Archive a CCD session. Archiving stops the session's process and (by default) cleans up its worktree; the session can still be reopened later from the Archived list. Pass the literal string "self" as session_id to archive this session — the conversation ends after this tool result.
...
const fi = `Rename another CCD session.
...
const yi = `Send a message to another CCD session. The message arrives in the target session as a user turn labelled "From {this session's title}" with a link back here, so the user can see where it came from.
...
function vi() {
  return {
    ...
    handleToolCall: async (e, r, t) => {
      ...
      if (e === tt) {
        const l = r.include_archived === true;
        const c = typeof r.limit == "number" && r.limit > 0 ? Math.floor(r.limit) : 20;
        const u = (await o.getAllSessions()).filter(p => p.sessionId !== t.sessionId && (l || !p.isArchived)).sort((p, h) => (h.lastActivityAt ?? 0) - (p.lastActivityAt ?? 0)).slice(0, c).map(p => {
          var f;
          var _;
          const h = ((f = p.prs) == null ? undefined : f.find(A => !A.inherited)) ?? ((_ = p.prs) == null ? undefined : _[0]);
          return {
            ...
            prNumber: h == null ? undefined : h.prNumber,
            prState: h == null ? undefined : h.state,
            lastActivityAt: p.lastActivityAt ? new Date(p.lastActivityAt).toISOString() : undefined
          };
        });
        return {
          content: [{
      ...
      if (e === rt) {
        ...
        const u = ((i = c.prs) == null ? undefined : i.find(h => !h.inherited)) ?? ((s = c.prs) == null ? undefined : s[0]);
        const p = {
          ...
          prNumber: u == null ? undefined : u.prNumber,
          prState: u == null ? undefined : u.state,
          lastActivityAt: c.lastActivityAt ? new Date(c.lastActivityAt).toISOString() : undefined,
          ...
          agent: d == null ? undefined : d.agent,
          effort: c.effort
        };
        return {
          content: [{
      ...
      if (e === nt) {
        ...
        const d = r.include_archived === true;
        const u = typeof r.limit == "number" && r.limit > 0 ? Math.floor(r.limit) : 20;
        const p = await o.searchSessions(c, {
          includeArchived: d,
          limit: u + 1
        });
        const h = await Promise.all(p.filter(f => f.sessionId !== t.sessionId).slice(0, u).map(async f => {
          const _ = await o.getSession(f.sessionId);
          return {
            sessionId: f.sessionId,
            title: _ == null ? undefined : _.title,
            cwd: _ == null ? undefined : _.cwd,
            isArchived: (_ == null ? undefined : _.isArchived) ?? false,
      ...
      if (e === ot) {
        ...
        const p = typeof r.before_uuid == "string" ? r.before_uuid.trim() : undefined;
        const {
          formatTranscript: h
        } = await Promise.resolve().then(() => require("./index.chunk-B7OgxkJ-.js"));
        const f = await o.getTranscript(c);
        if (f.length === 0) {
          const v = await o.getSession(c);
          if (v != null && v.transcriptUnavailable) {
            return {
              content: [{
                type: "text",
...
${h(_.events)}`
      ...
      if (e === it) {
        ...
        const u = d ? t.sessionId : c;
        const p = await o.getSession(u);
        if (!p) {
          return {
            content: [{
              type: "text",
      ...
      if (e === st) {
        ...
        const c = typeof r.session_id == "string" ? r.session_id.trim() : "";
        const d = typeof r.title == "string" ? r.title.trim() : "";
        if (!c || !d) {
          return {
            content: [{
              type: "text",
        ...
        } else if (await o.getSession(c)) {
          await o.updateSession(c, {
            title: d,
            titleSource: "user"
          });
          return {
      ...
      if (e === at) {
        ...
        const c = typeof r.session_id == "string" ? r.session_id.trim() : "";
        const d = typeof r.message == "string" ? r.message.trim() : "";
        if (!c || !d) {
          return {
            content: [{
              type: "text",
        ...
        const p = (a = t.getSessionTitle) == null ? undefined : a.call(t);
        const h = Zt(p ?? "");
        const f = h ? ` name="${h}"` : "";
        const _ = `<cross-session-message from="${Zt(t.sessionId)}"${f} encoded="1">
${_i(d)}
</cross-session-message>`;
        const A = await o.sendMessage(c, _, undefined, {
          origin: {
            kind: "peer",
            from: t.sessionId,
            name: (p == null ? undefined : p.trim()) || undefined
          }
        });
        const v = u.title ? ` ("${u.title}")` : "";
        if (A.delivered) {
          return {
            content: [{
              type: "text",
...
class Si extends wn.EventEmitter {
  constructor() {
    ...
    this.currentAccountTaggedId = null;
    this.lastInitAuthFailed = false;
    this.sessionsLoaded = false;
    this.initPromise = null;
    this.hasPendingInit = false;
    this.pendingOrgId = undefined;
    this.initializingOrgId = undefined;
  ...
  setupOrgChangeListener() {
    K.session.defaultSession.cookies.on("changed", (r, t, o, i) => {
      if (t.name === "lastActiveOrg" && !i) {
        ...
        const a = this.hasPendingInit ? this.pendingOrgId : this.initializingOrgId ?? this.currentOrgId;
        if (s && s !== a) {
          n.logger.info(`[${this.managerName}] Org changed from ${this.currentOrgId} to ${s}, reinitializing sessions`);
          this.initializeWithAccount(s);
        }
      }
    });
  }
  setupAccountChangeListener() {
    n.onAccountDetailsChange(() => {
      ...
      if (r.isLoggedOut) {
        if (this.currentAccountId && !this.sawLogoutSinceInit) {
          n.logger.info(`[${this.managerName}] Account logged out, marking for re-init on next login`);
          this.sawLogoutSinceInit = true;
        }
        return;
      }
      const t = r.accountUuid !== undefined && this.currentAccountId !== null && r.accountUuid !== this.currentAccountId;
      if (this.currentAccountId) {
        if (this.sawLogoutSinceInit || t) {
  ...
  async waitForSessionsLoaded(r = 5000) {
    if (!this.sessionsLoaded && (!this.initPromise || !(await this.initPromise, this.sessionsLoaded))) {
      await new Promise(t => {
        const o = s => {
          if (s.type === "initialized") {
            clearTimeout(i);
            this.off("event", o);
            t();
          }
  ...
  async initializeWithAccount(r) {
    ...
    this.initializingOrgId = r;
    this.initPromise = this.doInitialize(r);
    try {
      await this.initPromise;
    } finally {
      this.initPromise = null;
    ...
    if (this.hasPendingInit) {
      ...
      this.hasPendingInit = false;
      this.pendingOrgId = undefined;
      await this.initializeWithAccount(t);
    }
  }
  async doInitialize(r) {
    var s;
    const [t, o] = await Promise.all([n.waitForAccountId(), r !== undefined ? Promise.resolve(r) : n.getLastActiveOrg()]);
    const i = t ?? this.currentAccountId;
    if (!i || !o) {
      this.lastInitAuthFailed = ((s = n.getAccountDetails()) == null ? undefined : s.isLoggedOut) ?? false;
      n.logger.warn(`[${this.managerName}] Cannot initialize sessions: accountId=${t ?? "null"}, orgId=${o ?? "null"}. Keeping existing sessions.`);
      return;
    }
    this.lastInitAuthFailed = false;
    this.sawLogoutSinceInit = false;
    n.logger.info(`[${this.managerName}] Initialization succeeded — accountId=${i}, orgId=${o}, existingSessions=${this.sessions.size}`);
    if (i !== this.currentAccountId || o !== this.currentOrgId) {
      const a = i !== this.currentAccountId;
      const l = n.getAccountTaggedId();
      await this.flushPendingSaves();
      this.onAccountOrgChanged();
      this.sessionsLoaded = false;
      this.sessions.clear();
      this.currentAccountId = i;
      this.currentAccountTaggedId = a ? l : l ?? this.currentAccountTaggedId;
      this.currentOrgId = o;
      this.onAccountResolved(i, o);
      await this.migrateLegacySessions();
      try {
        await this.loadSessions();
      } catch (c) {
        n.logger.error(`[${this.managerName}] loadSessions failed during account transition`, c);
        this.currentAccountId = null;
        this.currentAccountTaggedId = null;
        this.currentOrgId = null;
        this.emit("event", {
...
function Ti(e) {
  ...
  const r = e;
  if (typeof r.result == "string" && er(r.result)) {
    return true;
  }
...
function ki(e) {
  ...
  const r = e;
  const t = "no conversation found with session id";
  if (typeof r.result == "string" && r.result.toLowerCase().includes(t)) {
    return true;
  }
  if (Array.isArray(r.errors)) {
    for (const o of r.errors) {
      if (typeof o == "string" && o.toLowerCase().includes(t)) {
        return true;
      }
    }
  }
...
function Pi(e) {
  ...
  for (const o of e) {
    ...
    const i = (t = o.message) == null ? undefined : t.content;
    if (Array.isArray(i)) {
      for (const s of i) {
        if (typeof s == "object" && s !== null && "type" in s && s.type === "image") {
          r++;
        }
      }
    }
...
const Ii = ["expiredtoken", "unrecognizedclient", "invalidsignature", "incompletesignature", "tokenrefreshrequired", "invalidclienttokenid", "credentialsprovidererror", "unable to locate credentials", "security token included in the request is expired", "security token included in the request is invalid"];
const Mi = [...Ri, ...Ii];
function $e(e) {
  const r = e.toLowerCase();
...
function Oi(e) {
  ...
  if (e.type === "result" && e.is_error) {
    if (e.subtype === "success" && e.api_error_status === 401) {
      return {
        kind: "credential-rejected",
        signal: "http-status"
      };
  ...
  if (e.type === "assistant" && e.error === "authentication_failed") {
    return {
      kind: "credential-rejected",
...
function $i(e) {
  ...
  const r = e;
  if (typeof r.result == "string" && $e(r.result) || typeof r.error == "string" && $e(r.error)) {
    return true;
  }
  if (Array.isArray(r.errors)) {
    for (const t of r.errors) {
...
class Fi {
  ...
  async preflight() {
    ...
    const t = this.wslConfig.distro.toLowerCase();
    const o = r.find(i => i.name.toLowerCase() === t);
    if (!o) {
      throw new Error(`WSL distro "${this.wslConfig.distro}" is not installed. Run \`wsl --list\` to see installed distros.`);
    }
    if (o.version !== 2) {
      throw new Error(`WSL distro "${this.wslConfig.distro}" is WSL 1. Convert it with \`wsl --set-version ${this.wslConfig.distro} 2\` — WSL 2 is required.`);
    }
  }
  supportsLaunchTools() {
    return false;
...
function ji(e, r) {
  ...
  let i = o.parentUuid ? t.get(o.parentUuid) : undefined;
  const s = new Set();
  while (i != null && i.uuid && !s.has(i.uuid)) {
    s.add(i.uuid);
    if (i.type === "assistant" && !i.parent_tool_use_id) {
      return i.uuid;
    }
    i = i.parentUuid ? t.get(i.parentUuid) : undefined;
  }
}
const Bi = 5000;
function Hi(e, r, t) {
  ...
  const i = r.isSidechain ?? false;
  let s;
  let a = Infinity;
  for (const l of e) {
    if (!l.uuid || t.has(l.uuid) || l.parentUuid === undefined || (l.isSidechain ?? false) !== i) {
      continue;
    }
...
function Wi(e) {
  ...
  for (const s of e) {
    if (s.uuid) {
      r.set(s.uuid, s);
      if (s.parentUuid !== undefined && !s.isSidechain && (s.type === "user" || s.type === "assistant")) {
        t = s;
      }
    }
  }
  const o = new Set();
  let i = t;
  while (i != null && i.uuid && !o.has(i.uuid)) {
    o.add(i.uuid);
...
function zi(e, r) {
  const t = r == null ? undefined : r.filter(i => i.base64 ? true : (n.logger.warn("[buildMessageContent] dropping empty-base64 image — an upstream guard is missing", {
    mimeType: i.mimeType
  }), false));
  if (!t || t.length === 0) {
    return e;
...
function Ki(e) {
  ...
  for (const l of e) {
    ...
    const c = (a = l.message) == null ? undefined : a.content;
    if (c === undefined) {
      return null;
    }
    if (typeof c == "string") {
  ...
  if (r.some(l => /^[/!]/.test(l.trimStart()))) {
    return null;
  }
  const o = r.filter(l => l.trim()).join(`

`);
  const i = t.length === 0 ? o : o.trim() ? [...t, {
    type: "text",
    text: o
  }] : t;
  return {
...
function Ji(e) {
  ...
  if (e.includes(" ")) {
    r.push("Tool name contains spaces, which may cause parsing issues");
  }
  if (e.includes(",")) {
    r.push("Tool name contains commas, which may cause parsing issues");
  }
  ...
  if (!Vi.test(e)) {
    ...
    r.push(`Tool name contains invalid characters: ${t.map(o => `"${o}"`).join(", ")}`, "Allowed characters are: A-Z, a-z, 0-9, underscore (_), dash (-), and dot (.)");
    return {
      isValid: false,
      warnings: r
    };
...
class Qi {
  ...
  registerToolTask(r, t, o) {
    ...
    if (i.taskSupport === "forbidden") {
      throw new Error(`Cannot register task-based tool '${r}' with taskSupport 'forbidden'. Use registerTool() instead.`);
    }
...
class xr {
  ...
  setToolRequestHandlers() {
    if (!this._toolHandlersInitialized) {
      ...
      this.server.assertCanSetRequestHandler(ee(n.CallToolRequestSchema));
      ...
      this.server.setRequestHandler(n.ListToolsRequestSchema, () => ({
        tools: Object.entries(this._registeredTools).filter(([, r]) => r.enabled).map(([r, t]) => {
          ...
          if (t.outputSchema) {
            ...
            if (i) {
              o.outputSchema = n.toJsonSchemaCompat(i, {
                strictUnions: true,
                pipeStrategy: "output"
              });
            }
      ...
      this.server.setRequestHandler(n.CallToolRequestSchema, async (r, t) => {
        ...
        try {
          ...
          if (!i) {
            throw new n.McpError(n.ErrorCode.InvalidParams, `Tool ${r.params.name} not found`);
          }
          if (!i.enabled) {
            throw new n.McpError(n.ErrorCode.InvalidParams, `Tool ${r.params.name} disabled`);
          }
          const s = !!r.params.task;
          const a = (o = i.execution) == null ? undefined : o.taskSupport;
          const l = "createTask" in i.handler;
          if ((a === "required" || a === "optional") && !l) {
            throw new n.McpError(n.ErrorCode.InternalError, `Tool ${r.params.name} has taskSupport '${a}' but was not registered with registerToolTask`);
          }
          if (a === "required" && !s) {
            throw new n.McpError(n.ErrorCode.MethodNotFound, `Tool ${r.params.name} requires task augmentation (taskSupport: 'required')`);
          }
          if (a === "optional" && !s && l) {
            return await this.handleAutomaticTaskPolling(i, r, t);
          }
          const c = await this.validateToolInput(i, r.params.arguments, r.params.name);
          const d = await this.executeToolHandler(i, c, t);
          if (!s) {
            await this.validateToolOutput(i, d, r.params.name);
          }
          return d;
        } catch (i) {
          if (i instanceof n.McpError && i.code === n.ErrorCode.UrlElicitationRequired) {
            throw i;
          }
  ...
  async validateToolInput(r, t, o) {
    ...
    const a = await n.safeParseAsync(s, t);
    if (!a.success) {
      const l = "error" in a ? a.error : "Unknown error";
      const c = n.getParseErrorMessage(l);
  ...
  async validateToolOutput(r, t, o) {
    if (!r.outputSchema || !("content" in t) || t.isError) {
      return;
    }
    if (!t.structuredContent) {
      throw new n.McpError(n.ErrorCode.InvalidParams, `Output validation error: Tool ${o} has an output schema but no structured content was provided`);
    }
    const i = n.normalizeObjectSchema(r.outputSchema);
    const s = await n.safeParseAsync(i, t.structuredContent);
    if (!s.success) {
      const a = "error" in s ? s.error : "Unknown error";
      const l = n.getParseErrorMessage(a);
  ...
  async handleAutomaticTaskPolling(r, t, o) {
    ...
    const l = i ? await Promise.resolve(s.createTask(i, a)) : await Promise.resolve(s.createTask(a));
    const c = l.task.taskId;
    let d = l.task;
    const u = d.pollInterval ?? 5000;
    while (d.status !== "completed" && d.status !== "failed" && d.status !== "cancelled") {
      await new Promise(h => setTimeout(h, u));
      const p = await o.taskStore.getTask(c);
      if (!p) {
        throw new n.McpError(n.ErrorCode.InternalError, `Task ${c} not found during polling`);
      }
      d = p;
    }
  ...
  setCompletionRequestHandler() {
    if (!this._completionHandlerInitialized) {
      this.server.assertCanSetRequestHandler(ee(n.CompleteRequestSchema));
      this.server.registerCapabilities({
        completions: {}
      });
      this.server.setRequestHandler(n.CompleteRequestSchema, async r => {
        switch (r.params.ref.type) {
          case "ref/prompt":
            n.assertCompleteRequestPrompt(r);
            return this.handlePromptCompletion(r, r.params.ref);
          case "ref/resource":
            n.assertCompleteRequestResourceTemplate(r);
            return this.handleResourceCompletion(r, r.params.ref);
          default:
  ...
  async handlePromptCompletion(r, t) {
    ...
    if (!o) {
      throw new n.McpError(n.ErrorCode.InvalidParams, `Prompt ${t.name} not found`);
    }
    if (!o.enabled) {
      throw new n.McpError(n.ErrorCode.InvalidParams, `Prompt ${t.name} disabled`);
    }
    if (!o.argsSchema) {
      return _e;
    }
    const i = n.getObjectShape(o.argsSchema);
    const s = i == null ? undefined : i[r.params.argument.name];
    if (!tr(s)) {
      return _e;
    }
    const a = Yi(s);
  ...
  setResourceRequestHandlers() {
    if (!this._resourceHandlersInitialized) {
      this.server.assertCanSetRequestHandler(ee(n.ListResourcesRequestSchema));
      this.server.assertCanSetRequestHandler(ee(n.ListResourceTemplatesRequestSchema));
      this.server.assertCanSetRequestHandler(ee(n.ReadResourceRequestSchema));
      this.server.registerCapabilities({
        resources: {
          listChanged: true
        }
      ...
      this.server.setRequestHandler(n.ReadResourceRequestSchema, async (r, t) => {
        ...
        const i = this._registeredResources[o.toString()];
        if (i) {
          if (!i.enabled) {
            throw new n.McpError(n.ErrorCode.InvalidParams, `Resource ${o} disabled`);
          }
  ...
  setPromptRequestHandlers() {
    if (!this._promptHandlersInitialized) {
      this.server.assertCanSetRequestHandler(ee(n.ListPromptsRequestSchema));
      this.server.assertCanSetRequestHandler(ee(n.GetPromptRequestSchema));
      this.server.registerCapabilities({
        prompts: {
          listChanged: true
        }
      ...
      this.server.setRequestHandler(n.ListPromptsRequestSchema, () => ({
        prompts: Object.entries(this._registeredPrompts).filter(([, r]) => r.enabled).map(([r, t]) => ({
          ...
          title: t.title,
          description: t.description,
          arguments: t.argsSchema ? es(t.argsSchema) : undefined
        }))
      }));
      this.server.setRequestHandler(n.GetPromptRequestSchema, async (r, t) => {
        const o = this._registeredPrompts[r.params.name];
        if (!o) {
          throw new n.McpError(n.ErrorCode.InvalidParams, `Prompt ${r.params.name} not found`);
        }
        if (!o.enabled) {
          throw new n.McpError(n.ErrorCode.InvalidParams, `Prompt ${r.params.name} disabled`);
        }
        if (o.argsSchema) {
          const i = n.normalizeObjectSchema(o.argsSchema);
          const s = await n.safeParseAsync(i, r.params.arguments);
          if (!s.success) {
            const c = "error" in s ? s.error : "Unknown error";
            const d = n.getParseErrorMessage(c);
  ...
  resource(r, t, ...o) {
    ...
    if (typeof t == "string") {
      ...
      const a = this._createRegisteredResource(r, undefined, t, i, s);
      this.setResourceRequestHandlers();
      this.sendResourceListChanged();
      return a;
    } else {
      if (this._registeredResourceTemplates[r]) {
        throw new Error(`Resource template ${r} is already registered`);
      }
      const a = this._createRegisteredResourceTemplate(r, undefined, t, i, s);
      this.setResourceRequestHandlers();
      this.sendResourceListChanged();
      return a;
    }
  ...
  _createRegisteredResource(r, t, o, i, s) {
    const a = {
      ...
      update: l => {
        if (typeof l.uri !== "undefined" && l.uri !== o) {
          delete this._registeredResources[o];
          if (l.uri) {
            this._registeredResources[l.uri] = a;
          }
        }
        ...
        if (typeof l.metadata !== "undefined") {
          a.metadata = l.metadata;
        }
        if (typeof l.callback !== "undefined") {
          a.readCallback = l.callback;
        }
  ...
  _createRegisteredResourceTemplate(r, t, o, i, s) {
    const a = {
      ...
      update: d => {
        if (typeof d.name !== "undefined" && d.name !== r) {
          delete this._registeredResourceTemplates[r];
          if (d.name) {
            this._registeredResourceTemplates[d.name] = a;
          }
        }
        if (typeof d.title !== "undefined") {
          a.title = d.title;
        }
        if (typeof d.template !== "undefined") {
          a.resourceTemplate = d.template;
        }
        if (typeof d.metadata !== "undefined") {
          a.metadata = d.metadata;
        }
        if (typeof d.callback !== "undefined") {
          a.readCallback = d.callback;
        }
    ...
    if (Array.isArray(l) && l.some(d => !!o.completeCallback(d))) {
  ...
  _createRegisteredPrompt(r, t, o, i, s) {
    const a = {
      title: t,
      description: o,
      argsSchema: i === undefined ? undefined : n.objectFromShape(i),
      callback: s,
      enabled: true,
      disable: () => a.update({
        enabled: false
      ...
      update: l => {
        if (typeof l.name !== "undefined" && l.name !== r) {
          delete this._registeredPrompts[r];
          if (l.name) {
            this._registeredPrompts[l.name] = a;
          }
        }
        if (typeof l.title !== "undefined") {
          a.title = l.title;
        ...
        if (typeof l.argsSchema !== "undefined") {
          a.argsSchema = n.objectFromShape(l.argsSchema);
        }
        if (typeof l.callback !== "undefined") {
          a.callback = l.callback;
        }
        if (typeof l.enabled !== "undefined") {
          a.enabled = l.enabled;
        }
    ...
    this._registeredPrompts[r] = a;
    if (i && Object.values(i).some(c => {
      var u;
      const d = c instanceof n.ZodOptional ? (u = c._def) == null ? undefined : u.innerType : c;
      return tr(d);
    })) {
      this.setCompletionRequestHandler();
    }
  ...
  _createRegisteredTool(r, t, o, i, s, a, l, c, d) {
    ...
    const u = {
      ...
      update: p => {
        if (typeof p.name !== "undefined" && p.name !== r) {
          if (typeof p.name == "string") {
            nr(p.name);
          }
          delete this._registeredTools[r];
          if (p.name) {
            this._registeredTools[p.name] = u;
          }
        }
        ...
        if (typeof p.paramsSchema !== "undefined") {
          u.inputSchema = n.objectFromShape(p.paramsSchema);
        }
        if (typeof p.outputSchema !== "undefined") {
          u.outputSchema = n.objectFromShape(p.outputSchema);
        }
        if (typeof p.callback !== "undefined") {
          u.handler = p.callback;
        }
        if (typeof p.annotations !== "undefined") {
          u.annotations = p.annotations;
        }
        if (typeof p._meta !== "undefined") {
          u._meta = p._meta;
        }
    ...
    this._registeredTools[r] = u;
    this.setToolRequestHandlers();
    this.sendToolListChanged();
    return u;
  }
  tool(r, ...t) {
    if (this._registeredTools[r]) {
      throw new Error(`Tool ${r} is already registered`);
    }
    let o;
    let i;
    let s;
    ...
    if (t.length > 1) {
      ...
      if (lt(c)) {
        i = t.shift();
        if (t.length > 1 && typeof t[0] == "object" && t[0] !== null && !lt(t[0])) {
          a = t.shift();
        }
      } else if (typeof c == "object" && c !== null) {
        if (Object.values(c).some(d => typeof d == "object" && d !== null)) {
          throw new Error(`Tool ${r} expected a Zod schema or ToolAnnotations, but received an unrecognized object`);
        }
        a = t.shift();
      }
    }
    const l = t[0];
    return this._createRegisteredTool(r, undefined, o, i, s, a, {
  ...
  prompt(r, ...t) {
    if (this._registeredPrompts[r]) {
      throw new Error(`Prompt ${r} is already registered`);
    }
    let o;
    if (typeof t[0] == "string") {
      o = t.shift();
    ...
    const s = t[0];
    const a = this._createRegisteredPrompt(r, undefined, o, i, s);
  ...
  registerPrompt(r, t, o) {
    ...
    const l = this._createRegisteredPrompt(r, i, s, a, o);
    this.setPromptRequestHandlers();
    this.sendPromptListChanged();
    return l;
  }
...
function lt(e) {
  if (typeof e != "object" || e === null || $r(e)) {
    ...
    return Object.values(e).some(Or);
  }
}
function or(e) {
  if (e) {
    if (lt(e)) {
      return n.objectFromShape(e);
    }
    if (!$r(e)) {
...
function es(e) {
  ...
  if (r) {
    return Object.entries(r).map(([t, o]) => {
      const i = n.getSchemaDescription(o);
      const s = n.isSchemaOptional(o);
      return {
        name: t,
        description: i,
        required: !s
...
function ee(e) {
  const r = n.getObjectShape(e);
  const t = r == null ? undefined : r.method;
  if (!t) {
...
function le(e, r) {
  ...
  const a = Re(((l = e.builtinMcpRegistry()) == null ? undefined : l.all()) ?? [], r);
  if (a) {
    return {
...
async function Ie(e, r) {
  ...
  switch (t.phase) {
    ...
    case "parked-no-tools":
      n.logger.info("[custom3p-mcp] lazy reconnect on imperative tool-call miss", {
        server: t.rawName
      });
      return n.reconnectParkedMcpOnDemand(e, t.rawName);
    case "builtin-parked":
      n.logger.info("[custom3p-mcp] lazy respawn on imperative tool-call miss", {
        server: t.rawName
      });
      return Y.respawnBuiltinMcpOnDemand(e, t.rawName);
    case "unknown":
      return null;
  }
}
...
const Me = new Set();
const ns = new Set(["outlook", "sharepoint", "onedrive", "teams"]);
function ut(e, r, t, o, i) {
  var u;
  if (!n.isBuiltinMcpEntry(e) || e.server !== "microsoft365") {
    return;
  }
  const s = typeof i == "string" ? undefined : i._meta;
  const a = typeof (s == null ? undefined : s.graph_http_status) == "number" ? s.graph_http_status : undefined;
  const l = t.find(p => p.name === r);
  const c = l ? r.split("_", 1)[0] : "";
  const d = {
    m365_tool: l ? r : "unknown_tool",
    graph_service: ns.has(c) ? c : "unknown",
    azure_cloud: e.azureCloud ?? "global",
    is_write: ((u = l == null ? undefined : l.annotations) == null ? undefined : u.readOnlyHint) !== true,
    duration_ms: o,
    status: typeof i == "string" ? i : i.isError === true ? "error" : "ok",
    ...(a !== undefined && {
      http_status: a
    })
  };
  n.logCoworkEvent("builtin_m365_call", d);
  n.logger.info("[office365-mcp] tool call", d);
}
function os(e, r, t, o, i, s, a) {
  ...
  for (const {
    ...
    if (n.isBuiltinMcpEntry(c)) {
      ...
      const P = v.uncovered.filter(m => !Me.has(`${c.server}:${m}`));
      if (P.length > 0) {
        for (const m of P) {
          Me.add(`${c.server}:${m}`);
        }
        n.logger.warn(`[directMcp] built-in ${c.server} exposes write tools with no default-ask coverage: ${P.join(", ")}`);
        n.logCoworkEvent("builtin_unlisted_write_tools", {
      ...
      if (y.length > 0) {
        for (const m of y) {
          Me.add(`glob-allow:${c.server}:${m}`);
        }
        n.logger.warn(`[directMcp] built-in ${c.server} exposes unlisted write tools pre-approved only by wildcard allow keys: ${y.join(", ")}`);
        n.logCoworkEvent("builtin_glob_allow_write_tools", {
          builtin_server: c.server,
    ...
    const f = o ? h.filter(v => o[`${c.name}:${v.name}`] !== false) : h;
    if (f.length === 0) {
      continue;
    }
    const _ = new xr({
    ...
    _.server.setRequestHandler(n.CallToolRequestSchema, async (v, P) => {
      ...
      if (a) {
        ...
        if (S) {
          ...
          const D = O instanceof Y.BuiltinMcpUserDisconnectedError || O instanceof n.ParkedMcpUserDisconnectedError;
          const L = D ? "user_disconnected" : k ? "respawn_failed" : "reconnect_failed";
          n.logCoworkEvent("lam_mcp_tool_call_completed", {
            ...
            session_id: r,
            session_type: t,
            user_message_uuid: i == null ? undefined : i()
          });
          if (k) {
            ut(c, y, u, Date.now() - T, D ? "user_disconnected" : "respawn_failed");
          }
          return dt(O);
        }
      }
      if (n.lookupMcpToolPolicy(w.toolPolicy, y) === "blocked") {
        return {
          content: [{
            type: "text",
            text: `Tool '${y}' is not permitted`
      ...
      const C = async () => {
        var R;
        if (!A.has(y) || s != null && s(c.name, y)) {
          return `Tool '${y}' is not permitted`;
        }
        const T = await (a == null ? undefined : a(c.name).catch(() => null));
        const k = (T == null ? undefined : T.config) ?? w;
        const S = n.getManagedConfig();
        if (n.lookupMcpToolPolicy(n.resolveManagedToolPolicy(k.name, {
          poolConfig: k,
          freshConfig: {
            managedMcpServers: S.mcp.managedServers,
            orgPluginSettings: (R = S.plugins) == null ? undefined : R.settings
          }
        }), y) === "blocked") {
          return `Tool '${y}' is not permitted`;
        } else {
          return (T == null ? undefined : T.client) ?? g;
        }
      };
      const b = Date.now();
      const E = await Dr(g, c.name, w.transport, y, m ?? {}, r, t, i, C, P == null ? undefined : P.signal);
      ut(w, y, u, Date.now() - b, E);
      return E;
    });
    l[c.name] = {
      type: "sdk",
...
async function Dr(e, r, t, o, i, s, a, l, c, d) {
  ...
  const p = t === "http" || t === "sse" ? "remote" : "local";
  const h = Date.now();
  let f = 0;
  const _ = new Map();
  const A = {
    session_id: s,
    session_type: a,
    user_message_uuid: l == null ? undefined : l()
  };
  const v = (y, m) => {
  ...
  for (let y = 0;; y++) {
    ...
    try {
      ...
      if (g._meta && "anthropic_error_code" in g._meta) {
        ...
        g._meta = Object.keys(C).length > 0 ? C : undefined;
      }
      v(g.isError === true);
      return g;
    } catch (g) {
      if (n.isUrlElicitationRequired(g) && y < rs) {
        ...
        if (b.length > 0) {
          try {
            ...
            n.logger.warn("[custom3p-mcp] elicitation URL rejected", {
              serverName: r,
              toolName: o,
              error: String(k)
            });
            v(true, "elicitation_rejected");
            return {
              content: [{
                type: "text",
          ...
          try {
            ...
            n.logger.warn("[custom3p-mcp] elicitation dialog failed", {
              serverName: r,
              toolName: o,
              error: S
            });
      ...
      const C = w.toLowerCase().includes("timeout");
      n.logger.error("[custom3p-mcp] tool call failed", {
        serverName: r,
        toolName: o,
        error: w
      });
      v(true, n.isUrlElicitationRequired(g) ? "elicitation_rejected" : C ? "timeout" : "network_error");
      return {
        content: [{
          type: "text",
...
async function Lr(e, r) {
  if (e.isError || !r.persistScreenshotForDispatch || !e.content.some(s => s.type === "image")) {
    return;
  }
  const t = [];
  let o = false;
  ...
  for (const s of e.content) {
    ...
    if (s.type === "image") {
      try {
        ...
        i = true;
        n.logger.warn(`Failed to persist screenshot to disk: ${a instanceof Error ? a.message : String(a)}`);
      }
    }
  }
  if (o) {
...
const ss = [/Helper(?:$|\s\()/, /Agent(?:$|\s\()/, /Service(?:$|\s\()/, /Uninstaller(?:$|\s\()/, /Updater(?:$|\s\()/, /^\./];
const as = new Set(["com.tinyspeck.slackmacgap", "us.zoom.xos", "com.microsoft.teams2", "com.microsoft.teams", "com.apple.MobileSMS", "com.apple.mail", "com.microsoft.Word", "com.microsoft.Excel", "com.microsoft.Powerpoint", "com.microsoft.Outlook", "com.apple.iWork.Pages", "com.apple.iWork.Numbers", "com.apple.iWork.Keynote", "com.google.GoogleDocs", "notion.id", "com.apple.Notes", "md.obsidian", "com.linear", "com.figma.Desktop", "com.github.GitHubDesktop", "com.apple.finder", "com.apple.iCal", "com.apple.systempreferences"]);
function ls(e, r) {
  for (const t of is) {
    if (e.startsWith(t)) {
      return true;
...
function cs(e, r, t = new Set(), o = "darwin", i) {
  const s = i !== undefined ? e.filter(v => v.bundleId !== i) : e;
  if (o === "win32") {
    const v = new Set();
    const P = [];
    for (const w of s) {
      if (t.has(w.bundleId)) {
        v.add(w.displayName.trim().normalize("NFC"));
      }
      if (!sr(w.displayName)) {
        P.push(w.displayName);
      }
    }
    const y = Qe(P);
    const [m, g] = y.reduce((w, C) => {
      w[v.has(C) ? 0 : 1].push(C);
      return w;
    }, [[], []]);
    return ar([...m, ...g]);
  }
  ...
  for (const v of s) {
    if (t.has(v.bundleId)) {
      c.add(v.displayName.trim().normalize("NFC"));
    }
    if (as.has(v.bundleId)) {
  ...
  const u = Qe(a);
  const p = new Set(d);
  const h = u.filter(v => !p.has(v));
  const f = [...d, ...h];
  const [_, A] = f.reduce((v, P) => {
    v[p.has(P) || c.has(P) ? 0 : 1].push(P);
    return v;
  }, [[], []]);
  return ar([..._, ...A]);
}
...
async function hs() {
  try {
    ...
    const r = e.executor.listInstalledApps();
    const t = new Promise(s => setTimeout(() => s(undefined), lr));
    const o = await Promise.race([r, t]);
    if (!o) {
      n.logger.debug(`[cu] app enumeration exceeded ${lr}ms, omitting list`);
      r.catch(() => {});
      return;
    }
    let i = new Set();
    try {
      ...
      const a = await Promise.race([s, t]);
      if (a) {
        i = new Set(a.map(l => l.bundleId));
      } else {
        s.catch(() => {});
      }
    } catch {}
...
if (n.isComputerUseEnabled()) {
  (async () => {
    try {
      await n.getComputerUseHostAdapter().executor.listInstalledApps();
      n.logger.debug("[cu] app enumeration pre-warm complete");
    } catch {}
  })();
}
...
async function gs(e, r) {
  const t = n.isComputerUseEnabled() ? await fs() : V ??= pt(undefined);
  const o = n.getChicagoBatchOnly() ? t.filter(s => !Le.CU_BATCH_ONLY_HIDDEN_TOOLS.has(s.name)).map(s => s.name === "computer_batch" ? {
    ...s,
    description: `${s.description}${ms}`
  } : s) : t;
  const i = St(e, r) ? o.map(s => ({
    ...s,
    alwaysLoad: true
  })) : o;
  return {
...
const ys = "Another Claude session is currently using the computer. Wait for the user to acknowledge it is finished (stop button in the Claude window), or find a non-computer-use approach if one is readily apparent.";
function ws(e) {
  return {
    getAllowedApps: () => {
      var r;
      return ((r = e.getCuAllowedApps) == null ? undefined : r.call(e)) ?? [];
    },
    getGrantFlags: () => {
      var r;
      return ((r = e.getCuGrantFlags) == null ? undefined : r.call(e)) ?? Le.DEFAULT_GRANT_FLAGS;
    },
    getUserDeniedBundleIds: () => n.getAppPreference("chicagoUserDeniedBundleIds"),
    getSelectedDisplayId: () => {
      var r;
      if ((r = e.getCuSelectedDisplayId) == null) {
        return undefined;
      } else {
        return r.call(e);
      }
    ...
    onAllowedAppsChanged: e.onCuPermissionUpdated ? (r, t) => e.onCuPermissionUpdated([...r], t) : undefined,
    ...
    checkCuLock: e.checkCuLock ? async () => e.checkCuLock() : undefined,
    acquireCuLock: e.acquireCuLock ? async () => e.acquireCuLock() : undefined,
...
async function vs(e, r, t) {
  ...
  if (!e.onComputerUsePermissionRequest) {
    return o("Computer Use is available but not enabled, and this session is not wired with a permission handler to show the enable prompt. Computer control is not available here.");
  }
  if (r !== "request_access") {
    return o("Computer Use is available but not yet enabled. Call request_access to show the user an in-chat enable prompt.");
  }
  const i = await n.ensureOsPermissions();
  const s = i.granted ? undefined : {
    accessibility: i.accessibility,
    screenRecording: i.screenRecording
  };
  const a = typeof t.reason == "string" ? t.reason.trim() : "";
  const l = {
  ...
  if (n.isComputerUseAvailableButOptedOut()) {
    return o("The user saw the enable prompt and chose not to turn on Computer Use. Do not retry in this turn. Let the user know you can't complete this without computer use and offer an alternative if one exists. If the user sends a new request that requires computer use, you may call request_access again.");
  }
  const d = `

IMPORTANT — safety rules now in effect:

${n.resolveSection((h = e.getSpSectionPrompts) == null ? undefined : h.call(e), n.SP_SECTION_KEYS.cuSafetyRules, vt)}`;
  const u = await n.ensureOsPermissions();
  if (u.granted) {
    return o("Computer Use is now enabled. Call request_access again to select which applications Claude may control." + d);
  }
  const p = [];
  if (!u.accessibility) {
    p.push("Accessibility");
  }
  if (!u.screenRecording) {
    p.push("Screen Recording");
  }
  return o(`Computer Use is now enabled, but ${p.join(" and ")} permission(s) are not yet granted. These need to be granted in the Claude desktop app. Once the user grants them, call request_access again to select applications.${d}`);
}
const ur = {
  ...
  handleToolCall: async (e, r, t) => {
    ...
    if (n.isComputerUseAvailableButOptedOut()) {
      ...
      const m = g => {
        ...
        n.logCoworkEvent("cu_tool_call", {
          ...
          user_message_uuid: (w = t.getMessageUuid) == null ? undefined : w.call(t),
      ...
      try {
        ...
        m((p = g.telemetry) == null ? undefined : p.error_kind);
        const {
          telemetry: w,
          ...C
        } = g;
    ...
    const l = ((h = t.getTeachModeActive) == null ? undefined : h.call(t)) ?? false;
    const c = n.getChicagoCoordinateMode();
    const d = Date.now();
    const u = y => {
      var m;
      n.logCoworkEvent("cu_tool_call", {
        session_id: t.sessionId,
        session_type: t.sessionType,
        user_message_uuid: (m = t.getMessageUuid) == null ? undefined : m.call(t),
        tool_name: `internal__${n.SERVER_NAME$2}__${o}`,
        is_error: y.isError,
    ...
    try {
      const y = await i(e, a);
      u({
        isError: y.isError ?? false,
        errorKind: (f = y.telemetry) == null ? undefined : f.error_kind,
        grantedCount: (_ = y.telemetry) == null ? undefined : _.granted_count,
        deniedCount: (A = y.telemetry) == null ? undefined : A.denied_count,
        deniedBrowserCount: (v = y.telemetry) == null ? undefined : v.denied_browser_count,
        deniedTerminalCount: (P = y.telemetry) == null ? undefined : P.denied_terminal_count
      });
      const {
        screenshot: m,
        telemetry: g,
      ...
      if ((e === "screenshot" || e === "zoom" || e === "computer_batch") && s === true && t.persistScreenshotForDispatch) {
        await Lr(w, t);
      }
      return w;
    } catch (y) {
...
const Ur = "Window Halo";
const Fr = "halo_attach";
const qr = "halo_detach";
const Ss = [{
  name: Fr,
...
async function Ts(e, r, t) {
  if (process.platform !== "darwin") {
    return ve("halo_* is macOS-only.");
  }
  const o = await n.maybeGetClaudeSwift();
  const i = o == null ? undefined : o.sessionHalo;
  if (!i) {
    return ve("sessionHalo native module not available (nest-only / harness builds skip it).");
  }
  const s = r;
  const a = typeof s.pid == "number" || !!s.bundlePath || !!s.appName;
  const l = await ks(s);
  if (a && !l) {
    return ve(s.appName ? `No running app named "${s.appName}" with a visible window.` : "No running app matched the given pid/bundlePath.");
  }
  if (e === qr) {
    if (l) {
      await i.detach(l);
  ...
  if (e === Fr) {
    if (!l) {
      return ve("Provide one of: pid, bundlePath, appName.");
    }
...
async function ks(e) {
  ...
  const t = e.appName.toLowerCase().trim();
  const o = r == null ? undefined : r.desktop.getOpenWindows().find(i => i.appName.toLowerCase() === t);
  if ((o == null ? undefined : o.pid) !== undefined) {
    return {
      pid: o.pid
    };
  } else {
...
function Es() {
  return {
    ...
    tools: Ss,
    handleToolCall: Ts,
    isEnabled: () => process.platform === "darwin" && false
  };
}
const bt = "ccd_directory";
const ht = "request_directory";
const Cs = `mcp__${bt}__${ht}`;
const As = "Request access to a directory on the user's computer that is outside your current working directory. If you know the path, pass it — the user sees and approves it. If you omit `path`, a native folder picker opens. Use this whenever the user asks you to work with files you don't currently have access to.";
function Ps() {
  return {
    serverName: bt,
    tools: [{
    ...
    handleToolCall: async (e, r, t) => {
      ...
      const o = typeof r.path == "string" && r.path.trim().length > 0 ? r.path.trim() : undefined;
      const {
...
const pr = "spawn_task";
const hr = "dismiss_task";
const mr = "mark_chapter";
const Rs = `mcp__${Tt}__${n.READ_WIDGET_CONTEXT}`;
const Is = "Read context from an embedded interactive widget. Widgets are rendered alongside chat from prior tool calls and can be interacted with by the user. Call this when you need to know the current state of a widget.";
const Ms = {
  type: "object",
  properties: {
    tool_name: {
...
const xs = `Flag an out-of-scope issue for a separate background task.
...
const Os = `Withdraw a background-task chip you previously created with spawn_task.
...
const Ds = `Mark the start of a new chapter in this session.
  ...
  return {
    ...
    handleToolCall: async (e, r, t) => {
      if (e === n.READ_WIDGET_CONTEXT) {
        ...
        const _ = f.getWidgetToolStates(t.sessionId) ?? [];
        const A = _.filter(P => P.tool_name === h);
        if (A.length === 0) {
        ...
        const v = [];
        for (const P of A) {
          for (const y of P.content) {
            if (y.type === "text" && y.text !== undefined) {
              v.push({
                type: "text",
                text: y.text
              });
            } else if (y.type === "image" && y.data !== undefined && y.media_type !== undefined) {
              v.push({
                type: "image",
                data: y.data,
      ...
      if (e === hr) {
        ...
        const f = typeof r.reason == "string" ? r.reason.trim() : "";
        if (!/^task_[0-9a-f]{8}$/.test(h)) {
          return {
            content: [{
              type: "text",
        ...
        const A = _.dismissBackgroundTaskSuggestionById(t.sessionId, h, f || undefined);
        return {
          content: [{
            type: "text",
            text: {
      ...
      const i = typeof r.prompt == "string" ? r.prompt : "";
      const s = typeof r.tldr == "string" ? r.tldr : "";
      const a = typeof r.cwd == "string" ? r.cwd.trim() : "";
      if (!i.trim()) {
        return {
          content: [{
            type: "text",
      ...
      const d = `task_${Tn.randomBytes(4).toString("hex")}`;
      const u = c.enqueueBackgroundTaskSuggestion(t.sessionId, {
        id: d,
        title: o.trim() || undefined,
        prompt: i.trim(),
        tldr: s.trim() || undefined,
        cwd: l
      });
      if (u === null) {
        return {
...
const qs = j.constants.O_NONBLOCK ?? 0;
const De = 10485760;
async function js(e, r, t = {
  ...
  for (const l of i) {
    ...
    if (o) {
      ...
      const f = de.mapVMPathToHostPath(l, o);
      if (h !== null) {
        c.push(h);
      }
      if (f !== null && f !== h) {
      ...
      if (c.length === 0 && de.isScratchpadVMPath(l, o.vmProcessName) && o.sessionStorageDir && !l.split(/[/\\]/).slice(1).some(_ => _ === ".." || _ === "." || _ === "")) {
        n.logger.warn(`[chromeFileUpload] rejected scratchpad path for session ${e}: ${l}`);
        return {
  ...
  n.logger.debug(`[chromeFileUpload] session ${e}: ${a.length} file(s), ${De - t.remaining} bytes (budget remaining ${t.remaining})`);
  return {
    files: a
  };
}
async function Bs(e, r, t) {
  ...
  try {
    ...
    n.logger.warn(`[chromeFileUpload] open failed: ${e} (${s instanceof Error ? s.message : String(s)})`);
    return {
  ...
  try {
    ...
    const a = await n.isPathSymlinkFree(r);
    const l = a ? await H.stat(r).catch(() => null) : null;
    if (!s.isFile() || !a || l === null || l.ino !== s.ino || l.dev !== s.dev) {
      return {
        error: `Cannot upload "${e}": path moved during validation.`
      };
    }
    if (s.size > t.remaining) {
      return {
        error: `Cannot upload "${e}": total upload size would exceed ${Math.round(De / 1048576)} MB. file_upload sends file contents over the browser bridge in a single message; use a smaller file, or split across multiple file_upload calls if the page accepts files one at a time.`
      };
    }
    const c = await i.readFile();
    if (c.length > s.size || c.length > t.remaining) {
      return {
    ...
    n.logger.warn(`[chromeFileUpload] read failed: ${e} (${s instanceof Error ? s.message : String(s)})`);
    return {
...
const Hs = {
  ...
  handleToolCall: async (e, r, t, o) => {
    ...
    const s = t.onBrowserPermissionRequest ? async k => {
      var R;
      var O;
      var D;
      var L;
      ...
      n.logger.debug(`[Chrome MCP] Permission result: allowed=${S.allowed}, always=${S.always ?? false}, allSites=${S.allSites ?? false}`);
      if (S.allowed && S.allSites) {
        if ((O = t.onChromePermissionUpdated) != null) {
          O.call(t, "skip_all_permission_checks", ((R = t.getChromeAllowedDomains) == null ? undefined : R.call(t)) ?? []);
        }
        n.logger.debug("[Chrome MCP] \"Allow all sites\" → mode=skip_all_permission_checks");
        ...
        if (se) {
          const he = (D = t.getChromePermissionMode) == null ? undefined : D.call(t);
          const be = new Set(((L = t.getChromeAllowedDomains) == null ? undefined : L.call(t)) ?? []);
          be.add(se);
          const Te = !he || he === "ask" ? "follow_a_plan" : he;
          if ((U = t.onChromePermissionUpdated) != null) {
            U.call(t, Te, [...be]);
          }
          n.logger.debug(`[Chrome MCP] "Always allow" → mode=${Te}, stored: ${se}`);
        }
      }
      return S.allowed;
    } : undefined;
    const a = (P = t.getChromePermissionMode) == null ? undefined : P.call(t);
    const l = (y = t.getChromeAllowedDomains) == null ? undefined : y.call(t);
    const c = (m = t.getSdkPermissionMode) == null ? undefined : m.call(t);
    n.logger.debug(`[Chrome MCP] tool=${e} mode=${a ?? "<unset>"} allowedDomains=[${(l ?? []).join(",")}] cicCanUseTool=${t.cicCanUseToolEnabled}`);
    if (n.buildGrandPrixHostTools().some(k => k.name === e) && (t.isUnattendedSession === undefined || t.isUnattendedSession())) {
      n.logger.info(`[Chrome MCP] ${e} → deny (unattended session)`);
      return {
        content: [{
          type: "text",
    ...
    const d = {
      ...
      tabGroupId: (g = t.getChromeTabGroupId) == null ? undefined : g.call(t),
      displayName: (w = t.getSessionTitle) == null ? undefined : w.call(t),
      userMessageUuid: (C = t.getMessageUuid) == null ? undefined : C.call(t)
    };
    const u = (() => {
      var k;
      var S;
      if (t.cicCanUseToolEnabled) {
        if (a === "skip_all_permission_checks") {
          return {
            permissionMode: "skip_all_permission_checks",
            sessionScope: d
          };
        }
        if ((c === "auto" || c === "bypassPermissions") && ((k = t.isUnattendedSession) == null || !k.call(t))) {
          return {
        ...
        const R = n.CIC_PERMISSIONLESS_TOOLS.has(e) || n.buildGrandPrixHostTools().some(O => O.name === e) || (S = t.consumeCicOnceApproved) == null ? undefined : S.call(t);
        return {
          ...
          onPermissionRequest: async O => {
            ...
            const L = D ? n.stripCicWww(D) : undefined;
            if (R && L && [...R].some(U => n.stripCicWww(U) === L)) {
              return true;
            } else {
              n.logCoworkEvent("cic_proxy_stale_deny", {
                session_allowed: l ?? [],
                ext_saw: D ?? "<unparseable>",
                once_approved: R ? [...R].join(",") : undefined
              });
              n.logger.info("[Chrome MCP] Deny — approved-host mismatch. Tab moved or proxy stale.");
              return false;
            }
          },
          sessionScope: d
    ...
    const p = (k, S) => {
      ...
      if (k === "browser_batch" && Array.isArray(D.actions)) {
        D.actions = D.actions.map(L => {
          if (typeof L != "object" || L === null) {
            return L;
          }
          const U = L;
          if (typeof U.name != "string" || typeof U.input != "object" || U.input === null) {
            return L;
          } else {
            return {
              ...U,
    ...
    try {
      ...
      const S = (b = k._meta) == null ? undefined : b.frontLoadedTabGroupId;
      if (typeof S == "number" && ((E = t.getChromeTabGroupId) == null ? undefined : E.call(t)) !== S) {
        if ((T = t.onChromeTabGroupIdUpdated) != null) {
          T.call(t, S);
        }
      }
      if ((e === "computer" || e === "browser_batch") && h === true && t.persistScreenshotForDispatch) {
        await Lr(k, t);
      }
      return k;
    } finally {
  ...
  isEnabled: () => {
    var e;
    var r;
    return n.getDeploymentMode().shouldEnableChromeExtensionBridge() && !(((r = (e = n.getChromeExtensionMcpContext()).isDisabled) == null ? undefined : r.call(e)) ?? false);
  }
};
function Ws(e, r) {
  var o;
  ...
  const t = (o = e.content) == null ? undefined : o[0];
  if ((t == null ? undefined : t.type) === "text" && typeof t.text == "string") {
    try {
      const s = JSON.parse(t.text);
      if (typeof s.tabGroupId == "number") {
        if ((i = r.onChromeTabGroupIdUpdated) != null) {
          i.call(r, s.tabGroupId);
        }
      }
    } catch {}
  }
...
async function Gs(e, r) {
  ...
  if ("checkUrl" in e) {
    o.checkUrls = [e.checkUrl];
  } else {
    o.includePermissionState = true;
  }
  let i;
  try {
  ...
  const a = (c = s.result) == null ? undefined : c.content;
  const l = Array.isArray(a) && a[0] && typeof a[0] == "object" && "text" in a[0] && typeof a[0].text == "string" ? a[0].text : undefined;
  if (l) {
    try {
      const p = JSON.parse(l);
      if ("checkUrl" in e) {
        const f = (d = p.checkedUrls) == null ? undefined : d[0];
        if (f) {
          return {
            url: f.url,
      ...
      const h = (u = p.availableTabs) == null ? undefined : u.find(f => f.tabId === e.tabId);
      if (h) {
        return {
          url: h.url,
...
const zs = "search_mcp_registry";
const Br = "plugins";
const kt = "skills";
const Hr = "cowork-onboarding";
const Ks = {
  serverName: Fe,
  tools: [{
    name: zs,
...
- None of the search results are relevant to what the user needs`,
  ...
  handleToolCall: async (e, r, t) => {
    if (e === "search_mcp_registry") {
      ...
      const s = (await Y.searchDirectoryServers(t.sessionId, o)).slice(0, 10).map(a => {
        var d;
        var u;
        const l = ((d = a.toolNames) == null ? undefined : d.slice(0, 8)) ?? [];
        const c = (((u = a.toolNames) == null ? undefined : u.length) ?? 0) > l.length;
        return {
          name: a.name,
    ...
    if (e === "suggest_connectors") {
      ...
      const a = (await Y.getDirectoryServersByUuids(t.sessionId, o ?? [])).map(l => ({
        name: l.name,
    ...
    if (e === "list_connectors") {
      ...
      const s = (await Y.listInstalledDirectoryServers(t.sessionId, o)).map(a => ({
        name: a.name,
        description: a.oneLiner,
        url: a.url,
        iconUrl: a.iconUrl,
...
Results include a matchedCapabilities array showing which skill, command, or connector matched, plus the plugin's full skills list. When results fit, call suggest_plugin_install once with the matching plugins (and their skills) to render the install card — the card shows skills inline, so describing them in text isn't needed. If nothing relevant, proceed normally without mentioning that you searched.`,
  ...
  handleToolCall: async (e, r, t) => {
    ...
    if (e === "list_plugins") {
      ...
      const a = await Y.listInstalledPluginsForWidget(t.sessionId, i);
      const {
        results: l
      } = JSON.parse(a);
      const c = l.map(d => ({
    ...
    if (e === "search_plugins") {
      ...
      return {
        content: [{
          type: "text",
          text: await Y.searchPluginsForSuggestion(t.sessionId, s, i, (o = t.getMessageUuid) == null ? undefined : o.call(t), a)
        }]
      };
    }
    return {
  ...
  isEnabled: e => e.sessionType === "cowork" && e.pluginsEnabled !== false
};
const mt = {
  serverName: kt,
  tools: [{
...
Do NOT write a lead-in before this call — pass context_label for the header. The result may be empty; its note field tells you what to do next.`,
  ...
  handleToolCall: async (e, r, t) => {
    ...
    const [a, l] = await Promise.all([Y.resolveSlashMenuSkills(t.sessionId, o, i), Y.listInstalledPluginsForWidget(t.sessionId, undefined)]);
    let c = [];
    try {
      const {
        results: u
    ...
    let d;
    if (a.length > 0) {
      d = "Skills widget rendered above with the listed skills. Any lead-in goes before this call; skip re-listing them in text.";
    } else if (c.length > 0) {
      d = `No slash-menu skills matched the requested names — the widget did not render. The user has these plugins installed: ${c.join(", ")}. Call list_skills again with no skill_names to surface their skills.`;
    } else {
      d = "No installed skills matched — the widget did not render.";
    }
    return {
      content: [{
        type: "text",
  ...
  isEnabled: e => e.sessionType === "cowork" && e.skillsEnabled !== false
};
function Vs() {
  return {
    ...mt,
...
const Wr = "dev-debug";
const Xs = [Fe, Br, kt, Hr, Ue, Ur, Wr, X, bt, Tt];
const Qs = [Hs, Ks, Ys, mt, Js, {
  serverName: Wr,
  tools: [{
    name: "get_roots",
...
async function Zs(e, r = false, t) {
  await n.refreshInstalledMap(true);
  const o = St(e, t);
  const i = Qs.map(s => o && s.serverName === n.SERVER_NAME$1 ? {
    ...s,
    tools: s.tools.map(a => ({
      ...a,
      alwaysLoad: true
  ...
  i.push({
    ...
    handleToolCall: (s, a, l) => vo(s, a, l.sessionCwd ?? "", l.sessionId, l.onBrowserPermissionRequest ? async (c, d, u) => {
      const p = Object.fromEntries(Object.entries(u).filter(([, f]) => f !== undefined));
    ...
    isEnabled: s => n.isLaunchToolingEnabled() && s.sessionType === "ccd" && !s.isSSH && n.getAppPreference("launchEnabled") !== false
  });
  i.push({
    serverName: vr,
    tools: xn(),
...
class ta {
  constructor() {
    this.enabledServerNames = new Set();
    this.serversGeneration = 0;
  }
  async createProxyServers(r, t, o) {
    var l;
    const i = {};
    const s = await Zs(r.model, r.suggestSkillsEnabled, r.sessionType);
    const a = St(r.model, r.sessionType);
    this.resolvedServers = s;
    this.enabledServerNames.clear();
    for (const c of s) {
      if (!c.isEnabled(r)) {
        n.logger.debug(`[InternalMcpServerManager] Server ${c.serverName} not enabled, skipping`);
        continue;
      }
      const d = [...c.tools, ...(((l = c.getDynamicTools) == null ? undefined : l.call(c)) ?? [])];
      const u = t ? d.filter(f => {
      ...
      const p = u.map(f => ce.tool(f.name, f.description, G.jsonSchemaToZodShape(f.inputSchema), async _ => {
        ...
        const v = {
          ...
          user_message_uuid: (g = r.getMessageUuid) == null ? undefined : g.call(r),
        ...
        const m = new Promise(C => {
          y = setTimeout(() => {
            ...
            C({
              content: [{
                type: "text",
                text: `${f.name} timed out after ${P / 1000}s. The underlying operation (browser extension, CDP, Apple Events) may be stuck or unresponsive.`
              }],
              isError: true
            });
          }, P);
        ...
        try {
          ...
          const b = Date.now() - A;
          const E = ((w = C._meta) == null ? undefined : w.isBridgeTimeout) === true ? "bridge_timeout" : b >= P && C.isError ? "timeout" : undefined;
          n.logCoworkEvent("lam_mcp_tool_call_completed", {
            server_name: c.serverName,
            server_type: "internal",
            server_uuid: n.INTERNAL_SERVER_UUIDS[c.serverName],
      ...
      const h = c.serverName;
      i[h] = ce.createSdkMcpServer({
        name: h,
        version: "1.0.0",
        tools: p
      });
      this.enabledServerNames.add(c.serverName);
      n.logCoworkEvent("lam_internal_mcp_server_created", {
        server_name: c.serverName,
        server_uuid: n.INTERNAL_SERVER_UUIDS[c.serverName],
        tool_count: p.length,
        session_type: r.sessionType,
  ...
  hasServer(r) {
    var t;
    return ((t = this.resolvedServers) == null ? undefined : t.some(o => o.serverName === r)) ?? false;
  }
  listResolvedServerNames() {
    var r;
    return ((r = this.resolvedServers) == null ? undefined : r.map(t => t.serverName)) ?? [];
  }
  readResource(r, t) {
    var i;
    const o = (i = this.resolvedServers) == null ? undefined : i.find(s => s.serverName === r);
    if (o == null || !o.handleReadResource) {
      throw new Error(`Internal server "${r}" does not support resource reads`);
    }
    return o.handleReadResource(t);
  }
  listResources(r) {
    var o;
    const t = (o = this.resolvedServers) == null ? undefined : o.find(i => i.serverName === r);
    if (t == null || !t.handleListResources) {
      throw new Error(`Internal server "${r}" does not support resource listing`);
    }
    return t.handleListResources();
  }
  getAppServersInfo() {
    if (this.resolvedServers) {
      return this.resolvedServers.filter(r => this.enabledServerNames.has(r.serverName)).map(r => {
        var t;
        return {
          name: r.serverName,
          tools: [...r.tools, ...(((t = r.getDynamicTools) == null ? undefined : t.call(r)) ?? [])].map(o => ({
            name: o.name,
...
class na {
  ...
  createProxyServers(r, t, o, i, s) {
    ...
    for (const l of o) {
      ...
      const d = (i ? l.tools.filter(u => i[`${l.uuid}:${u.name}`] !== false) : l.tools).filter(G.isToolVisibleToModel);
      if (d.length) {
        try {
          const u = new xr({
            name: l.name,
          ...
          const h = new Set(p.map(f => f.name));
          ...
          u.server.setRequestHandler(n.CallToolRequestSchema, async f => {
            ...
            if (h.has(_)) {
              return this.proxyToolCall(r, t, l.uuid, _, A ?? {}, s);
            } else {
              return {
                content: [{
                  type: "text",
  ...
  findTool(r, t) {
    var o;
    if ((o = this.toolsByServerUuid.get(r)) == null) {
      return undefined;
    } else {
      return o.find(i => i.name === t);
    }
  }
  async proxyToolCall(r, t, o, i, s, a) {
    ...
    const c = {
      session_id: r,
      session_type: t,
      user_message_uuid: a == null ? undefined : a()
    };
    const d = await n.getLastActiveOrg();
    if (!d) {
      n.logger.error("Cannot execute remote tool call: no active organization", {
        serverUuid: o,
        toolName: i
      });
      n.logCoworkEvent("lam_mcp_tool_call_completed", {
    ...
    const h = n.getMcpToolTimeout();
    const f = setTimeout(() => p.abort(), h);
    ...
    try {
      ...
      _ = y.headers.get("request-id") ?? undefined;
      if (!y.ok) {
        ...
        try {
          ...
          const R = (P = (v = S == null ? undefined : S.error) == null ? undefined : v.details) == null ? undefined : P.error_code;
          k = typeof R == "string" ? R : undefined;
        } catch {}
        n.logCoworkEvent("lam_mcp_tool_call_completed", {
          server_name: o,
          server_type: "remote",
      ...
      const w = m.meta ?? m._meta;
      const C = typeof (w == null ? undefined : w.anthropic_error_code) == "string" ? w.anthropic_error_code : undefined;
      const b = m.is_error ?? false;
      n.logCoworkEvent("lam_mcp_tool_call_completed", {
        server_name: o,
        server_type: "remote",
        tool_name: `mcp__${o}__${i}`,
      ...
      if (g != null && (!Array.isArray(m.content) || m.content.length === 0)) {
        return {
          content: [{
            type: "text",
      ...
      } else if (!("content" in m) && "toolResult" in m) {
        return {
          content: [{
            type: "text",
        ...
        return {
          content: (m.content ?? [{
            ...
            if (T.type === "resource" && T.resource) {
              if ("text" in T.resource && T.resource.text) {
                return {
                  type: "text",
                  text: T.resource.text
                };
              }
              if ("blob" in T.resource && T.resource.blob && (k = T.resource.mimeType) != null && k.startsWith("image/")) {
                return {
                  type: "image",
              ...
              n.logger.warn(`[ProxyMcpServerManager] Unknown content type: ${T.type}`, {
                content: T
              });
              return {
                type: "text",
      ...
      if (y instanceof Error && y.name === "AbortError") {
        n.logger.error("Remote tool call timed out", {
          serverUuid: o,
          toolName: i,
          timeoutMs: h
        });
        n.logCoworkEvent("lam_mcp_tool_call_completed", {
          ...
          error_type: "timeout",
          request_id: _,
          result_byte_size: A !== undefined ? Buffer.byteLength(A, "utf-8") : undefined,
          ...c
        });
        return {
          content: [{
  ...
  async readResource(r, t) {
    ...
    if (!o) {
      n.logger.error("Cannot read resource: no active organization", {
        serverUuid: r,
        uri: t
      });
      return {
    ...
    const a = setTimeout(() => s.abort(), n.getMcpToolTimeout());
    try {
      ...
      if (!l.ok) {
        ...
        n.logger.error("Resource read failed", {
          serverUuid: r,
          uri: t,
          status: l.status,
          errorText: d
      ...
      n.logger.error("Resource read error", {
        serverUuid: r,
        uri: t,
        error: l
      });
  ...
  async listResources(r) {
    const t = await n.getLastActiveOrg();
    if (!t) {
      n.logger.error("Cannot list resources: no active organization", {
        serverUuid: r
      });
      return [];
    }
    ...
    const i = new AbortController();
    const s = setTimeout(() => i.abort(), n.getMcpToolTimeout());
    try {
      ...
      if (!a.ok) {
        ...
        n.logger.error("Resource list failed", {
          serverUuid: r,
          status: a.status,
          errorText: c
        });
      ...
      n.logger.error("Resource list error", {
        serverUuid: r,
        error: a
      });
      return [];
...
function Se() {
  ...
  return {
    ...
    orgPluginSettings: (r = e.plugins) == null ? undefined : r.settings
  };
}
function ft(e) {
  if (e.type === "local" || n.listInternalMcpServers().includes(e.name)) {
    return e.name;
  } else {
    return e.uuid;
  }
...
function gt(e, r) {
  ...
  const t = `${e}:`;
  const o = Object.entries(r).filter(([i]) => i.startsWith(t));
  if (o.length === 0) {
    return false;
  } else {
    return o.every(([, i]) => i === false);
  }
}
function oa(e, r, t) {
  const o = `${e}:`;
  ...
  for (const s of i) {
    const a = (r == null ? undefined : r[s]) !== false;
    const l = t[s] !== false;
    if (a !== l) {
      return true;
    }
...
class sa {
  constructor(r) {
    this.isolationExemptBySession = new Map();
    this.sessionType = r;
    this.proxyManager = new na();
    this.internalManager = new ta();
    this.localMcpManager = G.LocalMcpServerManager.getSharedInstance();
  }
  ...
  createRemoteServers(r, t) {
    ...
    o.syncUserToolToggles(t.enabledMcpTools ?? {});
    if ((s = t.remoteMcpServers) != null && s.length) {
      t = {
        ...t,
    ...
    if (i != null) {
      return os([...i, ...o.parkedServersWithCachedTools()], r, this.sessionType, t.enabledMcpTools, t.getMessageUuid, (l, c) => o.isToolUserDisabled(l, c), l => Ie(n.getDeploymentMode(), l));
    } else if ((a = t.remoteMcpServers) != null && a.length) {
      return this.proxyManager.createProxyServers(r, this.sessionType, t.remoteMcpServers, t.enabledMcpTools, t.getMessageUuid ?? (() => {}));
    } else {
      return {};
    }
  }
  async createAllServers(r, t) {
    const o = Date.now();
    const i = t.mcpServers ?? {};
    const s = Object.keys(i).length;
    const a = Object.fromEntries(Object.entries(i).filter(([g, w]) => {
      if (t.filterFilesystemMcp && w.extensionId === fr) {
        return false;
      }
      const b = n.isFeatureEnabled("2246535838") ? `local:${g}` : g;
      if (gt(b, t.enabledMcpTools)) {
        n.logger.info(`Filtering out local MCP server "${g}" (extension: ${w.extensionId}) — all tools disabled`);
        return false;
      } else {
        return true;
      }
    }));
    const l = s - Object.keys(a).length;
    const c = Object.keys(a).filter(G.collidesWithInternalServerName).length;
    const d = (t.remoteMcpServers ?? []).filter(g => G.collidesWithInternalServerName(g)).length;
    const u = this.createRemoteServers(r, t);
    const p = c + d;
    const h = {
      sessionId: r,
      sessionType: this.sessionType,
    ...
    const f = a;
    const [_, A] = await Promise.all([this.createStdioProxyServers(f, t, h), this.internalManager.createProxyServers(this.buildInternalServerContext(r, t, h.getMessageUuid), t.enabledMcpTools, t.vmPathContext)]);
    const v = {
      ...u,
      ...A,
      ..._
    ...
    const y = Object.keys(u).length;
    const m = Object.keys(A).length;
    n.logCoworkEvent("lam_mcp_servers_setup_summary", {
      session_id: r,
  ...
  async reconcileServers(r, t, o, i) {
    ...
    if (t.toCreate.remote.length > 0) {
      ...
      const h = this.proxyManager.createProxyServers(r, this.sessionType, p, i.enabledMcpTools, a);
      Object.assign(s, h);
    }
    if (t.toCreate.local.length > 0) {
      const p = {};
      for (const f of t.toCreate.local) {
        const _ = (u = i.mcpServers) == null ? undefined : u[f];
        if (!_) {
          n.logger.warn(`[reconcileServers] Local server "${f}" in diff but missing from mcpServers config`);
          continue;
        }
        if (!i.filterFilesystemMcp || _.extensionId !== fr) {
          p[f] = _;
        }
      }
    ...
    if (t.toCreate.internal.length > 0) {
      ...
      for (const h of t.toCreate.internal) {
        if (p[h]) {
          s[h] = p[h];
        }
      }
    ...
    const d = [...t.toCreate.local.map(p => `${p} (local)`), ...t.toCreate.remote.map(p => `${p.name} (remote)`), ...t.toCreate.internal.map(p => `${p} (internal)`)];
    n.logger.info(`[reconcileServers] deleted=[${c.join(", ")}] created=[${d.join(", ")}] total=${Object.keys(s).length}`);
    return s;
  }
  async createMcpServer(r, t, o) {
    const s = n.listInternalMcpServers().includes(t.name) || this.internalManager.hasServer(t.name);
    const a = !s && t.type === "local";
    const l = !s && !a;
    if (!s && G.collidesWithInternalServerName({
      name: t.name,
      uuid: ft(t)
    })) {
      n.logger.warn(`[createMcpServer] Refusing to create server "${t.name}" — name or key collides with a trusted internal server prefix`);
      return null;
    }
    if (l && n.getDeploymentMode().directMcpServers() != null) {
      return null;
    }
    const c = ft(t);
    const d = (o == null ? undefined : o.getMessageUuid) ?? (() => {});
    let u = {};
    if (s) {
      u = await this.internalManager.createProxyServers(o ? this.buildInternalServerContext(r, o, d) : {
        sessionId: r,
        sessionType: this.sessionType,
        getMessageUuid: d
      }, undefined, o == null ? undefined : o.vmPathContext);
    } else if (a) {
      const h = (await n.getMcpServersConfig())[t.name];
      if (!h) {
        n.logger.warn(`[createMcpServer] No config for local server "${t.name}"`);
        return null;
      }
      ...
      u = this.proxyManager.createProxyServers(r, this.sessionType, [{
        uuid: t.uuid,
        name: t.name,
        tools: t.tools ?? []
      }], undefined, d);
  ...
  async createStdioProxyServers(r, t, o) {
    r = G.dropReservedNameServers(r, "local").kept;
  ...
  unregisterRootsProvider(r) {
    this.localMcpManager.unregisterRootsProvider(r);
    this.isolationExemptBySession.delete(r);
  }
  ...
  getInternalServerNamesForDiff() {
    ...
    for (const t of this.internalManager.listResolvedServerNames()) {
      r.add(t);
    }
    return [...r];
  }
  ...
  findDirectMcpConnection(r) {
    ...
    switch (t.phase) {
      ...
      case "builtin-parked":
        return {
          config: t.config,
          tools: n.readPersistedMcpToolSchema(t.rawName) ?? []
        };
      case "parked-no-tools":
        return {
          config: t.config,
  ...
  async callRemoteTool(r, t, o, i, s, a) {
    if ((a == null || !a.directOnly) && (this.isLocalMcpServer(t) || t in (await n.getMcpServersConfig()))) {
      if (G.collidesWithInternalServerName(t)) {
        n.logger.warn(`[callRemoteTool] Refusing call to local MCP server "${t}" — name collides with a trusted internal server prefix`);
        return {
          content: [{
            type: "text",
      ...
      if (c.isToolUserDisabled(t, o) || c.isToolUserDisabled(`local:${t}`, o)) {
        return {
          content: [{
            type: "text",
            text: `Tool '${o}' is not permitted`
        ...
        return this.localMcpManager.callTool(t, o, i);
      }
    }
    let l;
    try {
    ...
    if (l) {
      ...
      if (c === "blocked" || n.getDeploymentMode().isToolUserDisabled(l.config.name, o)) {
        return {
          content: [{
            type: "text",
            text: `Tool '${o}' is not permitted`
      ...
      if (c === "ask") {
        ...
        if (n.lookupMcpToolPolicy(n.resolveManagedToolPolicy(f.config.name, {
          poolConfig: f.config,
          freshConfig: Se()
        }), o) === "blocked" || n.getDeploymentMode().isToolUserDisabled(f.config.name, o)) {
          return {
            content: [{
              type: "text",
              text: `Tool '${o}' is not permitted`
      ...
      const u = Date.now();
      const p = await Dr(d.client, d.config.name, d.config.transport, o, i, r, this.sessionType, undefined, async () => {
        const h = (await Ie(n.getDeploymentMode(), t).catch(() => null)) ?? l;
        if (n.lookupMcpToolPolicy(n.resolveManagedToolPolicy(h.config.name, {
          poolConfig: h.config,
          freshConfig: Se()
        }), o) === "blocked" || n.getDeploymentMode().isToolUserDisabled(h.config.name, o)) {
          return `Tool '${o}' is not permitted`;
        } else {
          return h.client;
        }
      });
      ut(d.config, o, d.tools, Date.now() - u, p);
      return p;
    }
    if (n.getDeploymentMode().directMcpServers() != null) {
      return {
        content: [{
          type: "text",
          text: `Server '${t}' is not connected`
    ...
    } else if (n.getDeploymentMode().isToolUserDisabled(t, o)) {
      return {
        content: [{
          type: "text",
          text: `Tool '${o}' is not permitted`
      ...
      return this.proxyManager.callTool(r, this.sessionType, t, o, i);
    }
  }
  isRemoteToolReadOnly(r, t) {
    ...
    if (this.isLocalMcpServer(r)) {
      ...
      if ((s = (i = d == null ? undefined : d.tools.find(u => u.name === t)) == null ? undefined : i.annotations) == null) {
        return undefined;
      } else {
        return s.readOnlyHint;
      }
    }
    ...
    if (n.getDeploymentMode().directMcpServers() == null) {
      if ((c = (l = this.proxyManager.findTool(r, t)) == null ? undefined : l.annotations) == null) {
        return undefined;
      } else {
  ...
  async getManagedToolPolicy(r, t) {
    if (this.isLocalMcpServer(r) || r in (await n.getMcpServersConfig()) || n.getDeploymentMode().directMcpServers() == null) {
      return;
    }
    const o = this.findDirectMcpConnection(r);
    return n.lookupMcpToolPolicy(n.resolveManagedToolPolicy((o == null ? undefined : o.config.name) ?? r, {
      poolConfig: o == null ? undefined : o.config,
      freshConfig: Se()
    }), t);
  }
  ...
  async readRemoteResource(r, t, o, i) {
    if (i == null || !i.directOnly) {
      if (this.internalManager.hasServer(t)) {
        return this.internalManager.readResource(t, o);
      }
      if (this.isLocalMcpServer(t)) {
        return this.localMcpManager.readResource(t, o);
      }
    }
    const s = le(n.getDeploymentMode(), t);
    if (s.phase === "live") {
      if (this.isDirectMcpResourceBlocked(s.conn)) {
        return {
          contents: []
        };
      }
      try {
        ...
        n.logger.error(`[custom3p-mcp] readResource failed: ${t} ${o}: ${l}`);
        return {
          contents: []
        };
      }
    }
    if (s.phase !== "unknown" || n.getDeploymentMode().directMcpServers() != null) {
      return {
        contents: []
      };
    } else {
      return this.proxyManager.readResource(t, o);
    }
  }
  async listRemoteResources(r, t, o) {
    if (o == null || !o.directOnly) {
      if (this.internalManager.hasServer(t)) {
        return this.internalManager.listResources(t);
      }
      if (this.isLocalMcpServer(t)) {
        return this.localMcpManager.listResources(t);
      }
    }
    const i = le(n.getDeploymentMode(), t);
    if (i.phase === "live") {
      if (this.isDirectMcpResourceBlocked(i.conn)) {
        return [];
      }
      try {
        return (await i.conn.client.listResources(undefined, {
          timeout: ct
        })).resources;
      } catch (s) {
        const a = s instanceof Error ? s.message : String(s);
        n.logger.error(`[custom3p-mcp] listResources failed: ${t}: ${a}`);
        return [];
      }
    }
    if (i.phase !== "unknown" || n.getDeploymentMode().directMcpServers() != null) {
      return [];
    } else {
      return this.proxyManager.listResources(t);
    }
  }
  getMcpServersInfoForRenderer() {
    const r = this.localMcpManager.getConnectionsGeneration();
    const t = this.internalManager.getServersGeneration();
    const o = this.rendererInfoCache;
    if (o && o.localGen === r && o.internalGen === t) {
      return o.info;
    }
    ...
    const s = this.internalManager.getAppServersInfo().map(l => ({
      name: l.name,
      isInternal: true,
      tools: l.tools.map(c => ({
        name: c.name,
...
function la(e, r) {
  e.credentialEpoch = r.epochAtStart;
  e.issuedCredentialIdentity = r.identityAtIssue;
  e.spawnedCredentialExpiresAt = r.secrets.expiresAt;
}
function ca(e, r) {
...
function da(e) {
  ...
  if (r.maybeRefreshBeforeTurn(e.spawnedCredentialExpiresAt)) {
    return {
      stale: true,
      reason: "expiry"
    };
  } else if (e.issuedCredentialIdentity !== r.lastIssuedCredentialIdentity()) {
    return {
      stale: true,
      reason: "identity"
    };
  } else if (e.credentialEpoch !== r.credentialEpoch()) {
    return {
      stale: true,
      reason: "epoch"
    };
...
class ha {
  ...
  onSpawned(r, t) {
    la(r, t);
    this.registerSession(r.sessionId);
  }
  checkWarmReuse(r) {
    return da(r);
  }
  isArmed(r) {
    var t;
    return ((t = this.sessions.get(r)) == null ? undefined : t.idleTimeoutId) != null;
  }
  markDisconnected(r) {
    this.disarmIdle(r);
    const t = this.sessions.get(r);
    if (t) {
      t.hasPendingResult = false;
    }
  }
  disarmIdle(r) {
    const t = this.sessions.get(r);
    if (t == null || !t.idleTimeoutId) {
      return;
    }
    clearTimeout(t.idleTimeoutId);
    t.idleTimeoutId = null;
    const o = t.idleArmedAt != null ? Date.now() - t.idleArmedAt : undefined;
    t.idleArmedAt = null;
    return o;
  }
  registerSession(r) {
  ...
  unregisterSession(r) {
    ...
    this.sessions.delete(r);
    n.logger.debug(`${this.tag} Unregistered session ${r}`);
  }
  onTurnComplete(r) {
    const t = this.sessions.get(r);
    if (t) {
      t.hasPendingResult = true;
      t.lastResultTime = Date.now();
      n.logger.debug(`${this.tag} Turn complete for ${r}, tabVisible: ${t.isTabVisible}`);
      if (this.config.armOnTurnComplete === "always" || !t.isTabVisible) {
        this.startIdleTimeout(r);
      }
    }
  }
  onQueryInstalled(r) {
  ...
  getLruIdleCandidate(r) {
    ...
    for (const i of this.sessions.values()) {
      if (i.isTabVisible || i.isWarmingUp || !i.hasPendingResult || !this.config.hasActiveQuery(i.sessionId) || r && !r(i.sessionId)) {
        continue;
      }
      const s = zr(i);
      if (s < o) {
    ...
    return (t == null ? undefined : t.sessionId) ?? null;
  }
  onMessageSent(r) {
    const t = this.sessions.get(r);
    if (t) {
      n.logger.debug(`${this.tag} Message sent for ${r}`);
      this.clearIdleTimeout(r);
      t.hasPendingResult = false;
      t.lastResultTime = null;
    }
  }
  onVisibilityChange(r, t) {
    ...
    o.isTabVisible = t;
    n.logger.debug(`${this.tag} Visibility change for ${r}: ${i} → ${t}`);
    if (t && !i) {
      this.clearIdleTimeout(r);
      const {
        onWarmUp: l
      ...
      if (l && !this.config.hasActiveQuery(r) && !o.isWarmingUp) {
        ...
        const c = () => {
          ...
          n.logger.info(`${this.tag} Warming up session ${r}`);
          l(r).catch(p => {
        ...
        const u = Math.max(0, this.nextWarmUpSlotAt - d);
        this.nextWarmUpSlotAt = Math.max(d, this.nextWarmUpSlotAt) + pa;
        if (u === 0) {
          c();
        } else {
          n.logger.debug(`${this.tag} Staggering warm-up for ${r} by ${u}ms`);
          if ((a = (s = this.config).onAnalyticsEvent) != null) {
            a.call(s, "desktop_ccd_session_idle_warm_staggered", {
              session_id: r,
              delay_ms: u
            });
          }
      ...
      o.lastHiddenTime = Date.now();
      if (o.hasPendingResult || this.config.timeoutOnHidden) {
        this.startIdleTimeout(r);
      }
    }
  }
  ...
  destroy() {
    for (const [, r] of this.sessions) {
      if (r.idleTimeoutId) {
        clearTimeout(r.idleTimeoutId);
      }
    }
    this.sessions.clear();
    n.logger.info(`${this.tag} Destroyed`);
  }
  startIdleTimeout(r) {
    var i;
    var s;
    ...
    n.logger.info(`${this.tag} Starting idle timeout for ${r}: ${o / 1000}s`);
    if ((s = (i = this.config).onAnalyticsEvent) != null) {
      s.call(i, "desktop_ccd_session_idle_timeout_started", {
        session_id: r,
        timeout_ms: o,
        configured_timeout_ms: o,
        seconds_since_last_activity: t.lastResultTime ? Math.round((Date.now() - t.lastResultTime) / 1000) : null
      });
    }
    t.lastActivityTime = null;
    t.idleArmedAt = Date.now();
    this.scheduleIdleTimeout(t, o);
  }
  scheduleIdleTimeout(r, t) {
    ...
    r.idleTimeoutId = setTimeout(async () => {
      r.idleTimeoutId = null;
      if (this.config.armOnTurnComplete === "when-hidden" && r.isTabVisible) {
      ...
      if (r.lastActivityTime !== null) {
        ...
        r.lastActivityTime = null;
        if (i > 0) {
          n.logger.debug(`${this.tag} Activity during idle window for ${o}, extending ${Math.round(i / 1000)}s`);
          this.scheduleIdleTimeout(r, i);
          return;
        }
      }
  ...
  clearIdleTimeout(r, {
    ...
    var s;
    const o = this.sessions.get(r);
    if (o != null && o.idleTimeoutId) {
      clearTimeout(o.idleTimeoutId);
      o.idleTimeoutId = null;
      o.idleArmedAt = null;
      n.logger.debug(`${this.tag} Cleared timeout for ${r}`);
      if (!t && (s = (i = this.config).onAnalyticsEvent) != null) {
        s.call(i, "desktop_ccd_session_idle_timeout_cancelled", {
          session_id: r,
          seconds_since_last_activity: o.lastResultTime ? Math.round((Date.now() - o.lastResultTime) / 1000) : null
        });
      }
    }
  }
...
function fa(e, r) {
  ...
  const o = `${t[1]}:${t[2]}`;
  if (((i = e.enabledMcpTools) == null ? undefined : i[o]) === false) {
    return {
      decision: "block",
...
function ga(e, r) {
  const t = e.get(r);
  if ((t == null ? undefined : t.sessionType) === n.SESSION_TYPE_DISPATCH_CHILD && t.parentSessionId) {
    const o = e.get(t.parentSessionId);
    if (o && o.lifecycleState !== "archived") {
...
function ya(e) {
  ...
  const r = {};
  if (e.chromePermissionMode !== undefined) {
    r.chromePermissionMode = e.chromePermissionMode;
  }
  if (e.chromeAllowedDomains !== undefined) {
    r.chromeAllowedDomains = [...e.chromeAllowedDomains];
  }
  if (e.cuAllowedApps !== undefined) {
    r.cuAllowedApps = [...e.cuAllowedApps];
  }
  if (e.cuGrantFlags !== undefined) {
    r.cuGrantFlags = {
      ...e.cuGrantFlags
    };
  }
  if (e.approvedToolNames !== undefined) {
    r.approvedToolNames = [...e.approvedToolNames];
  }
  return r;
}
function wa(e, r, t) {
  if (e.some(o => r - o.grantedAt >= t)) {
    return e.filter(o => r - o.grantedAt < t);
  } else {
    return e;
  }
}
...
function va(e, r, t) {
  ...
  const i = gr(e.chromePermissionMode);
  return {
...
function Sa(e, r, t) {
  ...
  const i = t ? "skip_all_permission_checks" : undefined;
  if (o && !e.chromePermsBeforeUnsupervised) {
    return {
...
function ba(e, r, t) {
  ...
  return {
    ...
    cuGrantFlags: {
      clipboardRead: ((i == null ? undefined : i.clipboardRead) ?? false) || t.clipboardRead,
      clipboardWrite: ((i == null ? undefined : i.clipboardWrite) ?? false) || t.clipboardWrite,
      systemKeyCombos: ((i == null ? undefined : i.systemKeyCombos) ?? false) || t.systemKeyCombos
    }
  };
}
function Ta(e) {
...
function ka(e, r, t) {
  return e !== n.MCP_COWORK_REQUEST_DIRECTORY && e !== n.MCP_COWORK_SAVE_SKILL && e !== ma && e !== n.MCP_DELETE_SCHEDULED_TASK && !t(e) && ((r == null ? undefined : r.includes(e)) ?? false);
}
const Ea = "Workflow";
const Kr = "Review the first dynamic workflow before auto-approving.";
const Ca = "Workflow approval policy couldn't be resolved. Retry once your network and settings file are reachable.";
const Yr = "Your organization requires approval for each dynamic workflow.";
function Aa(e) {
  return e === Kr || e === Yr;
}
async function Pa() {
  ...
  const i = (o == null ? undefined : o.value) === false && o.source === n.ClaudeCodeSettingsTier.Managed;
  const s = await n.getLastActiveOrg().catch(() => null);
  return {
    consented: (o == null ? undefined : o.value) === true,
    managedFalse: i,
...
async function Oa(e) {
  ...
  try {
    ...
    if (!t.ok) {
      n.logger.warn(`[policyLimits] GET ${r.pathname} → ${t.status}`);
      return {
        ok: false
      };
    }
    ...
    n.logger.warn("[policyLimits] fetch failed:", t);
    return {
      ok: false
    };
  }
...
async function La(e, r) {
  const t = N.join(e, Ra);
  const o = await H.lstat(t).catch(() => null);
  if (!o || !!o.isFile()) {
    await n.writeFileAtomic(t, JSON.stringify(r, null, 2));
  }
}
...
function ja() {
  ...
  return r => {
    ...
    const t = r.map(i => {
      var s;
      return `${i == null ? undefined : i.uuid}/${((s = i == null ? undefined : i.tools) == null ? undefined : s.length) ?? 0}`;
    }).sort().join();
    const o = e.get(t);
    if (o) {
...
function Jr(e) {
  ...
  if (t > 0) {
    n.logger.warn("Dropped malformed remoteMcpServersConfig entries on session load", {
      dropped: t,
      kept: o.length
    });
  }
...
function Xr(e) {
  if (!e || Buffer.byteLength(JSON.stringify(e), "utf8") <= n.REMOTE_MCP_PERSIST_MAX_BYTES) {
    return e;
  } else {
    return e.map(r => ({
      uuid: r.uuid,
...
function Ga(e, r) {
  ...
  const o = Jr(e.remoteMcpServersConfig);
  return {
    ...{
      sessionId: e.sessionId,
      cliSessionId: e.cliSessionId,
    ...
    sshRemoteProjectDir: e.sshRemoteTranscriptPath ? N.posix.dirname(e.sshRemoteTranscriptPath) : undefined,
    query: null,
    inputStream: null,
    isRunning: false,
...
async function za(e, r) {
  const t = new Set(r);
  for (const o of r) {
    if (!o.startsWith(n.LOCAL_SESSION_PREFIX) || !o.endsWith(".json.tmp")) {
      continue;
    }
    const i = o.slice(0, -4);
    const s = N.join(e, o);
    const a = N.join(e, i);
    const l = await j.promises.stat(s).then(c => c.size).catch(() => 0);
    ...
    if (t.has(i)) {
      if ((await j.promises.stat(a).then(d => d.size).catch(() => 0)) > n.SESSION_FILE_MAX_BYTES) {
        continue;
      }
      try {
    ...
    try {
      ...
      await n.writeFilePrivate(a, c);
      t.add(i);
      n.logger.warn(`[LocalSessionManager] Recovered orphaned session temp ${o} → ${i}`);
      await j.promises.rm(s, {
        force: true
      }).catch(() => {});
    } catch (c) {
...
function Ya(e) {
  ...
  function o(i, s) {
    ...
    let c;
    let d = 0;
    if ((a == null ? undefined : a.type) === "content_block_delta" && a.delta) {
      d = a.index ?? 0;
      switch (a.delta.type) {
        case "text_delta":
          l = "text";
    ...
    if (l === undefined || typeof c != "string") {
      t();
      e(i, s);
      return;
    }
...
async function Xa({
  ...
  try {
    ...
    try {
      ...
      const h = await new n.PQueue({
        concurrency: 20
      }).addAll(u.map(f => async () => {
        const _ = N.join(r, f);
        const A = await j.promises.lstat(_).catch(() => null);
        if (!A || A.isSymbolicLink() || !A.isDirectory()) {
          return null;
        }
        const v = N.join(_, `${e}.jsonl`);
        const P = await j.promises.lstat(v).catch(() => null);
        if (P != null && P.isFile()) {
          return {
            projectPath: _,
            transcriptPath: v
      ...
      for (const f of h) {
        ...
        try {
          if ((await j.promises.lstat(A)).isDirectory()) {
            await Ne(A, e, i);
          }
        } catch {}
        break;
    ...
    for (const [u, p] of Object.entries(o ?? {})) {
      i[u] = new Uint8Array(n.scrubBufferForBundle(u, Buffer.from(p), n.SUPPORT_BUNDLE_SCRUB_OPTS));
    }
    try {
    ...
    const l = `session-export-${Date.now()}.zip`;
    const c = N.join(yr.homedir(), "Downloads");
    const d = N.join(c, l);
    try {
    ...
    await j.promises.writeFile(d, Buffer.from(s));
    n.logger.info(`[transcriptExport] Session ${e} exported to ${d} (${s.length} bytes, ${Object.keys(i).length} files)`);
    return {
      success: true,
      filePath: d
    };
    ...
    n.logger.error(`[transcriptExport] Failed: ${s}`, {
      error: i
    });
    return {
      success: false,
