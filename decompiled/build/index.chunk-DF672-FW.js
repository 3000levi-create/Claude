...
try {
    (function() {
        var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            t = new e.Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "13a7e9c7-cc1d-4995-ba78-b6bdd2e964a0", e._sentryDebugIdIdentifier = "sentry-dbid-13a7e9c7-cc1d-4995-ba78-b6bdd2e964a0")
    })()
} catch {}
...
async function d(e, t) {
    const i = e.epoch;
    if (i !== t.credentialEpoch() || i === o) return;
    const s = o;
    o = i;
    let n = !1;
    try {
...
async function r(e) {
    const {
        showToastInWebapp: t
    } = await Promise.resolve().then(() => require("./index.chunk-c42vKsva.js")).then(n => n.webAppApis), i = a.getIntl();
    if (e.httpStatus === 403 && e.hint === void 0) return t(i.formatMessage({
