...
try {
    (function() {
        var t = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            e = new t.Error().stack;
        e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "5e21ac33-d77b-492a-9a08-67cc69d66003", t._sentryDebugIdIdentifier = "sentry-dbid-5e21ac33-d77b-492a-9a08-67cc69d66003")
    })()
} catch {}
...
const xs = {
        ...
        onStepToMatch(t) {
            const e = (n, r) => t(r);
            return C.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.findInPage_$_FindInPage_$_stepToMatch", e), () => {
        ...
        onFocusInput(t) {
            const e = n => t();
            return C.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.findInPage_$_FindInPage_$_focusInput", e), () => {
        ...
        onBlurInput(t) {
            const e = n => t();
            return C.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.findInPage_$_FindInPage_$_blurInput", e), () => {
    ...
    Is = t => {
        ks() && (t["claude.internal.findInPage"] = t["claude.internal.findInPage"] || {}, t["claude.internal.findInPage"].FindInPage = xs)
    },
    Sr = {};
Is(Sr);
for (const [t, e] of Object.entries(Sr)) C.contextBridge.exposeInMainWorld(t, e);
...
const ws = {
        ...
        onLocaleChanged(t) {
            const e = (n, r, s) => t(r, s);
            return C.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.hybrid_$_DesktopIntl_$_localeChanged", e), () => {
    ...
    Rs = t => {
        Ts() && (t["claude.hybrid"] = t["claude.hybrid"] || {}, t["claude.hybrid"].DesktopIntl = ws)
    },
    kr = {};
Rs(kr);
for (const [t, e] of Object.entries(kr)) C.contextBridge.exposeInMainWorld(t, e);
...
function wr(t) {
    ...
    return /sentryWrapped/.test(Le(e).function || "") && e.pop(), e.reverse(), un.test(Le(e).function || "") && (e.pop(), un.test(Le(e).function || "") && e.pop()), e.slice(0, Ir).map(n => ({
        ...n,
...
function Fs() {
    ut = I.onerror, I.onerror = function(t, e, n, r, s) {
        return j("error", {
            column: r,
            error: s,
            line: n,
...
function Us() {
    dt = I.onunhandledrejection, I.onunhandledrejection = function(t) {
...
function $r(t, e = {}) {
    ...
    try {
        ...
        const d = Array.isArray(e) ? e : e.keyAttrs,
            l = !Array.isArray(e) && e.maxStringLength || Ws;
        for (; n && i++ < r && (u = qs(n, d), !(u === "html" || i > 1 && a + s.length * c + u.length >= l));) s.push(u), a += u.length, n = n.parentNode;
...
function pn(t) {
    try {
        return Zs(t) ? $r(t) : Object.prototype.toString.call(t)
    } catch {
        return "<unknown>"
    }
}
...
function mn(t, e) {
    ...
    for (let r = 0; r < t.length; r++) {
        const s = t[r];
        try {
            Or(s) ? n.push(Rr(s)) : n.push(String(s))
        } catch {
...
function ze(t, e, n = !1) {
    return H(t) ? zs(e) ? e.test(t) : H(e) ? n ? t === e : t.includes(e) : !1 : !1
}
...
function M(t = Js()) {
    ...
    return lt || (lt = "10000000100040008000" + 1e11), lt.replace(/[018]/g, e => (e ^ (Ks() & 15) >> e / 4).toString(16))
}
...
class W {
    ...
    clone() {
        ...
        }, e._client = this._client, e._lastEventId = this._lastEventId, bn(e, vn(this)), e
    }
    setClient(e) {
        this._client = e
    }
    ...
    clear() {
        return this._breadcrumbs = [], this._tags = {}, this._attributes = {}, this._extra = {}, this._user = {}, this._contexts = {}, this._level = void 0, this._transactionName = void 0, this._fingerprint = void 0, this._session = void 0, bn(this, void 0), this._attachments = [], this.setPropagationContext({
            traceId: yn(),
            sampleRand: Math.random()
        }), this._notifyScopeListeners(), this
    }
...
const fi = "sentry.source",
    pi = "sentry.sample_rate",
    hi = "sentry.previous_trace_sample_rate",
    mi = "sentry.op",
    _i = "sentry.origin",
    Fr = "sentry.profile_id",
    jr = "sentry.exclusive_time",
    gi = 0,
    yi = 1,
    bi = "_sentryScope",
    vi = "_sentryIsolationScope";
...
function Ci(t) {
    ...
    return ["protocol", "publicKey", "host", "projectId"].find(a => t[a] ? !1 : (y.error(`Invalid Sentry Dsn: ${a} missing`), !0)) ? !1 : n.match(/^\d+$/) ? Ri(r) ? e && isNaN(parseInt(e, 10)) ? (y.error(`Invalid Sentry Dsn: Invalid port ${e}`), !1) : !0 : (y.error(`Invalid Sentry Dsn: Invalid protocol ${r}`), !1) : (y.error(`Invalid Sentry Dsn: Invalid projectId ${n}`), !1)
}
...
function $i(t) {
    ...
    let r;
    return e.orgId ? r = String(e.orgId) : n && (r = Oi(n)), r
}
...
function Pi(t) {
    const {
        ...
        traceId: n,
        isRemote: r
    } = t.spanContext(), s = r ? e : Jt(t).parent_span_id, i = Ur(t).scope, a = r ? (i == null ? void 0 : i.getPropagationContext().propagationSpanId) || Lr() : e;
    return {
        parent_span_id: s,
        span_id: a,
        trace_id: n
...
function Ui(t) {
    if (!(!t || t.code === gi)) return t.code === yi ? "ok" : t.message || "internal_error"
}
...
function qi(t) {
    ...
    const n = zr(t),
        ...
        a = (i == null ? void 0 : i.get("sentry.sample_rate")) ?? s[pi] ?? s[hi];
    ...
    const l = Hr(t.spanContext().traceId, e),
        g = s[fi],
        p = r.description;
    return g !== "url" && p && (l.transaction = p), Zi() && (l.sampled = String(ji(n)), l.sample_rand = (i == null ? void 0 : i.get("sentry.sample_rand")) ?? ((T = Ur(n).scope) == null ? void 0 : T.getPropagationContext().sampleRand.toString())), o(l), e.emit("createDsc", l, n), l
}

function U(t, e = 100, n = 1 / 0) {
    try {
        return St("", t, e, n)
    } catch (r) {
        return {
...
function Vr(t, e = 3, n = 100 * 1024) {
    const r = U(t, e);
    return Ki(r) > n ? Vr(t, e - 1, n) : r
}

function St(t, e, n = 1 / 0, r = 1 / 0, s = Xi()) {
    const [i, a] = s;
...
function ea(t) {
    ...
    function s(i) {
        typeof r == "string" ? r = typeof i == "string" ? r + i : [kt(r), i] : r.push(typeof i == "string" ? kt(i) : i)
    }
    for (const i of n) {
        const [a, o] = i;
        if (s(`
...
class we {
    ...
    _executeHandlers() {
        ...
        this._handlers = [], e.forEach(n => {
            n[0] || (this._state === On && n[1](this._value), this._state === $n && n[2](this._value), n[0] = !0)
        })
    }
    _runExecutor(e) {
        const n = (i, a) => {
...
function xt(t, e, n, r) {
    ...
    return E && i === null && y.log(`Event processor "${s.id||"?"}" dropped event`), $e(i) ? i.then(a => xt(a, e, n, r + 1)) : xt(i, e, n, r + 1)
}
...
function ua(t, e) {
    ...
    da(t, e), r && pa(t, r), ha(t, n), la(t, s), fa(t, i)
}
...
function qe(t, e) {
    ...
    Fe(t, "extra", n), Fe(t, "tags", r), Fe(t, "user", s), Fe(t, "contexts", i), t.sdkProcessingMetadata = De(t.sdkProcessingMetadata, o, 2), a && (t.level = a), p && (t.transactionName = p), T && (t.span = T), c.length && (t.breadcrumbs = [...t.breadcrumbs, ...c]), u.length && (t.fingerprint = [...t.fingerprint, ...u]), d.length && (t.eventProcessors = [...t.eventProcessors, ...d]), l.length && (t.attachments = [...t.attachments, ...l]), t.propagationContext = {
...
function _a(t, e, n, r, s, i) {
    ...
    ga(c, t), va(c, u), s && s.emit("applyFrameMetadata", e), e.type === void 0 && ya(c, t.stackParser);
    ...
    p.length && (n.attachments = p), ua(c, g);
    const T = [...l, ...g.eventProcessors];
    return ca(T, c, n).then(N => (N && ba(N), typeof a == "number" && a > 0 ? Ea(N, a, o) : N))
}
...
function ga(t, e) {
    ...
    t.environment = t.environment || n || Kt, !t.release && r && (t.release = r), !t.dist && s && (t.dist = s);
    const a = t.request;
    a != null && a.url && i && (a.url = bt(a.url, i)), i && ((c = (o = t.exception) == null ? void 0 : o.values) == null || c.forEach(u => {
...
function Ea(t, e, n) {
    ...
    return (s = t.contexts) != null && s.trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = U(t.contexts.trace.data, e, n))), t.spans && (r.spans = t.spans.map(a => ({
        ...a,
        ...a.data && {
            data: U(a.data, e, n)
        }
    }))), (i = t.contexts) != null && i.flags && r.contexts && (r.contexts.flags = U(t.contexts.flags, 3, n)), r
}
...
function Jr(t, e, n) {
    ...
    if (n[e.name] = e, !Ln.includes(e.name) && typeof e.setupOnce == "function" && (e.setupOnce(), Ln.push(e.name)), e.setup && typeof e.setup == "function" && e.setup(t), typeof e.preprocessEvent == "function") {
...
function Kr(t, e) {
    ...
    const r = t.getOptions(),
        s = Aa(n, r._metadata, r.tunnel, t.getDsn());
...
function Za(t, {
    ...
    if (i)
        ...
        } else a ? s.all = r + ja(a, r) : e === 429 && (s.all = r + 60 * 1e3);
    return s
}
const ts = 64;
...
function ns(t, e, n = en(t.bufferSize || ts)) {
    ...
    function i(a) {
        ...
        if (Nn(a, (l, g) => {
                const p = Cn(g);
                Ba(r, p) ? t.recordDroppedEvent("ratelimit_backoff", p) : o.push(l)
        ...
        return n.add(d).then(l => l, l => {
            if (l === Qt) return E && y.error("Skipped sending event because buffer is full."), u("queue_overflow"), Promise.resolve({});
            throw l
        })
    }
    return {
...
function Ha(t) {
    ...
    return {
        ...
        exclusive_time: a == null ? void 0 : a[jr],
...
const jn = "Not capturing exception because it's already been captured.",
    Un = "Discarded session because of missing or non-string release",
...
class qa {
    constructor(e) {
        var r, s, i;
        if (this._options = e, this._integrations = {}, this._numProcessing = 0, this._outcomes = {}, this._hooks = {}, this._eventProcessors = [], this._promiseBuffer = en(((r = e.transportOptions) == null ? void 0 : r.bufferSize) ?? ts), e.dsn ? this._dsn = Ai(e.dsn) : E && y.warn("No DSN provided, client will not send events."), this._dsn) {
            const a = Ra(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
    ...
    captureEvent(e, n, r) {
        const s = M();
        if (n != null && n.originalException && _n(n.originalException)) return E && y.log(jn), s;
        const i = {
                event_id: s,
                ...n
            },
    ...
    addIntegration(e) {
        ...
        Jr(this, e, this._integrations), n || Fn(this, [e])
    }
    sendEvent(e, n = {}) {
        this.emit("beforeSendEvent", e, n);
        let r = oa(e, this._dsn, this._options._metadata, this._options.tunnel);
        for (const s of n.attachments || []) r = Qi(r, na(s));
    ...
    _setupIntegrations() {
        ...
        this._integrations = Oa(this, e), Fn(this, e)
    }
    ...
    _prepareEvent(e, n, r, s) {
        ...
        return !n.integrations && (a != null && a.length) && (n.integrations = a), this.emit("preprocessEvent", e, n), e.type || s.setLastEventId(e.event_id || n.event_id), _a(i, e, n, r, this, s).then(o => {
            if (o === null) return o;
    ...
    _captureEvent(e, n = {}, r = Z(), s = de()) {
        return E && It(e) && y.log(`Captured error event \`${rs(e)[0]||"<unknown>"}\``), this._processEvent(e, n, r, s).then(i => i.event_id, i => {
            E && (Zn(i) ? y.log(i.message) : Bn(i) ? y.warn(i.message) : y.warn(i))
        })
    }
    _processEvent(e, n, r, s) {
        const i = this.getOptions(),
            ...
            l = typeof a > "u" ? void 0 : Di(a);
        if (c && typeof l == "number" && Math.random() > l) return this.recordDroppedEvent("sample_rate", "error"), Xt(pt(`Discarding event because it's not included in the random sample (sampling rate = ${a})`));
        const g = Hn(e.type);
        return this._prepareEvent(e, n, r, s).then(p => {
            if (p === null) throw this.recordDroppedEvent("event_processor", g), pt("An event processor returned `null`, will not send event.");
            ...
            if (c && T && this._updateSessionFromEvent(T, p), o) {
                const Me = ((N = p.sdkProcessingMetadata) == null ? void 0 : N.spanCountBeforeProcessing) || 0,
...
Reason: ${p}`))
    ...
    _process(e, n) {
        this._numProcessing++, this._promiseBuffer.add(e).then(r => (this._numProcessing--, r), r => (this._numProcessing--, r === Qt && this.recordDroppedEvent("queue_overflow", n), r))
    }
    _clearOutcomes() {
...
function os(t) {
    ...
    return Object.values(t).forEach(n => {
        Array.isArray(n) ? e += n.length * Vn(n[0]) : nt(n) ? e += Vn(n) : e += 100
    }), e
}
...
function lo(t, e) {
    if (t.type) {
        if (t.type === "transaction" && po(t, e.ignoreTransactions)) return E && y.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${re(t)}`), !0
    } else {
        if (fo(t, e.ignoreErrors)) return E && y.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${re(t)}`), !0;
        if (go(t)) return E && y.warn(`Event dropped due to not having an error message, error type or stacktrace.
Event: ${re(t)}`), !0;
        if (ho(t, e.denyUrls)) return E && y.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${re(t)}.
Url: ${Ge(t)}`), !0;
        if (!mo(t, e.allowUrls)) return E && y.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${re(t)}.
Url: ${Ge(t)}`), !0
    }
    return !1
...
function fo(t, e) {
    return e != null && e.length ? rs(t).some(n => st(n, e)) : !1
}
...
function yo(t, e, n, r, s, i) {
    ...
    a && (s.exception.values = Tt(t, e, r, i.originalException, n, s.exception.values, a, 0))
}
...
function Tt(t, e, n, r, s, i, a, o) {
    ...
    return Array.isArray(r.errors) && r.errors.forEach((u, d) => {
        if (ee(u, Error)) {
            ...
            const l = t(e, u),
                g = c.length;
            Jn(l, `errors[${d}]`, g, o), c = Tt(t, e, n, u, s, [l, ...c], l, g)
        }
    }), c
}
...
function vo() {
    "console" in I && Ns.forEach(function(t) {
        t in I.console && P(I.console, t, function(e) {
            return We[t] = e,
                function(...n) {
                    j("console", {
                        args: n,
    ...
    ko = () => {
        ...
        return {
            ...
            processEvent(e) {
                if (e.type) return e;
                try {
                    if (Io(e, t)) return E && y.warn("Event dropped due to being a duplicate of previously captured event."), null
                } catch {}
                return t = e
            }
        }
...
function Co() {
    ...
    if (e && typeof e.createElement == "function") try {
        ...
        r.hidden = !0, e.head.appendChild(r), (n = r.contentWindow) != null && n.fetch && (t = wt(r.contentWindow.fetch)), e.head.removeChild(r)
    } catch (r) {
...
function Oo(t, e) {
    const n = "fetch";
    ce(n, t), ue(n, () => $o(void 0, e))
}

function $o(t, e = !1) {
    e && !Co() || P(I, "fetch", function(n) {
        return function(...r) {
            const s = new Error,
                {
                    method: i,
            ...
            return j("fetch", {
                ...o
            }), n.apply(I, r).then(async c => (j("fetch", {
                ...o,
                endTimestamp: V() * 1e3,
                response: c
            }), c), c => {
                if (j("fetch", {
                        ...
                        endTimestamp: V() * 1e3,
                        error: c
                    }), zt(c) && c.stack === void 0 && (c.stack = s.stack, ie(c, "framesToPop", 1)), c instanceof TypeError && (c.message === "Failed to fetch" || c.message === "Load failed" || c.message === "NetworkError when attempting to fetch resource.")) try {
...
function Xn(t) {
    return typeof t == "string" ? t : t ? Rt(t, "url") ? t.url : t.toString ? t.toString() : "" : ""
}
...
function Do(t) {
    ...
    try {
        ...
        if (Vs(e)) return new Headers(e.headers)
    } catch {}
}
...
function Lo(t) {
    ...
    return s => {
        ...
        if (a) {
            ...
            const T = a[5] === "native";
            return p != null && p.match(/\/[A-Z]:/) && (p = p.slice(1)), !p && a[5] && !T && (p = a[5]), {
...
function me(t, e = {}) {
    ...
    const r = function(...s) {
        try {
            ...
            throw Zo(), di(a => {
                a.addEventProcessor(o => (e.mechanism && (vt(o, void 0), fe(o, e.mechanism)), o.extra = {
                    ...o.extra,
                    arguments: s
                }, o)), ka(i)
            }), i
...
function Go(t) {
    ...
    return !e && ps(t) ? t.message && Array.isArray(t.message) && t.message.length == 2 ? t.message[0] : "WebAssembly.Exception" : e
}

function Yo(t) {
    const e = t == null ? void 0 : t.message;
    return ps(t) ? Array.isArray(t.message) && t.message.length == 2 ? t.message[1] : "wasm exception" : e ? e.error && typeof e.error.message == "string" ? e.error.message : e : "No error message"
}

function Jo(t, e, n, r) {
    const s = (n == null ? void 0 : n.syntheticException) || void 0,
        i = rn(t, e, s, r);
    return fe(i), i.level = "error", n != null && n.event_id && (i.event_id = n.event_id), it(i)
}

function Ko(t, e, n = "info", r, s) {
    const i = (r == null ? void 0 : r.syntheticException) || void 0,
        a = Ct(t, e, i, s);
    return a.level = n, r != null && r.event_id && (a.event_id = r.event_id), it(a)
}

function rn(t, e, n, r, s) {
    let i;
    if (Cr(e) && e.error) return mt(t, e.error);
    if (fn(e) || Bs(e)) {
        const a = e;
    ...
    return zt(e) ? mt(t, e) : Te(e) || rt(e) ? (i = Ho(t, e, n, s), fe(i, {
        synthetic: !0
    }), i) : (i = Ct(t, e, n, r), vt(i, `${e}`), fe(i, {
        synthetic: !0
    }), i)
}
...
function Xo(t, {
    ...
    return Cr(t) ? `Event \`ErrorEvent\` captured as ${r} with message \`${t.message}\`` : rt(t) ? `Event \`${Qo(t)}\` (type=${t.type}) captured as ${r}` : `Object captured as ${r} with keys: ${n}`
}
...
class tc extends qa {
    constructor(e) {
        var d;
        const n = nc(e),
            r = w.SENTRY_SDK_SOURCE || Po();
        to(n, "browser", ["browser"], r), (d = n._metadata) != null && d.sdk && (n._metadata.sdk.settings = {
        ...
        w.document && (i || a || u) && w.document.addEventListener("visibilitychange", () => {
            w.document.visibilityState === "hidden" && (i && this._flushOutcomes(), a && Kr(this), u && Qr(this))
        }), s && this.on("beforeSendSession", eo)
    }
...
function nc(t) {
    var e;
    return {
        release: typeof __SENTRY_RELEASE__ == "string" ? __SENTRY_RELEASE__ : (e = w.SENTRY_RELEASE) == null ? void 0 : e.id,
        sendClientReports: !0,
        parentSpanIsAlwaysRootSpan: !0,
        ...t
    }
}
const rc = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__,
    $ = I,
    sc = 1e3;
let tr, Ot, $t;
...
function nr(t, e = !1) {
    return n => {
        ...
        const r = uc(n);
        if (cc(n.type, r)) return;
        ie(n, "_sentryCaptured", !0), r && !r._sentryId && ie(r, "_sentryId", M());
        const s = n.type === "keypress" ? "input" : n.type;
        oc(n) || (t({
            event: n,
            name: s,
            global: e
        }), Ot = n.type, $t = r ? r._sentryId : void 0), clearTimeout(tr), tr = $.setTimeout(() => {
            $t = void 0, Ot = void 0
        }, sc)
    }
}
    ...
    function t(e) {
        return function(...n) {
            ...
            if (r) {
                const s = Ue,
                    i = lc(String(r));
                if (Ue = i, s === i) return e.apply(this, n);
                j("history", {
                    from: s,
                    to: i
                })
...
function fc(t) {
    ...
    if (r && typeof r.createElement == "function") try {
        ...
        rc && y.warn(`Could not create sandbox iframe for ${t} check, bailing to window.${t}: `, s)
    }
    ...
    t.open = new Proxy(t.open, {
        apply(e, n, r) {
            ...
            return "onreadystatechange" in n && typeof n.onreadystatechange == "function" ? n.onreadystatechange = new Proxy(n.onreadystatechange, {
                ...
                apply(u, d, l) {
                    const [g, p] = l, T = d[xe];
                    return T && H(g) && H(p) && (T.request_headers[g.toLowerCase()] = p), u.apply(d, l)
                }
            }), e.apply(n, r)
        }
...
const Ec = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
    Sc = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
    kc = /\((\S*)(?::(\d+))(?::(\d+))\)/,
    xc = /at (.+?) ?\(data:(.+?),/,
    Ic = t => {
        const e = t.match(xc);
    ...
    ms = [bc, Ic],
    Tc = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
    ...
    Rc = t => {
        ...
        if (e) {
            ...
            let r = e[3],
                s = e[1] || X;
            return [s, r] = _s(s, r), At(r, s, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0)
        }
    },
    Nc = [vc, Rc],
    Cc = [ms, Nc],
    ...
    Ac = (t = {}) => {
        ...
        return {
            name: $c,
            setup(n) {
                e.console && bo(Lc(n)), e.dom && ic(Mc(n, e.dom)), e.xhr && hc(Fc(n)), e.fetch && Oo(jc(n)), e.history && hs(Uc(n)), e.sentry && n.on("beforeSendEvent", Pc(n))
            }
        }
    },
    Dc = Ac;
...
function Mc(t, e) {
    return function(r) {
        ...
        o && o > Be && (at && y.warn(`\`dom.maxStringLength\` cannot exceed ${Be}, but a value of ${o} was configured. Sentry will use ${Be} instead.`), o = Be), typeof a == "string" && (a = [a]);
        try {
            const u = r.event,
                d = Bc(u) ? u.target : u;
            s = $r(d, {
...
function Lc(t) {
    return function(n) {
        ...
        if (n.level === "assert")
            if (n.args[0] === !1) r.message = `Assertion failed: ${mn(n.args.slice(1)," ")||"console.assert"}`, r.data.arguments = n.args.slice(1);
            else return;
        ae(r, {
            input: n.args,
            level: n.level
...
const Zc = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "BroadcastChannel", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "SharedWorker", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
    ...
    Hc = (t = {}) => {
        ...
        return {
            name: zc,
            setupOnce() {
                e.setTimeout && P(w, "setTimeout", rr), e.setInterval && P(w, "setInterval", rr), e.requestAnimationFrame && P(w, "requestAnimationFrame", Wc), e.XMLHttpRequest && "XMLHttpRequest" in w && P(XMLHttpRequest.prototype, "send", qc);
                const n = e.eventTarget;
                n && (Array.isArray(n) ? n : Zc).forEach(s => Gc(s, e))
            }
        }
    },
    Vc = Hc;
...
function Gc(t, e) {
    ...
    (i = r == null ? void 0 : r.hasOwnProperty) != null && i.call(r, "addEventListener") && (P(r, "addEventListener", function(a) {
        return function(o, c, u) {
            try {
                Yc(c) && (c.handleEvent = me(c.handleEvent, {
                    mechanism: {
                        data: {
                            handler: Q(c),
                            target: t
            ...
            return e.unregisterOriginalCallbacks && Jc(this, o, c), a.apply(this, [o, me(c, {
                mechanism: {
                    data: {
                        handler: Q(c),
                        target: t
...
const Kc = () => ({
        ...
        setupOnce() {
            if (typeof w.document > "u") {
                at && y.warn("Using the `browserSessionIntegration` in non-browser environments is not supported.");
                return
            }
            Pn({
                ignoreDuration: !0
    ...
    Qc = (t = {}) => {
        ...
        return {
            ...
            setup(n) {
                e.onerror && (tu(n), sr("onerror")), e.onunhandledrejection && (nu(n), sr("onunhandledrejection"))
            }
        }
    },
    eu = Qc;
...
function tu(t) {
    Ls(e => {
        ...
        const {
            ...
            column: o,
            error: c
        } = e, u = iu(rn(n, c || s, void 0, r, !1), i, a, o);
        u.level = "error", qr(u, {
            originalException: c,
            mechanism: {
                handled: !1,
...
const gu = () => ({
    ...
    setup(t) {
        const e = ls(t);
        _u((n, r) => {
            e.sendScope(JSON.stringify(U(n, 20, 2e3))), r.clearBreadcrumbs(), r.clearAttachments()
        })
    }
});
...
function yu(t) {
    let e;
    return ns(t, async n => (e || (e = ls()), e.sendEnvelope(n.body), {
        statusCode: 200
    }))
}
const bu = 50,
...
`).slice(e)) {
            const s = vu(r),
                i = Eu(r);
            if (s && (i == null ? void 0 : i.in_app) !== !1 ? n.push(s) : i && (i.module === void 0 && delete i.module, n.push(i)), n.length >= bu) break
        }
        return wr(n)
    };
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
    ...
    window.__SENTRY__RENDERER_INIT__ = !0, t.sendClientReports = !1, t.defaultIntegrations === void 0 && (t.defaultIntegrations = ku()), t.stackParser === void 0 && (t.stackParser = Su), t.ipcNamespace === void 0 && (t.ipcNamespace = "sentry-ipc"), t.dsn === void 0 && (t.dsn = "https://12345@dummy.dsn/12345"), t.transport === void 0 && (t.transport = yu), delete t.initialScope, e(t)
}
...
function h(t, e) {
    const n = wu(),
        r = Ru({
            ...
            data: t.data,
            path: t.path,
            errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, n, n === Dt ? void 0 : Dt].filter(s => !!s)
        });
...
const Nu = /^c[^\s-]{8,}$/i,
    ...
    Pu = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
...
const Fu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
    ju = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/,
    Uu = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/,
    Bu = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/,
    Zu = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
    zu = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/,
    bs = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))",
    Hu = new RegExp(`^${bs}$`);
...
class J extends k {
    _parse(e) {
        ...
        for (const i of this._def.checks)
        ...
        } else if (i.kind === "email") Mu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "email",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "emoji") gt || (gt = new RegExp(Lu, "u")), gt.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "emoji",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "uuid") $u.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "uuid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "nanoid") Au.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "nanoid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "cuid") Nu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cuid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "cuid2") Cu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cuid2",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "ulid") Ou.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "ulid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
            ...
            message: i.message
        }), r.dirty()) : i.kind === "datetime" ? Wu(i).test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: f.invalid_string,
            validation: "datetime",
            message: i.message
        }), r.dirty()) : i.kind === "date" ? Hu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: f.invalid_string,
            validation: "date",
            message: i.message
        }), r.dirty()) : i.kind === "time" ? Vu(i).test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: f.invalid_string,
            validation: "time",
            message: i.message
        }), r.dirty()) : i.kind === "duration" ? Pu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "duration",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "ip" ? qu(e.data, i.version) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "ip",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "jwt" ? Gu(e.data, i.alg) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "jwt",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "cidr" ? Yu(e.data, i.version) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cidr",
            code: f.invalid_string,
            message: i.message
            ...
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "base64url" ? zu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
...
class Ne extends k {
    ...
    _parse(e) {
        ...
        for (const i of this._def.checks) i.kind === "int" ? x.isInteger(e.data) || (r = this._getOrReturnCtx(e, r), h(r, {
            ...
            exact: !1,
            message: i.message
        }), s.dirty()) : i.kind === "multipleOf" ? Ju(e.data, i.value) !== 0 && (r = this._getOrReturnCtx(e, r), h(r, {
...
class B extends k {
    _parse(e) {
        ...
        if (s.minLength !== null && n.data.length < s.minLength.value && (h(n, {
            ...
            }), r.dirty()), n.common.async) return Promise.all([...n.data].map((a, o) => s.type._parseAsync(new te(n, a, n.path, o)))).then(a => L.mergeArray(r, a));
...
class Xe extends k {
    _parse(e) {
        const {
            ...
            if (or(i) || or(a)) return b;
            const o = Mt(i.value, a.value);
            return o.valid ? ((cr(i) || cr(a)) && n.dirty(), {
                status: n.value,
                value: o.data
            }) : (h(r, {
...
class oe extends k {
    _parse(e) {
        ...
        return r.common.async ? Promise.all(i).then(a => L.mergeArray(n, a)) : L.mergeArray(n, i)
    }
    get items() {
    ...
    _parse(e) {
        ...
        if (i.addIssue = i.addIssue.bind(i), s.type === "preprocess") {
            ...
            if (r.common.async) return Promise.resolve(a).then(async o => {
                ...
                return c.status === "aborted" ? b : c.status === "dirty" || n.value === "dirty" ? Ie(c.value) : c
            });
            {
                if (n.value === "aborted") return b;
                ...
                return o.status === "aborted" ? b : o.status === "dirty" || n.value === "dirty" ? Ie(o.value) : o
            }
        }
...
class K extends k {
    _parse(e) {
        return this._getType(e) === m.undefined ? F(void 0) : this._def.innerType._parse(e)
    }
    unwrap() {
...
class be extends k {
    _parse(e) {
        return this._getType(e) === m.null ? F(null) : this._def.innerType._parse(e)
    }
    unwrap() {
        return this._def.innerType
    }
...
class sn extends k {
    _parse(e) {
        ...
        if (r.common.async) return (async () => {
            ...
            return i.status === "aborted" ? b : i.status === "dirty" ? (n.dirty(), Ie(i.value)) : this._def.out._parseAsync({
                data: i.value,
                path: r.path,
                parent: r
            })
...
var Er = {};
const rd = Object.fromEntries(["arch", "platform", "type", "versions"].map(t => [t, !0])),
