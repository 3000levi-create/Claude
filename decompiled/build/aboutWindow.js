...
try {
    (function() {
        var t = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            e = new t.Error().stack;
        e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "b08317d9-dc29-4394-9989-2fba899ecb5e", t._sentryDebugIdIdentifier = "sentry-dbid-b08317d9-dc29-4394-9989-2fba899ecb5e")
    })()
} catch {}
...
function Zt() {
    var t;
    return "frameToken" in D.webFrame && D.webFrame.top && "frameToken" in D.webFrame.top ? D.webFrame.top.frameToken === D.webFrame.frameToken : ((t = D.webFrame.top) == null ? void 0 : t.routingId) === D.webFrame.routingId
}
const xs = {
        openHelp() {
    ...
    Ts = t => {
        Zt() && (t["claude.internal.ui"] = t["claude.internal.ui"] || {}, t["claude.internal.ui"].AboutWindow = xs)
    },
    ws = {
        requestDismiss(t) {
    ...
    Is = t => {
        Zt() && (t["claude.internal.ui"] = t["claude.internal.ui"] || {}, t["claude.internal.ui"].QuickWindow = ws)
    },
    Rs = {
        titleBarReady() {
        ...
        onUpdateTitleBar(t) {
            const e = (n, r) => t(r);
            return I.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.ui_$_MainWindowTitleBar_$_updateTitleBar", e), () => {
        ...
        onShowLoadError(t) {
            const e = (n, r) => t(r);
            return I.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.ui_$_MainWindowTitleBar_$_showLoadError", e), () => {
        ...
        onHideLoadError(t) {
            const e = n => t();
            return I.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.internal.ui_$_MainWindowTitleBar_$_hideLoadError", e), () => {
    ...
    $s = t => {
        Zt() && (t["claude.internal.ui"] = t["claude.internal.ui"] || {}, t["claude.internal.ui"].MainWindowTitleBar = Rs)
    },
    et = {};
Ts(et);
Is(et);
$s(et);
for (const [t, e] of Object.entries(et)) I.contextBridge.exposeInMainWorld(t, e);
...
const Cs = {
        ...
        onLocaleChanged(t) {
            const e = (n, r, s) => t(r, s);
            return I.ipcRenderer.on("$eipc_message$_6b262b63-5a77-4b4d-9676-f029b3b91e60_$_claude.hybrid_$_DesktopIntl_$_localeChanged", e), () => {
    ...
    Os = t => {
        Ns() && (t["claude.hybrid"] = t["claude.hybrid"] || {}, t["claude.hybrid"].DesktopIntl = Cs)
    },
    xr = {};
Os(xr);
for (const [t, e] of Object.entries(xr)) I.contextBridge.exposeInMainWorld(t, e);
...
function Rr(t) {
    ...
    return /sentryWrapped/.test(Pe(e).function || "") && e.pop(), e.reverse(), ln.test(Pe(e).function || "") && (e.pop(), ln.test(Pe(e).function || "") && e.pop()), e.slice(0, wr).map(n => ({
        ...n,
...
function Zs() {
    dt = T.onerror, T.onerror = function(t, e, n, r, s) {
        return F("error", {
            column: r,
            error: s,
            line: n,
...
function Hs() {
    lt = T.onunhandledrejection, T.onunhandledrejection = function(t) {
...
function Ar(t, e = {}) {
    ...
    try {
        ...
        const d = Array.isArray(e) ? e : e.keyAttrs,
            l = !Array.isArray(e) && e.maxStringLength || Js;
        for (; n && i++ < r && (u = Ks(n, d), !(u === "html" || i > 1 && a + s.length * c + u.length >= l));) s.push(u), a += u.length, n = n.parentNode;
...
function Mr(t) {
    ...
    if (st(t)) {
        ...
        return typeof CustomEvent < "u" && ee(t, CustomEvent) && (e.detail = t.detail), e
    } else return t
}

function mn(t) {
    try {
        return zs(t) ? Ar(t) : Object.prototype.toString.call(t)
    } catch {
        return "<unknown>"
    }
}
...
function gn(t, e) {
    ...
    for (let r = 0; r < t.length; r++) {
        const s = t[r];
        try {
            Or(s) ? n.push($r(s)) : n.push(String(s))
        } catch {
...
function We(t, e, n = !1) {
    return H(t) ? qs(e) ? e.test(t) : H(e) ? n ? t === e : t.includes(e) : !1 : !1
}
...
function L(t = ei()) {
    ...
    return ft || (ft = "10000000100040008000" + 1e11), ft.replace(/[018]/g, e => (e ^ (ti() & 15) >> e / 4).toString(16))
}
...
function De(t, e, n = 2) {
    ...
    for (const s in e) Object.prototype.hasOwnProperty.call(e, s) && (r[s] = De(r[s], e[s], n - 1));
    return r
}
...
class z {
    ...
    clone() {
        ...
        }, e._client = this._client, e._lastEventId = this._lastEventId, En(e, Sn(this)), e
    }
    setClient(e) {
        this._client = e
    }
    ...
    setUser(e) {
        return this._user = e || {
            ...
            ip_address: void 0,
            username: void 0
        }, this._session && pe(this._session, {
            user: e
    ...
    update(e) {
        ...
        const n = typeof e == "function" ? e(this) : e,
            r = n instanceof z ? n.getScopeData() : we(n) ? e : void 0,
            {
                tags: s,
                attributes: i,
                extra: a,
        ...
        return this._tags = {
            ...
            ...this._contexts,
            ...c
        }, o && Object.keys(o).length && (this._user = o), u && (this._level = u), d.length && (this._fingerprint = d), l && (this._propagationContext = l), this
    }
    clear() {
        return this._breadcrumbs = [], this._tags = {}, this._attributes = {}, this._extra = {}, this._user = {}, this._contexts = {}, this._level = void 0, this._transactionName = void 0, this._fingerprint = void 0, this._session = void 0, En(this, void 0), this._attachments = [], this.setPropagationContext({
            traceId: vn(),
            sampleRand: Math.random()
        }), this._notifyScopeListeners(), this
    }
    ...
    setSDKProcessingMetadata(e) {
        return this._sdkProcessingMetadata = De(this._sdkProcessingMetadata, e, 2), this
    }
...
class di {
    ...
    withScope(e) {
        ...
        return Oe(r) ? r.then(s => (this._popScope(), s), s => {
            throw this._popScope(), s
        }) : (this._popScope(), r)
    }
    getClient() {
...
const _i = "sentry.source",
    ...
    Br = "sentry.exclusive_time",
    Ei = 0,
    Si = 1,
    ki = "_sentryScope",
    xi = "_sentryIsolationScope";
...
function $i(t) {
    if (!(!t || !H(t) && !Array.isArray(t))) return Array.isArray(t) ? t.reduce((e, n) => {
        const r = xn(n);
...
function Di(t) {
    ...
    return ["protocol", "publicKey", "host", "projectId"].find(a => t[a] ? !1 : (y.error(`Invalid Sentry Dsn: ${a} missing`), !0)) ? !1 : n.match(/^\d+$/) ? Oi(r) ? e && isNaN(parseInt(e, 10)) ? (y.error(`Invalid Sentry Dsn: Invalid port ${e}`), !1) : !0 : (y.error(`Invalid Sentry Dsn: Invalid protocol ${r}`), !1) : (y.error(`Invalid Sentry Dsn: Invalid projectId ${n}`), !1)
}
...
function Li(t) {
    ...
    let r;
    return e.orgId ? r = String(e.orgId) : n && (r = Mi(n)), r
}
...
function Fi(t) {
    const {
        ...
        traceId: n,
        isRemote: r
    } = t.spanContext(), s = r ? e : Xt(t).parent_span_id, i = Ur(t).scope, a = r ? (i == null ? void 0 : i.getPropagationContext().propagationSpanId) || jr() : e;
    return {
        parent_span_id: s,
        span_id: a,
        trace_id: n
...
function wn(t) {
    return typeof t == "number" ? In(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? In(t.getTime()) : V()
}
...
function Xt(t) {
    ...
    if (Ui(t)) {
        const {
            ...
            status: c,
            links: u
        } = t, d = "parentSpanId" in t ? t.parentSpanId : "parentSpanContext" in t ? (r = t.parentSpanContext) == null ? void 0 : r.spanId : void 0;
        return {
            span_id: e,
            trace_id: n,
            data: s,
...
function Hi(t) {
    if (!(!t || t.code === Ei)) return t.code === Si ? "ok" : t.message || "internal_error"
}
...
function Ki(t) {
    ...
    function o(A) {
        return (typeof a == "number" || typeof a == "string") && (A.sample_rate = `${a}`), A
    }
    const c = n[Yi];
    if (c) return o(c);
    ...
    const l = Vr(t.spanContext().traceId, e),
        g = s[_i],
        p = r.description;
    return g !== "url" && p && (l.transaction = p), zi() && (l.sampled = String(Wi(n)), l.sample_rand = (i == null ? void 0 : i.get("sentry.sample_rand")) ?? ((w = Ur(n).scope) == null ? void 0 : w.getPropagationContext().sampleRand.toString())), o(l), e.emit("createDsc", l, n), l
}
...
function zr(t, e = 3, n = 100 * 1024) {
    const r = B(t, e);
    return ta(r) > n ? zr(t, e - 1, n) : r
}

function kt(t, e, n = 1 / 0, r = 1 / 0, s = na()) {
    const [i, a] = s;
...
function sa(t) {
    ...
    function s(i) {
        typeof r == "string" ? r = typeof i == "string" ? r + i : [xt(r), i] : r.push(typeof i == "string" ? xt(i) : i)
    }
    for (const i of n) {
        const [a, o] = i;
        if (s(`
...
function la(t, e, n, r) {
    ...
    const a = ca(t, s, r, e);
    return delete t.sdkProcessingMetadata, ke(a, [
        [{
            type: i
        }, t]
    ])
...
class Ie {
    ...
    _executeHandlers() {
        ...
        this._handlers = [], e.forEach(n => {
            n[0] || (this._state === An && n[1](this._value), this._state === Dn && n[2](this._value), n[0] = !0)
        })
    }
    _runExecutor(e) {
        const n = (i, a) => {
...
function Tt(t, e, n, r) {
    ...
    return E && i === null && y.log(`Event processor "${s.id||"?"}" dropped event`), Oe(i) ? i.then(a => Tt(a, e, n, r + 1)) : Tt(i, e, n, r + 1)
}
...
function pa(t, e) {
    ...
    ha(t, e), r && ga(t, r), ya(t, n), ma(t, s), _a(t, i)
}
...
function va(t, e, n, r, s, i) {
    ...
    Ea(c, t), xa(c, u), s && s.emit("applyFrameMetadata", e), e.type === void 0 && Sa(c, t.stackParser);
    ...
    p.length && (n.attachments = p), pa(c, g);
    const w = [...l, ...g.eventProcessors];
    return fa(w, c, n).then(N => (N && ka(N), typeof a == "number" && a > 0 ? Ta(N, a, o) : N))
}
...
function Ea(t, e) {
    ...
    const a = t.request;
    a != null && a.url && i && (a.url = vt(a.url, i)), i && ((c = (o = t.exception) == null ? void 0 : o.values) == null || c.forEach(u => {
...
function Ta(t, e, n) {
    ...
    return (s = t.contexts) != null && s.trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = B(t.contexts.trace.data, e, n))), t.spans && (r.spans = t.spans.map(a => ({
        ...a,
        ...a.data && {
            data: B(a.data, e, n)
        }
...
function Pn(t) {
    const e = de(),
        ...
        i = e.getSession();
    return (i == null ? void 0 : i.status) === "ok" && pe(i, {
        status: "exited"
    }), Yr(), e.setSession(s), s
}
...
function Kr(t, e, n) {
    ...
    if (n[e.name] = e, !Fn.includes(e.name) && typeof e.setupOnce == "function" && (e.setupOnce(), Fn.push(e.name)), e.setup && typeof e.setup == "function" && e.setup(t), typeof e.preprocessEvent == "function") {
...
function Xr(t, e) {
    ...
    const r = t.getOptions(),
        s = Pa(n, r._metadata, r.tunnel, t.getDsn());
    Qr().set(t, []), t.emit("flushLogs"), t.sendEnvelope(s)
}
...
function es(t, e) {
    ...
    if (n.length === 0) return;
    const r = t.getOptions(),
        s = Ba(n, r._metadata, r.tunnel, t.getDsn());
...
function za(t, {
    ...
    if (i)
        for (const o of i.trim().split(",")) {
            const [c, u, , , d] = o.split(":", 5), l = parseInt(c, 10), g = (isNaN(l) ? 60 : l) * 1e3;
            if (!u) s.all = r + g;
            else
                for (const p of u.split(";")) p === "metric_bucket" ? (!d || d.split(";").includes("custom")) && (s[p] = r + g) : s[p] = r + g
        } else a ? s.all = r + Wa(a, r) : e === 429 && (s.all = r + 60 * 1e3);
    return s
}
const ns = 64;
...
function rs(t, e, n = nn(t.bufferSize || ns)) {
    ...
    function i(a) {
        ...
        if (Cn(a, (l, g) => {
                const p = On(g);
                Va(r, p) ? t.recordDroppedEvent("ratelimit_backoff", p) : o.push(l)
        ...
        const c = ke(a[0], o),
            ...
            d = () => e({
                body: sa(c)
            }).then(l => (l.statusCode !== void 0 && (l.statusCode < 200 || l.statusCode >= 300) && E && y.warn(`Sentry responded with status code ${l.statusCode} to sent event.`), r = za(r, l), l), l => {
                throw u("network_error"), E && y.error("Encountered error running transport request:", l), l
            });
        return n.add(d).then(l => l, l => {
            if (l === tn) return E && y.error("Skipped sending event because buffer is full."), u("queue_overflow"), Promise.resolve({});
            throw l
        })
    }
    return {
...
function Ga(t) {
    ...
    return {
        ...
        trace_id: e ?? "",
        origin: i,
        profile_id: a == null ? void 0 : a[Fr],
        exclusive_time: a == null ? void 0 : a[Br],
...
class Ka {
    constructor(e) {
        var r, s, i;
        if (this._options = e, this._integrations = {}, this._numProcessing = 0, this._outcomes = {}, this._hooks = {}, this._eventProcessors = [], this._promiseBuffer = nn(((r = e.transportOptions) == null ? void 0 : r.bufferSize) ?? ns), e.dsn ? this._dsn = Pi(e.dsn) : E && y.warn("No DSN provided, client will not send events."), this._dsn) {
            const a = Oa(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
    ...
    captureEvent(e, n, r) {
        const s = L();
        if (n != null && n.originalException && yn(n.originalException)) return E && y.log(Un), s;
        const i = {
                event_id: s,
                ...n
            },
    ...
    addIntegration(e) {
        ...
        Kr(this, e, this._integrations), n || Bn(this, [e])
    }
    sendEvent(e, n = {}) {
        this.emit("beforeSendEvent", e, n);
        let r = la(e, this._dsn, this._options._metadata, this._options.tunnel);
        for (const s of n.attachments || []) r = ra(r, aa(s));
    ...
    _setupIntegrations() {
        ...
        this._integrations = Ma(this, e), Bn(this, e)
    }
    ...
    _prepareEvent(e, n, r, s) {
        ...
        return !n.integrations && (a != null && a.length) && (n.integrations = a), this.emit("preprocessEvent", e, n), e.type || s.setLastEventId(e.event_id || n.event_id), va(i, e, n, r, this, s).then(o => {
            if (o === null) return o;
    ...
    _captureEvent(e, n = {}, r = Z(), s = de()) {
        return E && wt(e) && y.log(`Captured error event \`${ss(e)[0]||"<unknown>"}\``), this._processEvent(e, n, r, s).then(i => i.event_id, i => {
            E && (Hn(i) ? y.log(i.message) : Wn(i) ? y.warn(i.message) : y.warn(i))
        })
    }
    _processEvent(e, n, r, s) {
        const i = this.getOptions(),
            ...
            l = typeof a > "u" ? void 0 : ji(a);
        if (c && typeof l == "number" && Math.random() > l) return this.recordDroppedEvent("sample_rate", "error"), en(ht(`Discarding event because it's not included in the random sample (sampling rate = ${a})`));
        const g = zn(e.type);
        return this._prepareEvent(e, n, r, s).then(p => {
            if (p === null) throw this.recordDroppedEvent("event_processor", g), ht("An event processor returned `null`, will not send event.");
            ...
            if (c && w && this._updateSessionFromEvent(w, p), o) {
                const Le = ((N = p.sdkProcessingMetadata) == null ? void 0 : N.spanCountBeforeProcessing) || 0,
...
Reason: ${p}`))
    ...
    _process(e, n) {
        this._numProcessing++, this._promiseBuffer.add(e).then(r => (this._numProcessing--, r), r => (this._numProcessing--, r === tn && this.recordDroppedEvent("queue_overflow", n), r))
    }
    _clearOutcomes() {
...
function Xa(t, e) {
    ...
    if (Oe(t)) return t.then(r => {
        if (!we(r) && r !== null) throw He(n);
        return r
    }, r => {
        throw He(`${e} rejected with ${r}`)
    });
    if (!we(t) && t !== null) throw He(n);
    return t
}
...
function eo(t) {
    let e = 0;
    return t.name && (e += t.name.length * 2), e += 8, e + cs(t.attributes)
}

function to(t) {
    let e = 0;
    return t.message && (e += t.message.length * 2), e + cs(t.attributes)
}
...
function cs(t) {
    ...
    return Object.values(t).forEach(n => {
        Array.isArray(n) ? e += n.length * qn(n[0]) : rt(n) ? e += qn(n) : e += 100
    }), e
}
...
Event: ${re(t)}`), !0
        ...
        if (_o(t, e.ignoreErrors)) return E && y.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${re(t)}`), !0;
        if (Eo(t)) return E && y.warn(`Event dropped due to not having an error message, error type or stacktrace.
Event: ${re(t)}`), !0;
        if (yo(t, e.denyUrls)) return E && y.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${re(t)}.
Url: ${Ge(t)}`), !0;
        if (!bo(t, e.allowUrls)) return E && y.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${re(t)}.
Url: ${Ge(t)}`), !0
    }
    return !1
...
function _o(t, e) {
    return e != null && e.length ? ss(t).some(n => it(n, e)) : !1
}
...
function So(t, e, n, r, s, i) {
    var o;
    if (!((o = s.exception) != null && o.values) || !i || !ee(i.originalException, Error)) return;
...
function It(t, e, n, r, s, i, a, o) {
    ...
    return Array.isArray(r.errors) && r.errors.forEach((u, d) => {
        if (ee(u, Error)) {
            ...
            const l = t(e, u),
                g = c.length;
            Xn(l, `errors[${d}]`, g, o), c = It(t, e, n, u, s, [l, ...c], l, g)
        }
    }), c
}
...
function xo() {
    "console" in T && As.forEach(function(t) {
        t in T.console && M(T.console, t, function(e) {
            return ze[t] = e,
                function(...n) {
                    F("console", {
                        args: n,
    ...
    Io = () => {
        ...
        return {
            ...
            processEvent(e) {
                if (e.type) return e;
                try {
                    if ($o(e, t)) return E && y.warn("Event dropped due to being a duplicate of previously captured event."), null
                } catch {}
                return t = e
            }
        }
...
function Do() {
    ...
    if (e && typeof e.createElement == "function") try {
        ...
        r.hidden = !0, e.head.appendChild(r), (n = r.contentWindow) != null && n.fetch && (t = Rt(r.contentWindow.fetch)), e.head.removeChild(r)
    } catch (r) {
...
function Mo(t, e) {
    const n = "fetch";
    ce(n, t), ue(n, () => Lo(void 0, e))
}

function Lo(t, e = !1) {
    e && !Do() || M(T, "fetch", function(n) {
        return function(...r) {
            const s = new Error,
                {
                    method: i,
            ...
            return F("fetch", {
                ...o
            }), n.apply(T, r).then(async c => (F("fetch", {
                ...o,
                endTimestamp: V() * 1e3,
                response: c
            }), c), c => {
                if (F("fetch", {
                        ...
                        endTimestamp: V() * 1e3,
                        error: c
                    }), Vt(c) && c.stack === void 0 && (c.stack = s.stack, ie(c, "framesToPop", 1)), c instanceof TypeError && (c.message === "Failed to fetch" || c.message === "Load failed" || c.message === "NetworkError when attempting to fetch resource.")) try {
...
function er(t) {
    return typeof t == "string" ? t : t ? $t(t, "url") ? t.url : t.toString ? t.toString() : "" : ""
}
...
function jo(t) {
    ...
    try {
        ...
        if (Ys(e)) return new Headers(e.headers)
    } catch {}
}
...
function Uo(t) {
    ...
    return s => {
        ...
        if (a) {
            ...
            u && (l = c, g = u), u === "<anonymous>" && (g = void 0, d = void 0), d === void 0 && (g = g || X, d = l ? `${l}.${g}` : g);
            let p = (o = a[2]) != null && o.startsWith("file://") ? a[2].slice(7) : a[2];
            const w = a[5] === "native";
            return p != null && p.match(/\/[A-Z]:/) && (p = p.slice(1)), !p && a[5] && !w && (p = a[5]), {
...
function me(t, e = {}) {
    ...
    const r = function(...s) {
        try {
            ...
            throw zo(), hi(a => {
                a.addEventProcessor(o => (e.mechanism && (Et(o, void 0), fe(o, e.mechanism)), o.extra = {
                    ...o.extra,
                    arguments: s
                }, o)), Ia(i)
            }), i
    ...
    Dr(r, t), ie(t, "__sentry_wrapped__", r);
    try {
...
function Jo(t) {
    return t && Yo.test(t.message) ? 1 : 0
}
...
function ec(t, e, n, r) {
    const s = (n == null ? void 0 : n.syntheticException) || void 0,
        i = an(t, e, s, r);
    return fe(i), i.level = "error", n != null && n.event_id && (i.event_id = n.event_id), at(i)
}

function tc(t, e, n = "info", r, s) {
    const i = (r == null ? void 0 : r.syntheticException) || void 0,
        a = Ct(t, e, i, s);
    return a.level = n, r != null && r.event_id && (a.event_id = r.event_id), at(a)
}

function an(t, e, n, r, s) {
    let i;
    if (Cr(e) && e.error) return _t(t, e.error);
    if (hn(e) || Vs(e)) {
        const a = e;
    ...
    return Vt(e) ? _t(t, e) : we(e) || st(e) ? (i = Go(t, e, n, s), fe(i, {
        synthetic: !0
    }), i) : (i = Ct(t, e, n, r), Et(i, `${e}`), fe(i, {
        synthetic: !0
    }), i)
}
...
function nc(t, {
    ...
    return Cr(t) ? `Event \`ErrorEvent\` captured as ${r} with message \`${t.message}\`` : st(t) ? `Event \`${rc(t)}\` (type=${t.type}) captured as ${r}` : `Object captured as ${r} with keys: ${n}`
}
...
class ic extends Ka {
    constructor(e) {
        var d;
        const n = ac(e),
            r = R.SENTRY_SDK_SOURCE || Fo();
        io(n, "browser", ["browser"], r), (d = n._metadata) != null && d.sdk && (n._metadata.sdk.settings = {
        ...
        R.document && (i || a || u) && R.document.addEventListener("visibilitychange", () => {
            R.document.visibilityState === "hidden" && (i && this._flushOutcomes(), a && Xr(this), u && es(this))
        }), s && this.on("beforeSendSession", so)
    }
...
function ac(t) {
    var e;
    return {
        release: typeof __SENTRY_RELEASE__ == "string" ? __SENTRY_RELEASE__ : (e = R.SENTRY_RELEASE) == null ? void 0 : e.id,
        sendClientReports: !0,
        parentSpanIsAlwaysRootSpan: !0,
        ...t
    }
}
const oc = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__,
    O = T,
    cc = 1e3;
let rr, Ot, At;
...
function dc() {
    ...
    O.document.addEventListener("click", e, !1), O.document.addEventListener("keypress", e, !1), ["EventTarget", "Node"].forEach(n => {
        ...
        (a = s == null ? void 0 : s.hasOwnProperty) != null && a.call(s, "addEventListener") && (M(s, "addEventListener", function(o) {
            ...
            return function(c, u, d) {
                if (c === "click" || c == "keypress") try {
                    const l = this.__sentry_instrumentation_handlers__ || {},
                        g = l[c];
                    g && (g.refCount--, g.refCount <= 0 && (o.call(this, c, g.handler, d), g.handler = void 0, delete l[c]), Object.keys(l).length === 0 && delete this.__sentry_instrumentation_handlers__)
                } catch {}
                return o.call(this, c, u, d)
            }
        }))
...
function sr(t, e = !1) {
    return n => {
        ...
        const r = pc(n);
        if (fc(n.type, r)) return;
        ie(n, "_sentryCaptured", !0), r && !r._sentryId && ie(r, "_sentryId", L());
        const s = n.type === "keypress" ? "input" : n.type;
        lc(n) || (t({
            event: n,
            name: s,
            global: e
        }), Ot = n.type, At = r ? r._sentryId : void 0), clearTimeout(rr), rr = O.setTimeout(() => {
            At = void 0, Ot = void 0
        }, cc)
    }
}
...
function _c(t) {
    ...
    if (r && typeof r.createElement == "function") try {
        ...
        oc && y.warn(`Could not create sandbox iframe for ${t} check, bailing to window.${t}: `, s)
    }
    ...
    t.open = new Proxy(t.open, {
        apply(e, n, r) {
            ...
            return "onreadystatechange" in n && typeof n.onreadystatechange == "function" ? n.onreadystatechange = new Proxy(n.onreadystatechange, {
                ...
                apply(u, d, l) {
                    const [g, p] = l, w = d[xe];
                    return w && H(g) && H(p) && (w.request_headers[g.toLowerCase()] = p), u.apply(d, l)
                }
            }), e.apply(n, r)
        }
...
const Tc = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
    wc = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
    Ic = /\((\S*)(?::(\d+))(?::(\d+))\)/,
    Rc = /at (.+?) ?\(data:(.+?),/,
    $c = t => {
        const e = t.match(Rc);
    ...
    _s = [kc, $c],
    Nc = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
    ...
    Oc = t => {
        ...
        if (e) {
            ...
            let r = e[3],
                s = e[1] || X;
            return [s, r] = gs(s, r), Dt(r, s, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0)
        }
    },
    Ac = [xc, Oc],
    Dc = [_s, Ac],
    ...
    gs = (t, e) => {
        ...
        return n || r ? [t.indexOf("@") !== -1 ? t.split("@")[0] : X, n ? `safari-extension:${e}` : `safari-web-extension:${e}`] : [t, e]
    },
    Ue = 1024,
    Lc = "Breadcrumbs",
    Pc = (t = {}) => {
        ...
        return {
            name: Lc,
            setup(n) {
                e.console && ko(Uc(n)), e.dom && uc(Bc(n, e.dom)), e.xhr && yc(Zc(n)), e.fetch && Mo(Wc(n)), e.history && ms(Hc(n)), e.sentry && n.on("beforeSendEvent", Fc(n))
            }
        }
    },
    jc = Pc;
...
function Bc(t, e) {
    return function(r) {
        ...
        o && o > Ue && (ot && y.warn(`\`dom.maxStringLength\` cannot exceed ${Ue}, but a value of ${o} was configured. Sentry will use ${Ue} instead.`), o = Ue), typeof a == "string" && (a = [a]);
        try {
            const u = r.event,
                d = Vc(u) ? u.target : u;
            s = Ar(d, {
...
function Uc(t) {
    return function(n) {
        ...
        if (n.level === "assert")
            if (n.args[0] === !1) r.message = `Assertion failed: ${gn(n.args.slice(1)," ")||"console.assert"}`, r.data.arguments = n.args.slice(1);
            else return;
        ae(r, {
            input: n.args,
            level: n.level
...
function Hc(t) {
    return function(n) {
        ...
        let a = r ? mt(r) : void 0;
        const o = mt(s);
        a != null && a.path || (a = i), i.protocol === o.protocol && i.host === o.host && (s = o.relative), i.protocol === a.protocol && i.host === a.host && (r = a.relative), ae({
            category: "navigation",
            data: {
                from: r,
                to: s
...
const zc = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "BroadcastChannel", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "SharedWorker", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
    ...
    Gc = (t = {}) => {
        ...
        return {
            name: qc,
            setupOnce() {
                e.setTimeout && M(R, "setTimeout", ir), e.setInterval && M(R, "setInterval", ir), e.requestAnimationFrame && M(R, "requestAnimationFrame", Jc), e.XMLHttpRequest && "XMLHttpRequest" in R && M(XMLHttpRequest.prototype, "send", Kc);
                const n = e.eventTarget;
                n && (Array.isArray(n) ? n : zc).forEach(s => Xc(s, e))
            }
        }
    },
    Yc = Gc;
...
function Kc(t) {
    return function(...e) {
        ...
        return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(s => {
            s in n && typeof n[s] == "function" && M(n, s, function(i) {
                const a = {
                        mechanism: {
                            data: {
                                handler: Q(i)
...
function Xc(t, e) {
    ...
    (i = r == null ? void 0 : r.hasOwnProperty) != null && i.call(r, "addEventListener") && (M(r, "addEventListener", function(a) {
        return function(o, c, u) {
            try {
                Qc(c) && (c.handleEvent = me(c.handleEvent, {
                    mechanism: {
                        data: {
                            handler: Q(c),
                            target: t
            ...
            return e.unregisterOriginalCallbacks && eu(this, o, c), a.apply(this, [o, me(c, {
                mechanism: {
                    data: {
                        handler: Q(c),
                        target: t
...
const tu = () => ({
        ...
        setupOnce() {
            if (typeof R.document > "u") {
                ot && y.warn("Using the `browserSessionIntegration` in non-browser environments is not supported.");
                return
            }
            Pn({
                ignoreDuration: !0
    ...
    ru = (t = {}) => {
        ...
        return {
            ...
            setup(n) {
                e.onerror && (iu(n), ar("onerror")), e.onunhandledrejection && (au(n), ar("onunhandledrejection"))
            }
        }
    },
    su = ru;
...
function iu(t) {
    Us(e => {
        ...
        const {
            ...
            column: o,
            error: c
        } = e, u = uu(an(n, c || s, void 0, r, !1), i, a, o);
        u.level = "error", Gr(u, {
            originalException: c,
            mechanism: {
                handled: !1,
...
const Eu = () => ({
    ...
    setup(t) {
        const e = fs(t);
        vu((n, r) => {
            e.sendScope(JSON.stringify(B(n, 20, 2e3))), r.clearBreadcrumbs(), r.clearAttachments()
        })
    }
});
...
function Su(t) {
    let e;
    return rs(t, async n => (e || (e = fs()), e.sendEnvelope(n.body), {
        statusCode: 200
    }))
}
const ku = 50,
...
`).slice(e)) {
            const s = xu(r),
                i = Tu(r);
            if (s && (i == null ? void 0 : i.in_app) !== !1 ? n.push(s) : i && (i.module === void 0 && delete i.module, n.push(i)), n.length >= ku) break
        }
        return Rr(n)
    };
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
    ...
    window.__SENTRY__RENDERER_INIT__ = !0, t.sendClientReports = !1, t.defaultIntegrations === void 0 && (t.defaultIntegrations = Iu()), t.stackParser === void 0 && (t.stackParser = wu), t.ipcNamespace === void 0 && (t.ipcNamespace = "sentry-ipc"), t.dsn === void 0 && (t.dsn = "https://12345@dummy.dsn/12345"), t.transport === void 0 && (t.transport = Su), delete t.initialScope, e(t)
}
...
function h(t, e) {
    const n = Cu(),
        r = Ou({
            ...
            data: t.data,
            path: t.path,
            errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, n, n === Mt ? void 0 : Mt].filter(s => !!s)
        });
...
class P {
    ...
    static mergeObjectSync(e, n) {
        ...
        for (const s of n) {
            ...
            if (i.status === "aborted" || a.status === "aborted") return b;
...
const Au = /^c[^\s-]{8,}$/i,
    ...
    Lu = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
    Pu = /^[a-z0-9_-]{21}$/i,
    ju = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
    Fu = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
    Bu = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
...
const Zu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
    Wu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/,
    Hu = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/,
    Vu = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/,
    zu = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
    qu = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/,
    vs = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))",
    Gu = new RegExp(`^${vs}$`);
...
class J extends k {
    _parse(e) {
        ...
        for (const i of this._def.checks)
        ...
        } else if (i.kind === "email") Bu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "email",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "emoji") yt || (yt = new RegExp(Uu, "u")), yt.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "emoji",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "uuid") Lu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "uuid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "nanoid") Pu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "nanoid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "cuid") Au.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cuid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "cuid2") Du.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cuid2",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
        else if (i.kind === "ulid") Mu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "ulid",
            code: f.invalid_string,
            message: i.message
        }), r.dirty());
            ...
            message: i.message
        }), r.dirty()) : i.kind === "datetime" ? Ju(i).test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: f.invalid_string,
            validation: "datetime",
            message: i.message
        }), r.dirty()) : i.kind === "date" ? Gu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: f.invalid_string,
            validation: "date",
            message: i.message
        }), r.dirty()) : i.kind === "time" ? Yu(i).test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            code: f.invalid_string,
            validation: "time",
            message: i.message
        }), r.dirty()) : i.kind === "duration" ? Fu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "duration",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "ip" ? Ku(e.data, i.version) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "ip",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "jwt" ? Xu(e.data, i.alg) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "jwt",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "cidr" ? Qu(e.data, i.version) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "cidr",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "base64" ? zu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
            validation: "base64",
            code: f.invalid_string,
            message: i.message
        }), r.dirty()) : i.kind === "base64url" ? qu.test(e.data) || (s = this._getOrReturnCtx(e, s), h(s, {
...
class $e extends k {
    ...
    _parse(e) {
        ...
        for (const i of this._def.checks) i.kind === "int" ? x.isInteger(e.data) || (r = this._getOrReturnCtx(e, r), h(r, {
            ...
            exact: !1,
            message: i.message
        }), s.dirty()) : i.kind === "multipleOf" ? ed(e.data, i.value) !== 0 && (r = this._getOrReturnCtx(e, r), h(r, {
...
class U extends k {
    _parse(e) {
        ...
        if (s.minLength !== null && n.data.length < s.minLength.value && (h(n, {
            ...
            }), r.dirty()), n.common.async) return Promise.all([...n.data].map((a, o) => s.type._parseAsync(new te(n, a, n.path, o)))).then(a => P.mergeArray(r, a));
...
function le(t) {
    if (t instanceof $) {
        ...
        ...t._def,
        type: le(t.element)
    }) : t instanceof K ? K.create(le(t.unwrap())) : t instanceof be ? be.create(le(t.unwrap())) : t instanceof oe ? oe.create(t.items.map(e => le(e))) : t
}
class $ extends k {
    constructor() {
...
class Xe extends k {
    _parse(e) {
        const {
            ...
            if (ur(i) || ur(a)) return b;
            const o = Pt(i.value, a.value);
            return o.valid ? ((dr(i) || dr(a)) && n.dirty(), {
                status: n.value,
                value: o.data
            }) : (h(r, {
...
class oe extends k {
    _parse(e) {
        ...
        return r.common.async ? Promise.all(i).then(a => P.mergeArray(n, a)) : P.mergeArray(n, i)
    }
    get items() {
        ...
        if (r.common.async) {
            ...
            return Promise.resolve().then(async () => {
                for (const c of a) {
                    const u = await c.key,
                        d = await c.value;
                    if (u.status === "aborted" || d.status === "aborted") return b;
    ...
    _parse(e) {
        ...
        if (i.addIssue = i.addIssue.bind(i), s.type === "preprocess") {
            ...
            if (r.common.async) return Promise.resolve(a).then(async o => {
                if (n.value === "aborted") return b;
                const c = await this._def.schema._parseAsync({
                    data: o,
                    path: r.path,
                    parent: r
                });
                return c.status === "aborted" ? b : c.status === "dirty" || n.value === "dirty" ? Te(c.value) : c
            });
            {
                if (n.value === "aborted") return b;
                ...
                return o.status === "aborted" ? b : o.status === "dirty" || n.value === "dirty" ? Te(o.value) : o
            }
        }
        if (s.type === "refinement") {
            ...
            if (r.common.async === !1) {
                ...
                return o.status === "aborted" ? b : (o.status === "dirty" && n.dirty(), a(o.value), {
                    status: n.value,
                    value: o.value
                })
...
class on extends k {
    _parse(e) {
        ...
        if (r.common.async) return (async () => {
            ...
            return i.status === "aborted" ? b : i.status === "dirty" ? (n.dirty(), Te(i.value)) : this._def.out._parseAsync({
                data: i.value,
                path: r.path,
                parent: r
            })
...
var kr = {};
const od = Object.fromEntries(["arch", "platform", "type", "versions"].map(t => [t, !0])),
